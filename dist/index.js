...
`||a==="\r"?(h(),o=2):s+=a),o===3&&s==="!--"&&(o=4,p=p[0])}return h(),p}(e)),t),arguments,[])).length>1?t:t[0]}var di=(e,t,...r)=>(t&&t.class&&(t.class=t.class.trim().split(" ").filter(a=>a.trim()).map(a=>a.indexOf("cvio-ab-")!==0?`cvio-ab-${a}`:a).join(" ")),ee(e,t,...r)),l=na.bind(di);var ye=e=>{let{dispatch:t,privacyPolicyLink:r}=g("privacyPolicyLink");return r?l`
  ...
  `;var Ni=async e=>{try{var t=await Mi(e)}catch(r){if(r instanceof be){zi(e,r);return}throw r}await Ei(e,t),await Fi(e,t),e.dispatch("moduleState/set","success")},Mi=async e=>{let t=Object.assign({},e.appointment.customer,{medical_records_allowed:e.medicalConsent!="disabled"?!0:null,country:e.country,mobile:e.appointment.customer.mobile?jt(e.store.chain.language,e.appointment.customer.mobile):null});return"birth"in t&&(t.birth=Ii(t.birth)),Object.keys(t).forEach(r=>{typeof t[r]=="string"&&(t[r]=t[r].trim())}),await C.post(e,"customers",t)},Ii=e=>{if(!e||!(e instanceof Date))return null;let t=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),a=String(e.getDate()).padStart(2,"0");return`${t}-${r}-${a}T00:00:00+00:00`},zi=async(e,t)=>{let{customerForm:r}=e;var a=[];for(let n=0;n<t.getValidations().length;n++){let{propertyPath:o,message:s}=t.getValidations()[n];if(o==""){a.push(s);continue}r[o].errors||(r[o].errors=[]),r[o].errors.push(s)}e.dispatch("customerForm/set",{customerForm:r,customerFormGlobalErrors:a}),e.dispatch("currentStep/set","customer"),e.dispatch("booking/set",!1)},Ei=async(e,t)=>{await C.post(e,"customer_consents",{customer:t["@id"],approved_at:new Date,medical_records_allowed:e.medicalConsent!="disabled",source:"api"})},Fi=async(e,t)=>{let{appointment:r,language:a,translationOverrides:n,constantAppointmentCommentText:o,confirmationType:s,reminderType:c}=e,p=o||"";r.comment&&(p=(p?p+`
...
`:"")+r.comment),await C.put(e,r.id,Object.assign({},r,{customer:t["@id"],eye_examination_process:r.eye_examination_process["@id"],calendar:r.calendar["@id"],comment:p||void 0,title:f("%customer%'s examination",{customer:ae.format(t,a)},{language:a,translationOverrides:n}),status:"booked",should_send_confirmation_email:s=="email"||s=="both",should_send_confirmation_sms:s=="sms"||s=="both",should_send_reminder_email:c=="email"||c=="both",should_send_reminder_sms:c=="sms"||c=="both",source:"online"}))},Wa=e=>{var t=g("appointment","api","booking","language","customerForm","customerFormGlobalErrors","country","moduleState","store","translationOverrides","constantAppointmentCommentText","medicalConsent","confirmationType","reminderType");let{booking:r,moduleState:a,dispatch:n}=t;return l`
  ...
  `};var Li=["@abbrSunday","@abbrMonday","@abbrTuesday","@abbrWednesday","@abbrThursday","@abbrFriday","@abbrSaturday"],Qa=({date:e})=>{let{selectedDate:t,dispatch:r}=g("selectedDate"),a=()=>r("selectedDate/set",e);return l`
    <div class="col">
  ...
  `};var ro=({day:e})=>{let{selectedCalendar:t,selectedDate:r,nextFreeSlots:a,appointment:n,dispatch:o,firstEligibleDate:s}=g("selectedCalendar","appointment","nextFreeSlots","selectedDate","firstEligibleDate"),c=a[T(n,t,e)],p=h=>{o("selectedDate/set",h)};return e<new Date(s).setHours(0,0,0,0)||c&&c.status=="empty"?l`<td class='table-active disabled'>${e.getDate()}</td>`:c?l`
    <td class=${R(e,r)?"bg-primary text-light":"active-cell"} 
      onClick="${()=>p(e)}"
    >
      ${e.getDate()}
    </td>
  `:l`<td class="placeholder">${e.getDate()}</td>`};var Bi=["January","February","March","April","May","June","July","August","September","October","November","December"],Hi=["@abbrMonday","@abbrTuesday","@abbrWednesday","@abbrThursday","@abbrFriday","@abbrSaturday","@abbrSunday"],ao=()=>{let{selectedCalendar:e,selectedDate:t,nextFreeSlots:r,appointment:a,dispatch:n}=g("selectedCalendar","appointment","nextFreeSlots","selectedDate"),o=t.getFullYear(),s=t.getMonth(),c=new Date(o,s+1,0).getDate(),p=new Date<new Date(o,s,0),h=new Date(o,s,1),d=[],S=[];var v=!0;for(let x=t.getDate();x<=c;x++){let $=r[T(a,e,new Date(o,s,x))];if($==null||$.status=="incomplete"){v=!1;break}}for(let x=0;x<(h.getDay()||7)-1;x++)d.push(null);for(let x=1;x<=c;x++)d.push(new Date(o,s,x));for(let x=0;x<d.length;x+=7)S.push(d.slice(x,x+7));let b=()=>{let x=new Date(o,s+1,0).getDate();for(let $=1;$<=x;$++){let j=r[T(a,e,new Date(o,s+1,$))];if(j&&(j.status=="complete"||j.status=="incomplete")){n("selectedDate/set",new Date(o,s+1,$));return}}n("selectedDate/set",new Date(o,s+1,1)),n("initialNextFreeSlotsLoading/set",!0)};return l`
          ...
          <table class="table table caption-top placeholder-glow">
            <caption class="text-center display-6">
              <button
                ...
                onClick="${()=>{let x=new Date(o,s,0).getDate();for(let $=1;$<=x;$++){let j=r[T(a,e,new Date(o,s-1,$))];if(j&&j.status=="complete"){n("selectedDate/set",new Date(o,s-1,$));return}}n("selectedDate/set",new Date(o,s-1,1))}}"
              >
                ${"<"}
              </button>
              ${o+" "+f(Bi[s])}
            ...
            <thead>
              <tr>
                ${Hi.map(x=>l`<th scope="col">${f(x)}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${S.map(x=>l`
  ...
  `};var Je=e=>{let{selectedCalendar:t,selectedDate:r,nextFreeSlots:a,appointment:n,dispatch:o,nextFreeSlotLoading:s}=g("selectedCalendar","appointment","nextFreeSlots","selectedDate","nextFreeSlotLoading");var c=new Date(r),p,h=!1;for(c.setDate(c.getDate()+1);a[p=T(n,t,c)];){if(a[p].status!=="empty"){h=!0;break}c.setDate(c.getDate()+1)}let d=()=>o("selectedDate/set",c);return l`
  ...
  `};var no=()=>{let{selectedDate:e,selectedCalendar:t,appointment:r,nextFreeSlots:a}=g("selectedCalendar","selectedDate","nextFreeSlots","appointment");var n=T(r,t,e);return l`
  ...
  `};var Ye=({title:e,slots:t})=>t.length?l`
      ...
      `:null;var so=()=>{let{selectedDate:e,selectedCalendar:t,appointment:r,nextFreeSlots:a}=g("selectedCalendar","selectedDate","nextFreeSlots","appointment"),n=T(r,t,e),o=[],s=[],c=[],p=a[n]?a[n].slots:[];for(let h of p||[]){let d=new Date(h.start);d.getHours()<12?o.push(h):d.getHours()<18?s.push(h):c.push(h)}return l`
    <div class="grid">
