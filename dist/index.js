var ae,v,Ue,q,qe,Ke,Je,re={},We=[],za=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;function E(e,t){for(var a in t)e[a]=t[a];return e}function Ye(e){var t=e.parentNode;t&&t.removeChild(e)}function O(e,t,a){var r,n,o,i={};for(o in t)o=="key"?r=t[o]:o=="ref"?n=t[o]:i[o]=t[o];if(arguments.length>2&&(i.children=arguments.length>3?ae.call(arguments,2):a),typeof e=="function"&&e.defaultProps!=null)for(o in e.defaultProps)i[o]===void 0&&(i[o]=e.defaultProps[o]);return oe(e,i,r,n,null)}function oe(e,t,a,r,n){var o={type:e,props:t,key:a,ref:r,__k:null,__:null,__b:0,__e:null,__d:void 0,__c:null,__h:null,constructor:void 0,__v:n==null?++Ue:n};return n==null&&v.vnode!=null&&v.vnode(o),o}function z(e){return e.children}function P(e,t){this.props=e,this.context=t}function H(e,t){if(t==null)return e.__?H(e.__,e.__.__k.indexOf(e)+1):null;for(var a;t<e.__k.length;t++)if((a=e.__k[t])!=null&&a.__e!=null)return a.__e;return typeof e.type=="function"?H(e):null}function Ze(e){var t,a;if((e=e.__)!=null&&e.__c!=null){for(e.__e=e.__c.base=null,t=0;t<e.__k.length;t++)if((a=e.__k[t])!=null&&a.__e!=null){e.__e=e.__c.base=a.__e;break}return Ze(e)}}function be(e){(!e.__d&&(e.__d=!0)&&q.push(e)&&!ne.__r++||Ke!==v.debounceRendering)&&((Ke=v.debounceRendering)||qe)(ne)}function ne(){for(var e;ne.__r=q.length;)e=q.sort(function(t,a){return t.__v.__b-a.__v.__b}),q=[],e.some(function(t){var a,r,n,o,i,d;t.__d&&(i=(o=(a=t).__v).__e,(d=a.__P)&&(r=[],(n=E({},o)).__v=o.__v+1,ye(d,o,n,a.__n,d.ownerSVGElement!==void 0,o.__h!=null?[i]:null,r,i==null?H(o):i,o.__h),Qe(r,o),o.__e!=i&&Ze(o)))})}function rt(e,t,a,r,n,o,i,d,c,p){var l,_,f,h,b,y,g,S=r&&r.__k||We,D=S.length;for(a.__k=[],l=0;l<t.length;l++)if((h=a.__k[l]=(h=t[l])==null||typeof h=="boolean"?null:typeof h=="string"||typeof h=="number"||typeof h=="bigint"?oe(null,h,null,null,h):Array.isArray(h)?oe(z,{children:h},null,null,null):h.__b>0?oe(h.type,h.props,h.key,null,h.__v):h)!=null){if(h.__=a,h.__b=a.__b+1,(f=S[l])===null||f&&h.key==f.key&&h.type===f.type)S[l]=void 0;else for(_=0;_<D;_++){if((f=S[_])&&h.key==f.key&&h.type===f.type){S[_]=void 0;break}f=null}ye(e,h,f=f||re,n,o,i,d,c,p),b=h.__e,(_=h.ref)&&f.ref!=_&&(g||(g=[]),f.ref&&g.push(f.ref,null,h),g.push(_,h.__c||b,h)),b!=null?(y==null&&(y=b),typeof h.type=="function"&&h.__k===f.__k?h.__d=c=Xe(h,c,e):c=et(e,h,f,S,b,c),typeof a.type=="function"&&(a.__d=c)):c&&f.__e==c&&c.parentNode!=e&&(c=H(f))}for(a.__e=y,l=D;l--;)S[l]!=null&&(typeof a.type=="function"&&S[l].__e!=null&&S[l].__e==a.__d&&(a.__d=H(r,l+1)),at(S[l],S[l]));if(g)for(l=0;l<g.length;l++)tt(g[l],g[++l],g[++l])}function Xe(e,t,a){for(var r,n=e.__k,o=0;n&&o<n.length;o++)(r=n[o])&&(r.__=e,t=typeof r.type=="function"?Xe(r,t,a):et(a,r,r,n,r.__e,t));return t}function K(e,t){return t=t||[],e==null||typeof e=="boolean"||(Array.isArray(e)?e.some(function(a){K(a,t)}):t.push(e)),t}function et(e,t,a,r,n,o){var i,d,c;if(t.__d!==void 0)i=t.__d,t.__d=void 0;else if(a==null||n!=o||n.parentNode==null)e:if(o==null||o.parentNode!==e)e.appendChild(n),i=null;else{for(d=o,c=0;(d=d.nextSibling)&&c<r.length;c+=2)if(d==n)break e;e.insertBefore(n,o),i=o}return i!==void 0?i:n.nextSibling}function Ia(e,t,a,r,n){var o;for(o in a)o==="children"||o==="key"||o in t||ie(e,o,null,a[o],r);for(o in t)n&&typeof t[o]!="function"||o==="children"||o==="key"||o==="value"||o==="checked"||a[o]===t[o]||ie(e,o,t[o],a[o],r)}function ot(e,t,a){t[0]==="-"?e.setProperty(t,a):e[t]=a==null?"":typeof a!="number"||za.test(t)?a:a+"px"}function ie(e,t,a,r,n){var o;e:if(t==="style")if(typeof a=="string")e.style.cssText=a;else{if(typeof r=="string"&&(e.style.cssText=r=""),r)for(t in r)a&&t in a||ot(e.style,t,"");if(a)for(t in a)r&&a[t]===r[t]||ot(e.style,t,a[t])}else if(t[0]==="o"&&t[1]==="n")o=t!==(t=t.replace(/Capture$/,"")),t=t.toLowerCase()in e?t.toLowerCase().slice(2):t.slice(2),e.l||(e.l={}),e.l[t+o]=a,a?r||e.addEventListener(t,o?it:nt,o):e.removeEventListener(t,o?it:nt,o);else if(t!=="dangerouslySetInnerHTML"){if(n)t=t.replace(/xlink[H:h]/,"h").replace(/sName$/,"s");else if(t!=="href"&&t!=="list"&&t!=="form"&&t!=="tabIndex"&&t!=="download"&&t in e)try{e[t]=a==null?"":a;break e}catch(i){}typeof a=="function"||(a!=null&&(a!==!1||t[0]==="a"&&t[1]==="r")?e.setAttribute(t,a):e.removeAttribute(t))}}function nt(e){this.l[e.type+!1](v.event?v.event(e):e)}function it(e){this.l[e.type+!0](v.event?v.event(e):e)}function ye(e,t,a,r,n,o,i,d,c){var p,l,_,f,h,b,y,g,S,D,ee,M=t.type;if(t.constructor!==void 0)return null;a.__h!=null&&(c=a.__h,d=t.__e=a.__e,t.__h=null,o=[d]),(p=v.__b)&&p(t);try{e:if(typeof M=="function"){if(g=t.props,S=(p=M.contextType)&&r[p.__c],D=p?S?S.props.value:p.__:r,a.__c?y=(l=t.__c=a.__c).__=l.__E:("prototype"in M&&M.prototype.render?t.__c=l=new M(g,D):(t.__c=l=new P(g,D),l.constructor=M,l.render=Ba),S&&S.sub(l),l.props=g,l.state||(l.state={}),l.context=D,l.__n=r,_=l.__d=!0,l.__h=[]),l.__s==null&&(l.__s=l.state),M.getDerivedStateFromProps!=null&&(l.__s==l.state&&(l.__s=E({},l.__s)),E(l.__s,M.getDerivedStateFromProps(g,l.__s))),f=l.props,h=l.state,_)M.getDerivedStateFromProps==null&&l.componentWillMount!=null&&l.componentWillMount(),l.componentDidMount!=null&&l.__h.push(l.componentDidMount);else{if(M.getDerivedStateFromProps==null&&g!==f&&l.componentWillReceiveProps!=null&&l.componentWillReceiveProps(g,D),!l.__e&&l.shouldComponentUpdate!=null&&l.shouldComponentUpdate(g,l.__s,D)===!1||t.__v===a.__v){l.props=g,l.state=l.__s,t.__v!==a.__v&&(l.__d=!1),l.__v=t,t.__e=a.__e,t.__k=a.__k,t.__k.forEach(function(te){te&&(te.__=t)}),l.__h.length&&i.push(l);break e}l.componentWillUpdate!=null&&l.componentWillUpdate(g,l.__s,D),l.componentDidUpdate!=null&&l.__h.push(function(){l.componentDidUpdate(f,h,b)})}l.context=D,l.props=g,l.state=l.__s,(p=v.__r)&&p(t),l.__d=!1,l.__v=t,l.__P=e,p=l.render(l.props,l.state,l.context),l.state=l.__s,l.getChildContext!=null&&(r=E(E({},r),l.getChildContext())),_||l.getSnapshotBeforeUpdate==null||(b=l.getSnapshotBeforeUpdate(f,h)),ee=p!=null&&p.type===z&&p.key==null?p.props.children:p,rt(e,Array.isArray(ee)?ee:[ee],t,a,r,n,o,i,d,c),l.base=t.__e,t.__h=null,l.__h.length&&i.push(l),y&&(l.__E=l.__=null),l.__e=!1}else o==null&&t.__v===a.__v?(t.__k=a.__k,t.__e=a.__e):t.__e=La(a.__e,t,a,r,n,o,i,c);(p=v.diffed)&&p(t)}catch(te){t.__v=null,(c||o!=null)&&(t.__e=d,t.__h=!!c,o[o.indexOf(d)]=null),v.__e(te,t,a)}}function Qe(e,t){v.__c&&v.__c(t,e),e.some(function(a){try{e=a.__h,a.__h=[],e.some(function(r){r.call(a)})}catch(r){v.__e(r,a.__v)}})}function La(e,t,a,r,n,o,i,d){var c,p,l,_=a.props,f=t.props,h=t.type,b=0;if(h==="svg"&&(n=!0),o!=null){for(;b<o.length;b++)if((c=o[b])&&(c===e||(h?c.localName==h:c.nodeType==3))){e=c,o[b]=null;break}}if(e==null){if(h===null)return document.createTextNode(f);e=n?document.createElementNS("http://www.w3.org/2000/svg",h):document.createElement(h,f.is&&f),o=null,d=!1}if(h===null)_===f||d&&e.data===f||(e.data=f);else{if(o=o&&ae.call(e.childNodes),p=(_=a.props||re).dangerouslySetInnerHTML,l=f.dangerouslySetInnerHTML,!d){if(o!=null)for(_={},b=0;b<e.attributes.length;b++)_[e.attributes[b].name]=e.attributes[b].value;(l||p)&&(l&&(p&&l.__html==p.__html||l.__html===e.innerHTML)||(e.innerHTML=l&&l.__html||""))}if(Ia(e,f,_,n,d),l)t.__k=[];else if(b=t.props.children,rt(e,Array.isArray(b)?b:[b],t,a,r,n&&h!=="foreignObject",o,i,o?o[0]:a.__k&&H(a,0),d),o!=null)for(b=o.length;b--;)o[b]!=null&&Ye(o[b]);d||("value"in f&&(b=f.value)!==void 0&&(b!==e.value||h==="progress"&&!b)&&ie(e,"value",b,_.value,!1),"checked"in f&&(b=f.checked)!==void 0&&b!==e.checked&&ie(e,"checked",b,_.checked,!1))}return e}function tt(e,t,a){try{typeof e=="function"?e(t):e.current=t}catch(r){v.__e(r,a)}}function at(e,t,a){var r,n;if(v.unmount&&v.unmount(e),(r=e.ref)&&(r.current&&r.current!==e.__e||tt(r,null,t)),(r=e.__c)!=null){if(r.componentWillUnmount)try{r.componentWillUnmount()}catch(o){v.__e(o,t)}r.base=r.__P=null}if(r=e.__k)for(n=0;n<r.length;n++)r[n]&&at(r[n],t,typeof e.type!="function");a||e.__e==null||Ye(e.__e),e.__e=e.__d=void 0}function Ba(e,t,a){return this.constructor(e,a)}function Se(e,t,a){var r,n,o;v.__&&v.__(e,t),n=(r=typeof a=="function")?null:a&&a.__k||t.__k,o=[],ye(t,e=(!r&&a||t).__k=O(z,null,[e]),n||re,re,t.ownerSVGElement!==void 0,!r&&a?[a]:n?null:t.firstChild?ae.call(t.childNodes):null,o,!r&&a?a:n?n.__e:t.firstChild,r),Qe(o,e)}function st(e,t){var a={__c:t="__cC"+Je++,__:e,Consumer:function(r,n){return r.children(n)},Provider:function(r){var n,o;return this.getChildContext||(n=[],(o={})[t]=this,this.getChildContext=function(){return o},this.shouldComponentUpdate=function(i){this.props.value!==i.value&&n.some(be)},this.sub=function(i){n.push(i);var d=i.componentWillUnmount;i.componentWillUnmount=function(){n.splice(n.indexOf(i),1),d&&d.call(i)}}),r.children}};return a.Provider.__=a.Consumer.contextType=a}ae=We.slice,v={__e:function(e,t){for(var a,r,n;t=t.__;)if((a=t.__c)&&!a.__)try{if((r=a.constructor)&&r.getDerivedStateFromError!=null&&(a.setState(r.getDerivedStateFromError(e)),n=a.__d),a.componentDidCatch!=null&&(a.componentDidCatch(e),n=a.__d),n)return a.__E=a}catch(o){e=o}throw e}},Ue=0,P.prototype.setState=function(e,t){var a;a=this.__s!=null&&this.__s!==this.state?this.__s:this.__s=E({},this.state),typeof e=="function"&&(e=e(E({},a),this.props)),e&&E(a,e),e!=null&&this.__v&&(t&&this.__h.push(t),be(this))},P.prototype.forceUpdate=function(e){this.__v&&(this.__e=!0,e&&this.__h.push(e),be(this))},P.prototype.render=z,q=[],qe=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,ne.__r=0,Je=0;var G,j,lt,xe=0,ke=[],ct=v.__b,dt=v.__r,pt=v.diffed,mt=v.__c,ut=v.unmount;function J(e,t){v.__h&&v.__h(j,e,xe||t),xe=0;var a=j.__H||(j.__H={__:[],__h:[]});return e>=a.__.length&&a.__.push({}),a.__[e]}function I(e){return xe=1,Ra(ft,e)}function Ra(e,t,a){var r=J(G++,2);return r.t=e,r.__c||(r.__=[a?a(t):ft(void 0,t),function(n){var o=r.t(r.__[0],n);r.__[0]!==o&&(r.__=[o,r.__[1]],r.__c.setState({}))}],r.__c=j),r.__}function ht(e,t){var a=J(G++,3);!v.__s&&$e(a.__H,t)&&(a.__=e,a.__H=t,j.__H.__h.push(a))}function _t(e,t){var a=J(G++,4);!v.__s&&$e(a.__H,t)&&(a.__=e,a.__H=t,j.__h.push(a))}function vt(e,t){var a=J(G++,7);return $e(a.__H,t)&&(a.__=e(),a.__H=t,a.__h=e),a.__}function gt(e){var t=j.context[e.__c],a=J(G++,9);return a.c=e,t?(a.__==null&&(a.__=!0,t.sub(j)),t.props.value):e.__}function Ha(){ke.forEach(function(e){if(e.__P)try{e.__H.__h.forEach(se),e.__H.__h.forEach(je),e.__H.__h=[]}catch(t){e.__H.__h=[],v.__e(t,e.__v)}}),ke=[]}v.__b=function(e){j=null,ct&&ct(e)},v.__r=function(e){dt&&dt(e),G=0;var t=(j=e.__c).__H;t&&(t.__h.forEach(se),t.__h.forEach(je),t.__h=[])},v.diffed=function(e){pt&&pt(e);var t=e.__c;t&&t.__H&&t.__H.__h.length&&(ke.push(t)!==1&&lt===v.requestAnimationFrame||((lt=v.requestAnimationFrame)||function(a){var r,n=function(){clearTimeout(o),bt&&cancelAnimationFrame(r),setTimeout(a)},o=setTimeout(n,100);bt&&(r=requestAnimationFrame(n))})(Ha)),j=null},v.__c=function(e,t){t.some(function(a){try{a.__h.forEach(se),a.__h=a.__h.filter(function(r){return!r.__||je(r)})}catch(r){t.some(function(n){n.__h&&(n.__h=[])}),t=[],v.__e(r,a.__v)}}),mt&&mt(e,t)},v.unmount=function(e){ut&&ut(e);var t=e.__c;if(t&&t.__H)try{t.__H.__.forEach(se)}catch(a){v.__e(a,t.__v)}};var bt=typeof requestAnimationFrame=="function";function se(e){var t=j;typeof e.__c=="function"&&e.__c(),j=t}function je(e){var t=j;e.__c=e.__(),j=t}function $e(e,t){return!e||e.length!==t.length||t.some(function(a,r){return a!==e[r]})}function ft(e,t){return typeof t=="function"?t(e):t}function Ga(e,t){for(var a in t)e[a]=t[a];return e}function yt(e,t){for(var a in e)if(a!=="__source"&&!(a in t))return!0;for(var r in t)if(r!=="__source"&&e[r]!==t[r])return!0;return!1}function St(e){this.props=e}(St.prototype=new P).isPureReactComponent=!0,St.prototype.shouldComponentUpdate=function(e,t){return yt(this.props,e)||yt(this.state,t)};var xt=v.__b;v.__b=function(e){e.type&&e.type.__f&&e.ref&&(e.props.ref=e.ref,e.ref=null),xt&&xt(e)};var Va=v.__e;v.__e=function(e,t,a){if(e.then){for(var r,n=t;n=n.__;)if((r=n.__c)&&r.__c)return t.__e==null&&(t.__e=a.__e,t.__k=a.__k),r.__c(e,t)}Va(e,t,a)};var kt=v.unmount;function Ce(){this.__u=0,this.t=null,this.__b=null}function $t(e){var t=e.__.__c;return t&&t.__e&&t.__e(e)}function le(){this.u=null,this.o=null}v.unmount=function(e){var t=e.__c;t&&t.__R&&t.__R(),t&&e.__h===!0&&(e.type=null),kt&&kt(e)},(Ce.prototype=new P).__c=function(e,t){var a=t.__c,r=this;r.t==null&&(r.t=[]),r.t.push(a);var n=$t(r.__v),o=!1,i=function(){o||(o=!0,a.__R=null,n?n(d):d())};a.__R=i;var d=function(){if(!--r.__u){if(r.state.__e){var p=r.state.__e;r.__v.__k[0]=function _(f,h,b){return f&&(f.__v=null,f.__k=f.__k&&f.__k.map(function(y){return _(y,h,b)}),f.__c&&f.__c.__P===h&&(f.__e&&b.insertBefore(f.__e,f.__d),f.__c.__e=!0,f.__c.__P=b)),f}(p,p.__c.__P,p.__c.__O)}var l;for(r.setState({__e:r.__b=null});l=r.t.pop();)l.forceUpdate()}},c=t.__h===!0;r.__u++||c||r.setState({__e:r.__b=r.__v.__k[0]}),e.then(i,i)},Ce.prototype.componentWillUnmount=function(){this.t=[]},Ce.prototype.render=function(e,t){if(this.__b){if(this.__v.__k){var a=document.createElement("div"),r=this.__v.__k[0].__c;this.__v.__k[0]=function o(i,d,c){return i&&(i.__c&&i.__c.__H&&(i.__c.__H.__.forEach(function(p){typeof p.__c=="function"&&p.__c()}),i.__c.__H=null),(i=Ga({},i)).__c!=null&&(i.__c.__P===c&&(i.__c.__P=d),i.__c=null),i.__k=i.__k&&i.__k.map(function(p){return o(p,d,c)})),i}(this.__b,a,r.__O=r.__P)}this.__b=null}var n=t.__e&&O(z,null,e.fallback);return n&&(n.__h=null),[O(z,null,t.__e?null:e.children),n]};var jt=function(e,t,a){if(++a[1]===a[0]&&e.o.delete(t),e.props.revealOrder&&(e.props.revealOrder[0]!=="t"||!e.o.size))for(a=e.u;a;){for(;a.length>3;)a.pop()();if(a[1]<a[0])break;e.u=a=a[2]}};(le.prototype=new P).__e=function(e){var t=this,a=$t(t.__v),r=t.o.get(e);return r[0]++,function(n){var o=function(){t.props.revealOrder?(r.push(n),jt(t,e,r)):n()};a?a(o):o()}},le.prototype.render=function(e){this.u=null,this.o=new Map;var t=K(e.children);e.revealOrder&&e.revealOrder[0]==="b"&&t.reverse();for(var a=t.length;a--;)this.o.set(t[a],this.u=[1,0,this.u]);return e.children},le.prototype.componentDidUpdate=le.prototype.componentDidMount=function(){var e=this;this.o.forEach(function(t,a){jt(e,a,t)})};var Ua=typeof Symbol!="undefined"&&Symbol.for&&Symbol.for("react.element")||60103,qa=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,Ka=typeof document!="undefined",Ja=function(e){return(typeof Symbol!="undefined"&&typeof Symbol()=="symbol"?/fil|che|rad/i:/fil|che|ra/i).test(e)};P.prototype.isReactComponent={},["componentWillMount","componentWillReceiveProps","componentWillUpdate"].forEach(function(e){Object.defineProperty(P.prototype,e,{configurable:!0,get:function(){return this["UNSAFE_"+e]},set:function(t){Object.defineProperty(this,e,{configurable:!0,writable:!0,value:t})}})});var Ct=v.event;function Wa(){}function Ya(){return this.cancelBubble}function Za(){return this.defaultPrevented}v.event=function(e){return Ct&&(e=Ct(e)),e.persist=Wa,e.isPropagationStopped=Ya,e.isDefaultPrevented=Za,e.nativeEvent=e};var wt={configurable:!0,get:function(){return this.class}},Dt=v.vnode;v.vnode=function(e){var t=e.type,a=e.props,r=a;if(typeof t=="string"){var n=t.indexOf("-")===-1;for(var o in r={},a){var i=a[o];Ka&&o==="children"&&t==="noscript"||o==="value"&&"defaultValue"in a&&i==null||(o==="defaultValue"&&"value"in a&&a.value==null?o="value":o==="download"&&i===!0?i="":/ondoubleclick/i.test(o)?o="ondblclick":/^onchange(textarea|input)/i.test(o+t)&&!Ja(a.type)?o="oninput":/^on(Ani|Tra|Tou|BeforeInp)/.test(o)?o=o.toLowerCase():n&&qa.test(o)?o=o.replace(/[A-Z0-9]/,"-$&").toLowerCase():i===null&&(i=void 0),r[o]=i)}t=="select"&&r.multiple&&Array.isArray(r.value)&&(r.value=K(a.children).forEach(function(d){d.props.selected=r.value.indexOf(d.props.value)!=-1})),t=="select"&&r.defaultValue!=null&&(r.value=K(a.children).forEach(function(d){d.props.selected=r.multiple?r.defaultValue.indexOf(d.props.value)!=-1:r.defaultValue==d.props.value})),e.props=r}t&&a.class!=a.className&&(wt.enumerable="className"in a,a.className!=null&&(r.class=a.className),Object.defineProperty(r,"className",wt)),e.$$typeof=Ua,Dt&&Dt(e)};var Mt=v.__r;v.__r=function(e){Mt&&Mt(e)};var we=st(),Qa=typeof window!="undefined"?_t:ht,Xa=e=>(...t)=>{let a=gt(e),r=I({});return Qa(()=>a.on("@changed",(n,o)=>{t.some(d=>d in o)&&r[1]({})}),[]),vt(()=>{let n=a.get(),o={};return t.forEach(i=>{o[i]=n[i]}),o.dispatch=a.dispatch,o},[r[0]])},m=Xa(we);var De=class extends Error{constructor(t){super("Validation error");this.validations=t}getValidations(){return this.validations}},W=De;var Pt=e=>Object.assign({accept:"application/ld+json","Content-Type":"application/ld+json"},e),er={get:async(e,t)=>{var n;let{path:a,headers:r}=e.get().api;try{let o=await(await fetch(`${a}/${t}`,{headers:Pt(r)})).json();if(typeof o!="object")throw new Error("Invalid response");return(n=o["hydra:member"])!=null?n:o}catch(o){throw e.dispatch("moduleState/set","error"),o}},post:async({api:e,dispatch:t},a,r)=>{let{path:n,headers:o}=e,i={method:"POST",headers:Pt(o),body:JSON.stringify(r)};try{var d=await(await fetch(`${n}/${a}`,i)).json()}catch(c){throw t("moduleState/set","error"),c}if(d["@id"])return d;throw d.violations?new W(d.violations):(t("moduleState/set","error"),new Error("Invalid result"))}},x=er;var At=function(e,t,a,r){var n;t[0]=0;for(var o=1;o<t.length;o++){var i=t[o++],d=t[o]?(t[0]|=i?1:2,a[t[o++]]):t[++o];i===3?r[0]=d:i===4?r[1]=Object.assign(r[1]||{},d):i===5?(r[1]=r[1]||{})[t[++o]]=d:i===6?r[1][t[++o]]+=d+"":i?(n=e.apply(d,At(e,d,a,["",null])),r.push(n),d[0]?t[0]|=2:(t[o-2]=0,t[o]=n)):r.push(d)}return r},Ft=new Map;function Tt(e){var t=Ft.get(this);return t||(t=new Map,Ft.set(this,t)),(t=At(this,t.get(e)||(t.set(e,t=function(a){for(var r,n,o=1,i="",d="",c=[0],p=function(f){o===1&&(f||(i=i.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?c.push(0,f,i):o===3&&(f||i)?(c.push(3,f,i),o=2):o===2&&i==="..."&&f?c.push(4,f,0):o===2&&i&&!f?c.push(5,0,!0,i):o>=5&&((i||!f&&o===5)&&(c.push(o,0,i,n),o=6),f&&(c.push(o,f,0,n),o=6)),i=""},l=0;l<a.length;l++){l&&(o===1&&p(),p(l));for(var _=0;_<a[l].length;_++)r=a[l][_],o===1?r==="<"?(p(),c=[c],o=3):i+=r:o===4?i==="--"&&r===">"?(o=1,i=""):i=r+i[0]:d?r===d?d="":i+=r:r==='"'||r==="'"?d=r:r===">"?(p(),o=1):o&&(r==="="?(o=5,n=i,i=""):r==="/"&&(o<5||a[l][_+1]===">")?(p(),o===3&&(c=c[0]),o=c,(c=c[0]).push(2,0,o),o=0):r===" "||r==="	"||r===`
`||r==="\r"?(p(),o=2):i+=r),o===3&&i==="!--"&&(o=4,c=c[0])}return p(),c}(e)),t),arguments,[])).length>1?t:t[0]}var tr=(e,t,...a)=>(t&&t.class&&(t.class=t.class.trim().split(" ").filter(r=>r.trim()).map(r=>r.indexOf("cvio-ab-")!==0?`cvio-ab-${r}`:r).join(" ")),O(e,t,...a)),s=Tt.bind(tr);var Y=e=>{let{dispatch:t,privacyPolicyLink:a}=m("privacyPolicyLink");return a?s`
  ...
  `;var $r=async e=>{try{var t=await yr(e)}catch(a){if(a instanceof W){Sr(e,a);return}throw a}await xr(e,t),await kr(e,t),e.dispatch("moduleState/set","success")},yr=async e=>{let t=Object.assign({},e.appointment.customer,{medical_records_allowed:e.medicalConsent!="disabled"?!0:null,country:e.country,mobile:e.appointment.customer.mobile?Ne(e.store.chain.language,e.appointment.customer.mobile):null});return Object.keys(t).forEach(a=>{typeof t[a]=="string"&&(t[a]=t[a].trim())}),await x.post(e,"customers",t)},Sr=async(e,t)=>{let{customerForm:a}=e;var r=[];for(let n=0;n<t.getValidations().length;n++){let{propertyPath:o,message:i}=t.getValidations()[n];if(o==""){r.push(i);continue}a[o].errors||(a[o].errors=[]),a[o].errors.push(i)}e.dispatch("customerForm/set",{customerForm:a,customerFormGlobalErrors:r}),e.dispatch("currentStep/set","customer"),e.dispatch("booking/set",!1)},xr=async(e,t)=>{await x.post(e,"customer_consents",{customer:t["@id"],approved_at:new Date,medical_records_allowed:e.medicalConsent!="disabled",source:"api"})},kr=async(e,t)=>{let{appointment:a,language:r,translationOverrides:n,constantAppointmentCommentText:o}=e,i=o||"";a.comment&&(i=(i?i+`

`:"")+a.comment),await x.post(e,"appointment_events",Object.assign({},a,{customer:t["@id"],eye_examination_process:a.eye_examination_process["@id"],calendar:a.calendar["@id"],comment:i||void 0,title:u("%customer%'s examination",{customer:L.format(t,r)},{language:r,translationOverrides:n}),status:"booked",should_send_confirmation_email:!0,should_send_reminder_email:!0,source:"online"}))},ua=e=>{var t=m("appointment","api","booking","language","customerForm","customerFormGlobalErrors","country","moduleState","store","translationOverrides","constantAppointmentCommentText","medicalConsent");let{booking:a,moduleState:r,dispatch:n}=t;return s`
    <div class="d-grid">
      <button type="button" onClick=${async()=>{n("booking/set",!0);try{await $r(t)}catch(i){throw n("moduleState/set","error"),i}}} disabled=${r!="idle"}
        class="btn btn-primary btn-lg">
        ${a&&r=="idle"?s`<${F}/>`:u("Confirm appointment")}
      </button>
    </div>
  `};var Be={HUF:0},jr=(e,t)=>{var a=e.price_list.currency,r={style:"currency",currency:a};return Be[a]!=null&&(r.maximumFractionDigits=Be[a],r.minimumFractionDigits=Be[a]),new Intl.NumberFormat(t,r)},fe=({process:e})=>{if(!e)return s``;let{store:t,language:a,showPrice:r}=m("store","language","showPrice");if(!r)return s``;let n=e.process_services;var o=null,i=null,d=t.price_list.id;n.forEach(p=>{p.service.packagings.forEach(l=>{l.currentPrices.forEach(_=>{_.price_list.id==d&&((o==null||o>_.value)&&(o=_.value),(i==null||i<_.value)&&(i=_.value))})})});var c=jr(t,a);return o==null||i==null?s``:o==i?s`${c.format(o)}`:s`${c.format(o)} - ${c.format(i)}`};var he=e=>{let{appointment:t,language:a,currentStep:r,store:n,selectedCalendar:o,priceComment:i,showPrice:d,showExaminerName:c,locationName:p,locationAddress:l,showLocation:_,dispatch:f}=m("appointment","language","currentStep","store","selectedCalendar","priceComment","showPrice","showExaminerName","locationName","locationAddress","showLocation");if(!n)return;var h=["state","postal_code","city","street_address"],b=[];h.forEach(D=>{!t.customer[D]||b.push(t.customer[D])});var y=t.calendar||o,g={dateTimeStart:t.start?k.formatDateTime(t.start):null,dateTimeEnd:t.end?k.formatDateTime(t.end):null,processLength:t.eye_examination_process?t.eye_examination_process.length:null,processName:t.eye_examination_process?t.eye_examination_process.name:null,process:t.eye_examination_process,examinerName:c&&y?y.user.name:null,customer:t.customer,customerAddress:b.join(", "),showLocation:_,locationName:p!==null?p:n.name,locationAddress:l!==null?l:n.postal_code+" "+n.city+", "+n.street_address,appointmentComment:t.comment};let S=()=>{f("currentStep/set","appointment")};return s`
    <ul class="list-group${r=="summary"?"":" text-end"}">
      ...
      ${g.dateTimeStart&&g.dateTimeEnd&&g.processLength?s`
        <li class="list-group-item">
          ...
          <div class="fs-6">
            <a href="#" onClick="${S}">${u("change date")}</a>
          </div>
        </li>
      `:""}
      ${r=="summary"?s`
        <li class="list-group-item">
          <${ma} customer=${g.customer} customerAddress=${g.customerAddress}/>
        </li>
      `:""}
      ${r=="summary"&&g.appointmentComment?s`
        <li class="list-group-item">
  ...
  `};var R=e=>{let{currentStep:t,availableSteps:a}=m("currentStep","availableSteps"),r=a.indexOf(e.step),n=a.indexOf(t);if(a.indexOf(e.step)==-1)return s``;var o=t!="process"&&t!="summary"&&t!="storeSelection";return s`
  ...
  `};var ha=e=>{let{eyeExaminationProcesses:t}=m("eyeExaminationProcesses"),{detailedDescriptionModalState:a,dispatch:r}=m("detailedDescriptionModalState"),n=()=>r("detailedDescriptionModalState/set",!1);return s`
    ...
    <${T} modalStateStore="detailedDescriptionModalState"
      ...
      onApprove=${n}
    />
  `};var Re=e=>{let{selectedCalendar:t,dispatch:a,currentStep:r}=m("selectedCalendar","currentStep"),n=()=>{r==="calendar"&&(a("selectedCalendar/set",e.item["@id"]?e.item:null),a("currentStep/next"))};return s`
  ...
  `};var _a=e=>{let{appointment:t,showFirstAvailableUserItem:a,dispatch:r}=m("appointment","showFirstAvailableUserItem"),n=Z(m("calendars","appointment","calendarRoleCheckMode")),o={user:{name:u("First free"),description:u("For finding the nearest free time slot.")}},i=()=>r("currentStep/previous");return s`
    <ul class="list-group">
  ...
  `};var Cr=["@abbrSunday","@abbrMonday","@abbrTuesday","@abbrWednesday","@abbrThursday","@abbrFriday","@abbrSaturday"],va=({date:e})=>{let{selectedDate:t,dispatch:a}=m("selectedDate"),r=()=>a("selectedDate/set",e);return s`
    <div class="col">
  ...
  `};var ga=({dateGroup:e,visibleDateGroups:t})=>{let{previousDateGroup:a,currentDateGroup:r,nextDateGroup:n}=t;return s`
    <div class="carousel-item
  ...
  `};var wr=["January","February","March","April","May","June","July","August","September","October","November","December"],ba=e=>{let{selectedDate:t,firstEligibleDate:a,dispatch:r}=m("selectedDate","firstEligibleDate"),n=Ae(a),o=()=>r("selectedDate/set",d[4]),i=()=>r("selectedDate/set",p[0]);var d,c,p;for(let _=0;_<n.length&&(d=n[_-1],c=n[_],p=n[_+1],!c.hasDate(t));_++);let l={previousDateGroup:d,currentDateGroup:c,nextDateGroup:p};return s`
    <div class="dateSelection hstack gap-1">
      ...
      <div class="carousel-container">
        <div>${u(wr[c[0].getMonth()])}</div>
        <div class="carousel slide">
          <div class="carousel-inner">
            ${n.map(_=>s`<${ga} dateGroup=${_} visibleDateGroups=${l}/>`)}
          </div>
        </div>
      </div>
  ...
  `};var ya=({day:e})=>{let{selectedCalendar:t,selectedDate:a,nextFreeSlots:r,appointment:n,dispatch:o}=m("selectedCalendar","appointment","nextFreeSlots","selectedDate"),i=r[w(n,t,e)],d=c=>{o("selectedDate/set",c)};return e<new Date||i&&i.status=="empty"?s`<td class='table-active disabled'>${e.getDate()}</td>`:i?s`
    <td class=${A(e,a)?"bg-primary text-light":"active-cell"} 
      onClick="${()=>d(e)}"
    >
      ${e.getDate()}
    </td>
  `:s`<td class="placeholder">${e.getDate()}</td>`};var Dr=["January","February","March","April","May","June","July","August","September","October","November","December"],Mr=["@abbrMonday","@abbrTuesday","@abbrWednesday","@abbrThursday","@abbrFriday","@abbrSaturday","@abbrSunday"],Sa=()=>{let{selectedCalendar:e,selectedDate:t,nextFreeSlots:a,appointment:r,dispatch:n}=m("selectedCalendar","appointment","nextFreeSlots","selectedDate"),o=t.getFullYear(),i=t.getMonth(),d=new Date(o,i+1,0).getDate(),c=new Date<new Date(o,i,0),p=new Date(o,i,1),l=[],_=[];var f=!0;for(let y=t.getDate();y<=d;y++){let g=a[w(r,e,new Date(o,i,y))];if(g==null||g.status=="incomplete"){f=!1;break}}for(let y=0;y<(p.getDay()||7)-1;y++)l.push(null);for(let y=1;y<=d;y++)l.push(new Date(o,i,y));for(let y=0;y<l.length;y+=7)_.push(l.slice(y,y+7));let h=()=>{n("selectedDate/set",new Date(o,i+1,1))};return s`
      ...
      <div class="row">
        <div class="col">
          <table class="table table caption-top placeholder-glow">
            ...
            <thead>
              <tr>
                ${Mr.map(y=>s`<th scope="col">${u(y)}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${_.map(y=>s`
  ...
  `};var xa=e=>{let{dispatch:t,appointment:a}=m("appointment"),r=()=>{t("appointment/selectSlot",e.slot)};return s`
  ...
  `};var ka=()=>{let{selectedDate:e,selectedCalendar:t,appointment:a,nextFreeSlots:r}=m("selectedCalendar","selectedDate","nextFreeSlots","appointment");var n=w(a,t,e);return s`
    <ul class="list-group mt-3">
      ${r[n]?r[n].status=="empty"?s`<${_e}/>`:r[n].slots.map(o=>s`<${xa} slot=${o}/>`):s`<li class="list-group-item"><${F}/></li>`}
    </ul>
  `};var $a=({slot:e})=>{let{dispatch:t,appointment:a}=m("appointment"),r=()=>{t("appointment/selectSlot",e)},n=Q(new Date(a.start),new Date(e.start));return s`
  ...
  `};var ve=({title:e,slots:t})=>t.length?s`
      ...
      `:null;var ja=()=>{let{selectedDate:e,selectedCalendar:t,appointment:a,nextFreeSlots:r}=m("selectedCalendar","selectedDate","nextFreeSlots","appointment"),n=w(a,t,e),o=[],i=[],d=[],c=r[n]?r[n].slots:[];for(let p in c){let l=c[p],_=new Date(l.start);_.getHours()<12?o.push(l):_.getHours()<18?i.push(l):d.push(l)}return s`
    <div class="grid">
      ${r[n]?r[n].status=="empty"?s`<${_e}/>`:s`
            <${ve} title=${"Morning"} slots=${o}/>
            <${ve} title=${"Afternoon"} slots=${i}/>
            <${ve} title=${"Evening"} slots=${d}/>
          `:s`<li class="list-group-item"><${F}/></li>`}
    </div>
  `};var Ca=()=>{let{calendarRange:e,timeSlotMode:t}=m("calendarRange","timeSlotMode");return s`
    <${e=="fiveDays"?ba:Sa}/>
    <${t=="singleColumn"?ka:ja}/>
  `};var wa=e=>{let{appointment:t,dispatch:a}=m("appointment"),r=n=>{let{value:o}=n.target;var{customer:i}=t;i[e.property]=o,a("appointment/set",{customer:i})};return s`
  ...
  `};var $=e=>{let{customerForm:t}=m("customerForm");if(!!t[e.property]){var a=t[e.property];return s`
    <div class="${e.class||"col-sm"} needs-validation p-1 mb-2 w-100">
      ${e.label?s`
        ...
        `:null}
      <${e.inputClass||wa} property=${e.property}
  ...
  `}};var Da=e=>{let{appointment:t,showAppointmentComment:a,dispatch:r}=m("appointment","showAppointmentComment");if(!a)return s``;let n=o=>{let{value:i}=o.target;t.comment=i,r("appointment/set",t)};return s`
      <div class="row mx-2">
    ...
    `};var U=e=>{let t=a=>{let{value:r}=a.target;e.onInput(r)};return s`
  ...
  `};var Pr=e=>(e=e||new Date,e=new Date(e.getFullYear(),e.getMonth()+1,0),e.getDate()),Ma=e=>{let{appointment:t,dispatch:a}=m("appointment"),r=(c,p)=>{var{customer:l}=t;p==""?l[e.property]=null:(l[e.property]=l[e.property]||new Date("2000-01-01"),l[e.property][`set${c}`](p)),a("appointment/set",{customer:l})},n=t.customer[e.property];var o=[];for(let c=1900;c<=new Date().getFullYear();c++)o.push({value:c,label:c});var i=[];for(let c=1;c<=12;c++)i.push({value:c-1,label:c<10?`0${c}`:c});var d=[];for(let c=1;c<=Pr(n);c++)d.push({value:c,label:c<10?`0${c}`:c});return s`
    <div class="${e.invalid?"is-invalid":""} input-group">
      <${U} invalid=${e.invalid} onInput=${c=>r("FullYear",c)}
        value=${n?n.getFullYear():""} emptySelection="----" options=${o}
         disabled=${!!t.customer["@id"]}/>
      <${U} invalid=${e.invalid} onInput=${c=>r("Month",c)}
        value=${n?n.getMonth():""} emptySelection="--" options=${i}
         disabled=${!!t.customer["@id"]}/>
      <${U} invalid=${e.invalid} onInput=${c=>r("Date",c)}
        value=${n?n.getDate():""} emptySelection="--" options=${d}
         disabled=${!!t.customer["@id"]}/>
    </div>
  `};var Pa=e=>{let{appointment:t,dispatch:a}=m("appointment");return s`
    <${U} onInput=${n=>{var{customer:o}=t;o[e.property]=n,a("appointment/set",{customer:o})}} invalid=${e.invalid} disabled=${!!t.customer["@id"]}
      value=${t.customer[e.property]||""} emptySelection="${u("Not specified")}"
        options=${[{value:"m",label:u("Male")},{value:"f",label:u("Female")}]}/>
  `};var Aa=e=>{let{appointment:t,privacyPolicy:a,dispatch:r}=m("appointment","privacyPolicy"),n=()=>{var{customer:i}=t;i[e.property]=!i[e.property]||null,r("appointment/set",{customer:i})},o=()=>r("privacyPolicyModalState/set",!1);return s`
  ...
  `};var Fa=e=>{let{appointment:t,dispatch:a}=m("appointment"),r=()=>{var{customer:n}=t;n[e.property]=!n[e.property]||null,a("appointment/set",{customer:n})};return s`
  ...
  `};var Ta=e=>{let{customerForm:t,customerFormGlobalErrors:a,medicalConsent:r,dispatch:n}=m("customerForm","customerFormGlobalErrors","language","medicalConsent"),o=()=>{n("customerForm/validateAndNext")};return s`
    <div class="card p-2">
      ${a&&a.length?s`
      ...
      <div class="row mx-2">
        <${$} class="col-lg-5" property="birth" label="Birth" inputClass=${Ma}/>
      ...
      <${Da}/>
      <div class="row mx-2">
        <${$} property="acceptPrivacyPolicy" inputClass=${Aa}/>
      </div>
      ${r=="explicit"?s`
          <div class="row mx-2">
            <${$} property="acceptMedicalRecordsUse" inputClass=${Fa}/>
          </div>
        `:""}
      <button class="mx-2 btn btn-primary" onClick=${o}>${u("Next")}</button>
    </div>
  `};var Ea=e=>{let{store:t,dispatch:a,currentStep:r}=m("store","currentStep"),n=e.item.postal_code,o=e.item.city,i=e.item.street_address,d=()=>{r==="storeSelection"&&(a("store/set",e.item),a("currentStep/next"))};return s`
  <li class="row list-group-item ${t==e.item?"selected":""}" onClick=${d}>
      <div class="row">
        <div class="col-11 p-0">
          <h4>${e.item.name}</h4>
          <p>${e.item.phone}</p>
          <p>${e.item.email}</p>
          <p>${Te.formatAddress({postal_code:n,city:o,street_address:i})}</p>
        </div>
        <div class="col text-end p-2 next item icon">
          \u203A
        </div>
  ...
  `};var Na=e=>{let{stores:t}=m("stores");return s`
		${t!==null?(t.sort((a,r)=>a.name.localeCompare(r.name)),t.map(a=>s`<${Ea} item=${a}/>`)):s`
				<li class="list-group-item">
          <div class="row">
            <div class="col-auto">
              <div class="avatar me-2">
    ...
    <div class="carousel slide">
      <div class="carousel-inner">
        <${R} step="storeSelection" wrappedComponent=${Na}/>
        <${R} step="process" wrappedComponent=${ha}/>
        <${R} step="calendar" wrappedComponent=${_a}/>
        <${R} step="appointment" wrappedComponent=${Ca}/>
        <${R} step="customer" wrappedComponent=${Ta}/>
        <${R} step="summary" wrappedComponent=${he}/>
      </div>
    </div>
