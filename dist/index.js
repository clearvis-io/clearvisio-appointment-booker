var Pe,x,mr,_e,fr,hr,_r,Fe={},vr=[],Io=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;function q(e,t){for(var r in t)e[r]=t[r];return e}function gr(e){var t=e.parentNode;t&&t.removeChild(e)}function Q(e,t,r){var a,o,n,s={};for(n in t)n=="key"?a=t[n]:n=="ref"?o=t[n]:s[n]=t[n];if(arguments.length>2&&(s.children=arguments.length>3?Pe.call(arguments,2):r),typeof e=="function"&&e.defaultProps!=null)for(n in e.defaultProps)s[n]===void 0&&(s[n]=e.defaultProps[n]);return Ee(e,s,a,o,null)}function Ee(e,t,r,a,o){var n={type:e,props:t,key:r,ref:a,__k:null,__:null,__b:0,__e:null,__d:void 0,__c:null,__h:null,constructor:void 0,__v:o==null?++mr:o};return o==null&&x.vnode!=null&&x.vnode(n),n}function ee(e){return e.children}function L(e,t){this.props=e,this.context=t}function ce(e,t){if(t==null)return e.__?ce(e.__,e.__.__k.indexOf(e)+1):null;for(var r;t<e.__k.length;t++)if((r=e.__k[t])!=null&&r.__e!=null)return r.__e;return typeof e.type=="function"?ce(e):null}function br(e){var t,r;if((e=e.__)!=null&&e.__c!=null){for(e.__e=e.__c.base=null,t=0;t<e.__k.length;t++)if((r=e.__k[t])!=null&&r.__e!=null){e.__e=e.__c.base=r.__e;break}return br(e)}}function st(e){(!e.__d&&(e.__d=!0)&&_e.push(e)&&!Oe.__r++||hr!==x.debounceRendering)&&((hr=x.debounceRendering)||fr)(Oe)}function Oe(){for(var e;Oe.__r=_e.length;)e=_e.sort(function(t,r){return t.__v.__b-r.__v.__b}),_e=[],e.some(function(t){var r,a,o,n,s,p;t.__d&&(s=(n=(r=t).__v).__e,(p=r.__P)&&(a=[],(o=q({},n)).__v=n.__v+1,lt(p,n,o,r.__n,p.ownerSVGElement!==void 0,n.__h!=null?[s]:null,a,s==null?ce(n):s,n.__h),yr(a,n),n.__e!=s&&br(n)))})}function jr(e,t,r,a,o,n,s,p,u,f){var c,S,v,g,y,k,$,C=a&&a.__k||vr,O=C.length;for(r.__k=[],c=0;c<t.length;c++)if((g=r.__k[c]=(g=t[c])==null||typeof g=="boolean"?null:typeof g=="string"||typeof g=="number"||typeof g=="bigint"?Ee(null,g,null,null,g):Array.isArray(g)?Ee(ee,{children:g},null,null,null):g.__b>0?Ee(g.type,g.props,g.key,null,g.__v):g)!=null){if(g.__=r,g.__b=r.__b+1,(v=C[c])===null||v&&g.key==v.key&&g.type===v.type)C[c]=void 0;else for(S=0;S<O;S++){if((v=C[S])&&g.key==v.key&&g.type===v.type){C[S]=void 0;break}v=null}lt(e,g,v=v||Fe,o,n,s,p,u,f),y=g.__e,(S=g.ref)&&v.ref!=S&&($||($=[]),v.ref&&$.push(v.ref,null,g),$.push(S,g.__c||y,g)),y!=null?(k==null&&(k=y),typeof g.type=="function"&&g.__k===v.__k?g.__d=u=Sr(g,u,e):u=xr(e,g,v,C,y,u),typeof r.type=="function"&&(r.__d=u)):u&&v.__e==u&&u.parentNode!=e&&(u=ce(v))}for(r.__e=k,c=O;c--;)C[c]!=null&&(typeof r.type=="function"&&C[c].__e!=null&&C[c].__e==r.__d&&(r.__d=ce(a,c+1)),$r(C[c],C[c]));if($)for(c=0;c<$.length;c++)kr($[c],$[++c],$[++c])}function Sr(e,t,r){for(var a,o=e.__k,n=0;o&&n<o.length;n++)(a=o[n])&&(a.__=e,t=typeof a.type=="function"?Sr(a,t,r):xr(r,a,a,o,a.__e,t));return t}function ve(e,t){return t=t||[],e==null||typeof e=="boolean"||(Array.isArray(e)?e.some(function(r){ve(r,t)}):t.push(e)),t}function xr(e,t,r,a,o,n){var s,p,u;if(t.__d!==void 0)s=t.__d,t.__d=void 0;else if(r==null||o!=n||o.parentNode==null)e:if(n==null||n.parentNode!==e)e.appendChild(o),s=null;else{for(p=n,u=0;(p=p.nextSibling)&&u<a.length;u+=2)if(p==o)break e;e.insertBefore(o,n),s=n}return s!==void 0?s:o.nextSibling}function zo(e,t,r,a,o){var n;for(n in r)n==="children"||n==="key"||n in t||Ne(e,n,null,r[n],a);for(n in t)o&&typeof t[n]!="function"||n==="children"||n==="key"||n==="value"||n==="checked"||r[n]===t[n]||Ne(e,n,t[n],r[n],a)}function Cr(e,t,r){t[0]==="-"?e.setProperty(t,r):e[t]=r==null?"":typeof r!="number"||Io.test(t)?r:r+"px"}function Ne(e,t,r,a,o){var n;e:if(t==="style")if(typeof r=="string")e.style.cssText=r;else{if(typeof a=="string"&&(e.style.cssText=a=""),a)for(t in a)r&&t in r||Cr(e.style,t,"");if(r)for(t in r)a&&r[t]===a[t]||Cr(e.style,t,r[t])}else if(t[0]==="o"&&t[1]==="n")n=t!==(t=t.replace(/Capture$/,"")),t=t.toLowerCase()in e?t.toLowerCase().slice(2):t.slice(2),e.l||(e.l={}),e.l[t+n]=r,r?a||e.addEventListener(t,n?Dr:wr,n):e.removeEventListener(t,n?Dr:wr,n);else if(t!=="dangerouslySetInnerHTML"){if(o)t=t.replace(/xlink[H:h]/,"h").replace(/sName$/,"s");else if(t!=="href"&&t!=="list"&&t!=="form"&&t!=="tabIndex"&&t!=="download"&&t in e)try{e[t]=r==null?"":r;break e}catch(s){}typeof r=="function"||(r!=null&&(r!==!1||t[0]==="a"&&t[1]==="r")?e.setAttribute(t,r):e.removeAttribute(t))}}function wr(e){this.l[e.type+!1](x.event?x.event(e):e)}function Dr(e){this.l[e.type+!0](x.event?x.event(e):e)}function lt(e,t,r,a,o,n,s,p,u){var f,c,S,v,g,y,k,$,C,O,K,N=t.type;if(t.constructor!==void 0)return null;r.__h!=null&&(u=r.__h,p=t.__e=r.__e,t.__h=null,n=[p]),(f=x.__b)&&f(t);try{e:if(typeof N=="function"){if($=t.props,C=(f=N.contextType)&&a[f.__c],O=f?C?C.props.value:f.__:a,r.__c?k=(c=t.__c=r.__c).__=c.__E:("prototype"in N&&N.prototype.render?t.__c=c=new N($,O):(t.__c=c=new L($,O),c.constructor=N,c.render=Ro),C&&C.sub(c),c.props=$,c.state||(c.state={}),c.context=O,c.__n=a,S=c.__d=!0,c.__h=[]),c.__s==null&&(c.__s=c.state),N.getDerivedStateFromProps!=null&&(c.__s==c.state&&(c.__s=q({},c.__s)),q(c.__s,N.getDerivedStateFromProps($,c.__s))),v=c.props,g=c.state,S)N.getDerivedStateFromProps==null&&c.componentWillMount!=null&&c.componentWillMount(),c.componentDidMount!=null&&c.__h.push(c.componentDidMount);else{if(N.getDerivedStateFromProps==null&&$!==v&&c.componentWillReceiveProps!=null&&c.componentWillReceiveProps($,O),!c.__e&&c.shouldComponentUpdate!=null&&c.shouldComponentUpdate($,c.__s,O)===!1||t.__v===r.__v){c.props=$,c.state=c.__s,t.__v!==r.__v&&(c.__d=!1),c.__v=t,t.__e=r.__e,t.__k=r.__k,t.__k.forEach(function(J){J&&(J.__=t)}),c.__h.length&&s.push(c);break e}c.componentWillUpdate!=null&&c.componentWillUpdate($,c.__s,O),c.componentDidUpdate!=null&&c.__h.push(function(){c.componentDidUpdate(v,g,y)})}c.context=O,c.props=$,c.state=c.__s,(f=x.__r)&&f(t),c.__d=!1,c.__v=t,c.__P=e,f=c.render(c.props,c.state,c.context),c.state=c.__s,c.getChildContext!=null&&(a=q(q({},a),c.getChildContext())),S||c.getSnapshotBeforeUpdate==null||(y=c.getSnapshotBeforeUpdate(v,g)),K=f!=null&&f.type===ee&&f.key==null?f.props.children:f,jr(e,Array.isArray(K)?K:[K],t,r,a,o,n,s,p,u),c.base=t.__e,t.__h=null,c.__h.length&&s.push(c),k&&(c.__E=c.__=null),c.__e=!1}else n==null&&t.__v===r.__v?(t.__k=r.__k,t.__e=r.__e):t.__e=Lo(r.__e,t,r,a,o,n,s,u);(f=x.diffed)&&f(t)}catch(J){t.__v=null,(u||n!=null)&&(t.__e=p,t.__h=!!u,n[n.indexOf(p)]=null),x.__e(J,t,r)}}function yr(e,t){x.__c&&x.__c(t,e),e.some(function(r){try{e=r.__h,r.__h=[],e.some(function(a){a.call(r)})}catch(a){x.__e(a,r.__v)}})}function Lo(e,t,r,a,o,n,s,p){var u,f,c,S=r.props,v=t.props,g=t.type,y=0;if(g==="svg"&&(o=!0),n!=null){for(;y<n.length;y++)if((u=n[y])&&(u===e||(g?u.localName==g:u.nodeType==3))){e=u,n[y]=null;break}}if(e==null){if(g===null)return document.createTextNode(v);e=o?document.createElementNS("http://www.w3.org/2000/svg",g):document.createElement(g,v.is&&v),n=null,p=!1}if(g===null)S===v||p&&e.data===v||(e.data=v);else{if(n=n&&Pe.call(e.childNodes),f=(S=r.props||Fe).dangerouslySetInnerHTML,c=v.dangerouslySetInnerHTML,!p){if(n!=null)for(S={},y=0;y<e.attributes.length;y++)S[e.attributes[y].name]=e.attributes[y].value;(c||f)&&(c&&(f&&c.__html==f.__html||c.__html===e.innerHTML)||(e.innerHTML=c&&c.__html||""))}if(zo(e,v,S,o,p),c)t.__k=[];else if(y=t.props.children,jr(e,Array.isArray(y)?y:[y],t,r,a,o&&g!=="foreignObject",n,s,n?n[0]:r.__k&&ce(r,0),p),n!=null)for(y=n.length;y--;)n[y]!=null&&gr(n[y]);p||("value"in v&&(y=v.value)!==void 0&&(y!==e.value||g==="progress"&&!y)&&Ne(e,"value",y,S.value,!1),"checked"in v&&(y=v.checked)!==void 0&&y!==e.checked&&Ne(e,"checked",y,S.checked,!1))}return e}function kr(e,t,r){try{typeof e=="function"?e(t):e.current=t}catch(a){x.__e(a,r)}}function $r(e,t,r){var a,o;if(x.unmount&&x.unmount(e),(a=e.ref)&&(a.current&&a.current!==e.__e||kr(a,null,t)),(a=e.__c)!=null){if(a.componentWillUnmount)try{a.componentWillUnmount()}catch(n){x.__e(n,t)}a.base=a.__P=null}if(a=e.__k)for(o=0;o<a.length;o++)a[o]&&$r(a[o],t,typeof e.type!="function");r||e.__e==null||gr(e.__e),e.__e=e.__d=void 0}function Ro(e,t,r){return this.constructor(e,r)}function ct(e,t,r){var a,o,n;x.__&&x.__(e,t),o=(a=typeof r=="function")?null:r&&r.__k||t.__k,n=[],lt(t,e=(!a&&r||t).__k=Q(ee,null,[e]),o||Fe,Fe,t.ownerSVGElement!==void 0,!a&&r?[r]:o?null:t.firstChild?Pe.call(t.childNodes):null,n,!a&&r?r:o?o.__e:t.firstChild,a),yr(n,e)}function Mr(e,t){var r={__c:t="__cC"+_r++,__:e,Consumer:function(a,o){return a.children(o)},Provider:function(a){var o,n;return this.getChildContext||(o=[],(n={})[t]=this,this.getChildContext=function(){return n},this.shouldComponentUpdate=function(s){this.props.value!==s.value&&o.some(st)},this.sub=function(s){o.push(s);var p=s.componentWillUnmount;s.componentWillUnmount=function(){o.splice(o.indexOf(s),1),p&&p.call(s)}}),a.children}};return r.Provider.__=r.Consumer.contextType=r}Pe=vr.slice,x={__e:function(e,t){for(var r,a,o;t=t.__;)if((r=t.__c)&&!r.__)try{if((a=r.constructor)&&a.getDerivedStateFromError!=null&&(r.setState(a.getDerivedStateFromError(e)),o=r.__d),r.componentDidCatch!=null&&(r.componentDidCatch(e),o=r.__d),o)return r.__E=r}catch(n){e=n}throw e}},mr=0,L.prototype.setState=function(e,t){var r;r=this.__s!=null&&this.__s!==this.state?this.__s:this.__s=q({},this.state),typeof e=="function"&&(e=e(q({},r),this.props)),e&&q(r,e),e!=null&&this.__v&&(t&&this.__h.push(t),st(this))},L.prototype.forceUpdate=function(e){this.__v&&(this.__e=!0,e&&this.__h.push(e),st(this))},L.prototype.render=ee,_e=[],fr=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Oe.__r=0,_r=0;var de,P,Ar,dt=0,pt=[],Tr=x.__b,Pr=x.__r,Fr=x.diffed,Er=x.__c,Or=x.unmount;function ge(e,t){x.__h&&x.__h(P,e,dt||t),dt=0;var r=P.__H||(P.__H={__:[],__h:[]});return e>=r.__.length&&r.__.push({}),r.__[e]}function te(e){return dt=1,Bo(Nr,e)}function Bo(e,t,r){var a=ge(de++,2);return a.t=e,a.__c||(a.__=[r?r(t):Nr(void 0,t),function(o){var n=a.t(a.__[0],o);a.__[0]!==n&&(a.__=[n,a.__[1]],a.__c.setState({}))}],a.__c=P),a.__}function Ir(e,t){var r=ge(de++,3);!x.__s&&ut(r.__H,t)&&(r.__=e,r.__H=t,P.__H.__h.push(r))}function zr(e,t){var r=ge(de++,4);!x.__s&&ut(r.__H,t)&&(r.__=e,r.__H=t,P.__h.push(r))}function Lr(e,t){var r=ge(de++,7);return ut(r.__H,t)&&(r.__=e(),r.__H=t,r.__h=e),r.__}function Rr(e){var t=P.context[e.__c],r=ge(de++,9);return r.c=e,t?(r.__==null&&(r.__=!0,t.sub(P)),t.props.value):e.__}function Ho(){pt.forEach(function(e){if(e.__P)try{e.__H.__h.forEach(Ie),e.__H.__h.forEach(mt),e.__H.__h=[]}catch(t){e.__H.__h=[],x.__e(t,e.__v)}}),pt=[]}x.__b=function(e){P=null,Tr&&Tr(e)},x.__r=function(e){Pr&&Pr(e),de=0;var t=(P=e.__c).__H;t&&(t.__h.forEach(Ie),t.__h.forEach(mt),t.__h=[])},x.diffed=function(e){Fr&&Fr(e);var t=e.__c;t&&t.__H&&t.__H.__h.length&&(pt.push(t)!==1&&Ar===x.requestAnimationFrame||((Ar=x.requestAnimationFrame)||function(r){var a,o=function(){clearTimeout(n),Br&&cancelAnimationFrame(a),setTimeout(r)},n=setTimeout(o,100);Br&&(a=requestAnimationFrame(o))})(Ho)),P=null},x.__c=function(e,t){t.some(function(r){try{r.__h.forEach(Ie),r.__h=r.__h.filter(function(a){return!a.__||mt(a)})}catch(a){t.some(function(o){o.__h&&(o.__h=[])}),t=[],x.__e(a,r.__v)}}),Er&&Er(e,t)},x.unmount=function(e){Or&&Or(e);var t=e.__c;if(t&&t.__H)try{t.__H.__.forEach(Ie)}catch(r){x.__e(r,t.__v)}};var Br=typeof requestAnimationFrame=="function";function Ie(e){var t=P;typeof e.__c=="function"&&e.__c(),P=t}function mt(e){var t=P;e.__c=e.__(),P=t}function ut(e,t){return!e||e.length!==t.length||t.some(function(r,a){return r!==e[a]})}function Nr(e,t){return typeof t=="function"?t(e):t}function Go(e,t){for(var r in t)e[r]=t[r];return e}function Hr(e,t){for(var r in e)if(r!=="__source"&&!(r in t))return!0;for(var a in t)if(a!=="__source"&&e[a]!==t[a])return!0;return!1}function Gr(e){this.props=e}(Gr.prototype=new L).isPureReactComponent=!0,Gr.prototype.shouldComponentUpdate=function(e,t){return Hr(this.props,e)||Hr(this.state,t)};var Vr=x.__b;x.__b=function(e){e.type&&e.type.__f&&e.ref&&(e.props.ref=e.ref,e.ref=null),Vr&&Vr(e)};var Vo=x.__e;x.__e=function(e,t,r){if(e.then){for(var a,o=t;o=o.__;)if((a=o.__c)&&a.__c)return t.__e==null&&(t.__e=r.__e,t.__k=r.__k),a.__c(e,t)}Vo(e,t,r)};var Ur=x.unmount;function ft(){this.__u=0,this.t=null,this.__b=null}function qr(e){var t=e.__.__c;return t&&t.__e&&t.__e(e)}function ze(){this.u=null,this.o=null}x.unmount=function(e){var t=e.__c;t&&t.__R&&t.__R(),t&&e.__h===!0&&(e.type=null),Ur&&Ur(e)},(ft.prototype=new L).__c=function(e,t){var r=t.__c,a=this;a.t==null&&(a.t=[]),a.t.push(r);var o=qr(a.__v),n=!1,s=function(){n||(n=!0,r.__R=null,o?o(p):p())};r.__R=s;var p=function(){if(!--a.__u){if(a.state.__e){var f=a.state.__e;a.__v.__k[0]=function S(v,g,y){return v&&(v.__v=null,v.__k=v.__k&&v.__k.map(function(k){return S(k,g,y)}),v.__c&&v.__c.__P===g&&(v.__e&&y.insertBefore(v.__e,v.__d),v.__c.__e=!0,v.__c.__P=y)),v}(f,f.__c.__P,f.__c.__O)}var c;for(a.setState({__e:a.__b=null});c=a.t.pop();)c.forceUpdate()}},u=t.__h===!0;a.__u++||u||a.setState({__e:a.__b=a.__v.__k[0]}),e.then(s,s)},ft.prototype.componentWillUnmount=function(){this.t=[]},ft.prototype.render=function(e,t){if(this.__b){if(this.__v.__k){var r=document.createElement("div"),a=this.__v.__k[0].__c;this.__v.__k[0]=function n(s,p,u){return s&&(s.__c&&s.__c.__H&&(s.__c.__H.__.forEach(function(f){typeof f.__c=="function"&&f.__c()}),s.__c.__H=null),(s=Go({},s)).__c!=null&&(s.__c.__P===u&&(s.__c.__P=p),s.__c=null),s.__k=s.__k&&s.__k.map(function(f){return n(f,p,u)})),s}(this.__b,r,a.__O=a.__P)}this.__b=null}var o=t.__e&&Q(ee,null,e.fallback);return o&&(o.__h=null),[Q(ee,null,t.__e?null:e.children),o]};var Wr=function(e,t,r){if(++r[1]===r[0]&&e.o.delete(t),e.props.revealOrder&&(e.props.revealOrder[0]!=="t"||!e.o.size))for(r=e.u;r;){for(;r.length>3;)r.pop()();if(r[1]<r[0])break;e.u=r=r[2]}};(ze.prototype=new L).__e=function(e){var t=this,r=qr(t.__v),a=t.o.get(e);return a[0]++,function(o){var n=function(){t.props.revealOrder?(a.push(o),Wr(t,e,a)):o()};r?r(n):n()}},ze.prototype.render=function(e){this.u=null,this.o=new Map;var t=ve(e.children);e.revealOrder&&e.revealOrder[0]==="b"&&t.reverse();for(var r=t.length;r--;)this.o.set(t[r],this.u=[1,0,this.u]);return e.children},ze.prototype.componentDidUpdate=ze.prototype.componentDidMount=function(){var e=this;this.o.forEach(function(t,r){Wr(e,r,t)})};var Uo=typeof Symbol!="undefined"&&Symbol.for&&Symbol.for("react.element")||60103,qo=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,Wo=typeof document!="undefined",Ko=function(e){return(typeof Symbol!="undefined"&&typeof Symbol()=="symbol"?/fil|che|rad/i:/fil|che|ra/i).test(e)};L.prototype.isReactComponent={},["componentWillMount","componentWillReceiveProps","componentWillUpdate"].forEach(function(e){Object.defineProperty(L.prototype,e,{configurable:!0,get:function(){return this["UNSAFE_"+e]},set:function(t){Object.defineProperty(this,e,{configurable:!0,writable:!0,value:t})}})});var Kr=x.event;function Jo(){}function Yo(){return this.cancelBubble}function Zo(){return this.defaultPrevented}x.event=function(e){return Kr&&(e=Kr(e)),e.persist=Jo,e.isPropagationStopped=Yo,e.isDefaultPrevented=Zo,e.nativeEvent=e};var Jr={configurable:!0,get:function(){return this.class}},Yr=x.vnode;x.vnode=function(e){var t=e.type,r=e.props,a=r;if(typeof t=="string"){var o=t.indexOf("-")===-1;for(var n in a={},r){var s=r[n];Wo&&n==="children"&&t==="noscript"||n==="value"&&"defaultValue"in r&&s==null||(n==="defaultValue"&&"value"in r&&r.value==null?n="value":n==="download"&&s===!0?s="":/ondoubleclick/i.test(n)?n="ondblclick":/^onchange(textarea|input)/i.test(n+t)&&!Ko(r.type)?n="oninput":/^on(Ani|Tra|Tou|BeforeInp)/.test(n)?n=n.toLowerCase():o&&qo.test(n)?n=n.replace(/[A-Z0-9]/,"-$&").toLowerCase():s===null&&(s=void 0),a[n]=s)}t=="select"&&a.multiple&&Array.isArray(a.value)&&(a.value=ve(r.children).forEach(function(p){p.props.selected=a.value.indexOf(p.props.value)!=-1})),t=="select"&&a.defaultValue!=null&&(a.value=ve(r.children).forEach(function(p){p.props.selected=a.multiple?a.defaultValue.indexOf(p.props.value)!=-1:a.defaultValue==p.props.value})),e.props=a}t&&r.class!=r.className&&(Jr.enumerable="className"in r,r.className!=null&&(a.class=r.className),Object.defineProperty(a,"className",Jr)),e.$$typeof=Uo,Yr&&Yr(e)};var Zr=x.__r;x.__r=function(e){Zr&&Zr(e)};var ht=Mr(),Xo=typeof window!="undefined"?zr:Ir,Qo=e=>(...t)=>{let r=Rr(e),a=te({});return Xo(()=>r.on("@changed",(o,n)=>{t.some(p=>p in n)&&a[1]({})}),[]),Lr(()=>{let o=r.get(),n={};return t.forEach(s=>{n[s]=o[s]}),n.dispatch=r.dispatch,n},[a[0]])},h=Qo(ht);var _t=class extends Error{constructor(t){super("Validation error");this.validations=t}getValidations(){return this.validations}},be=_t;var Xr=e=>Object.assign({accept:"application/ld+json","Content-Type":"application/ld+json"},e),ei={get:async(e,t)=>{var o;let{path:r,headers:a}=e.get().api;try{let n=await(await fetch(`${r}/${t}`,{headers:Xr(a)})).json();if(typeof n!="object")throw new Error("Invalid response");return(o=n["hydra:member"])!=null?o:n}catch(n){throw e.dispatch("moduleState/set","error"),n}},post:async({api:e,dispatch:t},r,a)=>{let{path:o,headers:n}=e,s={method:"POST",headers:Xr(n),body:JSON.stringify(a)};try{var p=await(await fetch(`${o}/${r}`,s)).json()}catch(u){throw t("moduleState/set","error"),u}if(p["@id"])return p;throw p.violations?new be(p.violations):(t("moduleState/set","error"),new Error("Invalid result"))}},D=ei;var Qr=function(e,t,r,a){var o;t[0]=0;for(var n=1;n<t.length;n++){var s=t[n++],p=t[n]?(t[0]|=s?1:2,r[t[n++]]):t[++n];s===3?a[0]=p:s===4?a[1]=Object.assign(a[1]||{},p):s===5?(a[1]=a[1]||{})[t[++n]]=p:s===6?a[1][t[++n]]+=p+"":s?(o=e.apply(p,Qr(e,p,r,["",null])),a.push(o),p[0]?t[0]|=2:(t[n-2]=0,t[n]=o)):a.push(p)}return a},ea=new Map;function ta(e){var t=ea.get(this);return t||(t=new Map,ea.set(this,t)),(t=Qr(this,t.get(e)||(t.set(e,t=function(r){for(var a,o,n=1,s="",p="",u=[0],f=function(v){n===1&&(v||(s=s.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?u.push(0,v,s):n===3&&(v||s)?(u.push(3,v,s),n=2):n===2&&s==="..."&&v?u.push(4,v,0):n===2&&s&&!v?u.push(5,0,!0,s):n>=5&&((s||!v&&n===5)&&(u.push(n,0,s,o),n=6),v&&(u.push(n,v,0,o),n=6)),s=""},c=0;c<r.length;c++){c&&(n===1&&f(),f(c));for(var S=0;S<r[c].length;S++)a=r[c][S],n===1?a==="<"?(f(),u=[u],n=3):s+=a:n===4?s==="--"&&a===">"?(n=1,s=""):s=a+s[0]:p?a===p?p="":s+=a:a==='"'||a==="'"?p=a:a===">"?(f(),n=1):n&&(a==="="?(n=5,o=s,s=""):a==="/"&&(n<5||r[c][S+1]===">")?(f(),n===3&&(u=u[0]),n=u,(u=u[0]).push(2,0,n),n=0):a===" "||a==="	"||a===`
`||a==="\r"?(f(),n=2):s+=a),n===3&&s==="!--"&&(n=4,u=u[0])}return f(),u}(e)),t),arguments,[])).length>1?t:t[0]}var ti=(e,t,...r)=>(t&&t.class&&(t.class=t.class.trim().split(" ").filter(a=>a.trim()).map(a=>a.indexOf("cvio-ab-")!==0?`cvio-ab-${a}`:a).join(" ")),Q(e,t,...r)),l=ta.bind(ti);var ye=e=>{let{dispatch:t,privacyPolicyLink:r}=h("privacyPolicyLink");return r?l`
  ...
  `};var wt=e=>{let{dispatch:t}=h();return l`
  ...
  `;var Ci=async e=>{try{var t=await xi(e)}catch(r){if(r instanceof be){ki(e,r);return}throw r}await $i(e,t),await ji(e,t),e.dispatch("moduleState/set","success")},xi=async e=>{let t=Object.assign({},e.appointment.customer,{medical_records_allowed:e.medicalConsent!="disabled"?!0:null,country:e.country,mobile:e.appointment.customer.mobile?xt(e.store.chain.language,e.appointment.customer.mobile):null});return"birth"in t&&(t.birth=wi(t.birth)),Object.keys(t).forEach(r=>{typeof t[r]=="string"&&(t[r]=t[r].trim())}),await D.post(e,"customers",t)},wi=e=>{if(!e||!(e instanceof Date))return null;let t=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),a=String(e.getDate()).padStart(2,"0");return`${t}-${r}-${a}T00:00:00+00:00`},ki=async(e,t)=>{let{customerForm:r}=e;var a=[];for(let o=0;o<t.getValidations().length;o++){let{propertyPath:n,message:s}=t.getValidations()[o];if(n==""){a.push(s);continue}r[n].errors||(r[n].errors=[]),r[n].errors.push(s)}e.dispatch("customerForm/set",{customerForm:r,customerFormGlobalErrors:a}),e.dispatch("currentStep/set","customer"),e.dispatch("booking/set",!1)},$i=async(e,t)=>{await D.post(e,"customer_consents",{customer:t["@id"],approved_at:new Date,medical_records_allowed:e.medicalConsent!="disabled",source:"api"})},ji=async(e,t)=>{let{appointment:r,language:a,translationOverrides:o,constantAppointmentCommentText:n}=e,s=n||"";r.comment&&(s=(s?s+`

`:"")+r.comment),await D.post(e,"appointment_events",Object.assign({},r,{customer:t["@id"],eye_examination_process:r.eye_examination_process["@id"],calendar:r.calendar["@id"],comment:s||void 0,title:_("%customer%'s examination",{customer:re.format(t,a)},{language:a,translationOverrides:o}),status:"booked",should_send_confirmation_email:!0,should_send_reminder_email:!0,source:"online"}))},La=e=>{var t=h("appointment","api","booking","language","customerForm","customerFormGlobalErrors","country","moduleState","store","translationOverrides","constantAppointmentCommentText","medicalConsent");let{booking:r,moduleState:a,dispatch:o}=t;return l`
    <div class="d-grid">
  ...
  `};var Dt={HUF:0},Di=(e,t)=>{var r=e.price_list.currency,a={style:"currency",currency:r};return Dt[r]!=null&&(a.maximumFractionDigits=Dt[r],a.minimumFractionDigits=Dt[r]),new Intl.NumberFormat(t,a)},Ue=({process:e})=>{if(!e)return l``;let{store:t,language:r,showPrice:a}=h("store","language","showPrice");if(!a)return l``;let o=e.process_services;var n=null,s=null,p=t.price_list.id;o.forEach(f=>{f.service.packagings.forEach(c=>{c.currentPrices.forEach(S=>{S.price_list.id==p&&((n==null||n>S.value)&&(n=S.value),(s==null||s<S.value)&&(s=S.value))})})});var u=Di(t,r);return n==null||s==null?l``:n==s?l`${u.format(n)}`:l`${u.format(n)} - ${u.format(s)}`};var qe=e=>{let{appointment:t,language:r,currentStep:a,store:o,selectedCalendar:n,priceComment:s,showPrice:p,showExaminerName:u,locationName:f,locationAddress:c,showLocation:S,dispatch:v}=h("appointment","language","currentStep","store","selectedCalendar","priceComment","showPrice","showExaminerName","locationName","locationAddress","showLocation");if(!o)return;var g=t.calendar||n,y={dateTimeStart:t.start?M.formatDateTime(t.start):null,dateTimeEnd:t.end?M.formatDateTime(t.end):null,processLength:t.eye_examination_process?t.eye_examination_process.length:null,processName:t.eye_examination_process?t.eye_examination_process.name:null,process:t.eye_examination_process,examinerName:u&&g?g.user.name:null,customer:t.customer,customerAddress:pe.formatAddress(t.customer),showLocation:S,locationName:f!==null?f:o.name,locationAddress:c!==null?c:pe.formatAddress(o),appointmentComment:t.comment};let k=()=>{v("currentStep/set","appointment")};return l`
    <ul class="list-group${a=="summary"?"":" text-end"}">
      ${a!="summary"?l`<li class="list-group-item fw-bold">${_("Appointment summary")}</li>`:null}
      ${y.processName?l`
        <li class="list-group-item">
          <div>${_("Subject")}:</div>
          <div class="fw-bold">${y.processName}</div>
          <div>
            ${y.examinerName?l`${_("examiner: %examiner%",{examiner:y.examinerName})}`:null}
          </div>
        </li>
      `:""}
      ${y.dateTimeStart&&y.dateTimeEnd&&y.processLength?l`
        <li class="list-group-item">
          ...
          <div class="text-muted">
            ${_("It takes up to %length% minutes",{length:y.processLength})}
          </div>
          <div class="fs-6">
      ...
      ${a=="summary"?l`
        <li class="list-group-item">
          <${za} customer=${y.customer} customerAddress=${y.customerAddress}/>
        </li>
      `:""}
      ${a=="summary"&&y.appointmentComment?l`
        <li class="list-group-item">
          ${_("Comment")}: ${y.appointmentComment}
        </li>
      `:""}
      ${y.showLocation?l`
            <li class="list-group-item">
              <div>${_("Location")}:</div>
              <div class="fw-bold">${y.locationName}</div>
              <div>${y.locationAddress}</div>
            </li>
        `:""}
      <li class="list-group-item">
        ${p?l`
          <div>${_("Price")}:</div>
          <div class="fw-bold"><${Ue} process=${y.process}/></div>
        `:""}
        <div>${s||""}</div>
      </li>
      ${a=="summary"?l`
  ...
  `};var Ra=e=>{let{appointment:t,dispatch:r,currentStep:a}=h("appointment","currentStep"),o=()=>{a==="process"&&(r("appointment/set",{eye_examination_process:e.item}),r("currentStep/eyeExaminationProcessSelected"),r("currentStep/next"))},n=s=>{s.stopPropagation(),r("detailedDescriptionModalState/set",e.item.detailed_description)};return l`
      ...
      <div class="row">
        <div class="col-11 p-0">
          ...
          <p class="${e.item.description&&e.item.description.length>0?"":"d-none"}">
            ${e.item.description}
            ${e.item.detailed_description&&e.item.detailed_description.length>0?l` <a href="#" onClick=${n}>${_("More...")}</a>`:""}
          </p>
          <span class="badge bg-primary me-1">${e.item.length} ${_("@abbrMinute")}</span>
  ...
  `};var Ba=e=>{let{eyeExaminationProcesses:t}=h("eyeExaminationProcesses"),{detailedDescriptionModalState:r,dispatch:a}=h("detailedDescriptionModalState"),o=()=>a("detailedDescriptionModalState/set",!1);return l`
    <ul class="list-group">
      ${t.length?t.map(n=>l`<${Ra} item=${n} />`):l`<li class="list-group-item"><${B}/></li>`}
    </ul>
  ...
  `};var Ha=()=>l`
    ...
    </li>`;var Ga=e=>{let{appointment:t,showFirstAvailableUserItem:r,dispatch:a}=h("appointment","showFirstAvailableUserItem"),o=Se(h("calendars","appointment","calendarRoleCheckMode")),n={user:{name:_("First free"),description:_("For finding the nearest free time slot.")}},s=()=>a("currentStep/previous");return l`
    <ul class="list-group">
  ...
  `};var Mi=["@abbrSunday","@abbrMonday","@abbrTuesday","@abbrWednesday","@abbrThursday","@abbrFriday","@abbrSaturday"],Va=({date:e})=>{let{selectedDate:t,dispatch:r}=h("selectedDate"),a=()=>r("selectedDate/set",e);return l`
    <div class="col">
  ...
  `};var Ua=({dateGroup:e,visibleDateGroups:t})=>{let{previousDateGroup:r,currentDateGroup:a,nextDateGroup:o}=t;return l`
    <div class="carousel-item
  ...
  `};var Ai=["January","February","March","April","May","June","July","August","September","October","November","December"],qa=e=>{let{selectedDate:t,firstEligibleDate:r,dispatch:a}=h("selectedDate","firstEligibleDate"),o=bt(r),n=()=>a("selectedDate/set",p[4]),s=()=>a("selectedDate/set",f[0]);var p,u,f;for(let S=0;S<o.length&&(p=o[S-1],u=o[S],f=o[S+1],!u.hasDate(t));S++);let c={previousDateGroup:p,currentDateGroup:u,nextDateGroup:f};return l`
    <div class="dateSelection hstack gap-1">
      ...
      <div class="carousel-container">
        <div>${_(Ai[u[0].getMonth()])}</div>
        <div class="carousel slide">
          <div class="carousel-inner">
            ${o.map(S=>l`<${Ua} dateGroup=${S} visibleDateGroups=${c}/>`)}
          </div>
        </div>
      </div>
  ...
  `};var Wa=({day:e})=>{let{selectedCalendar:t,selectedDate:r,nextFreeSlots:a,appointment:o,dispatch:n}=h("selectedCalendar","appointment","nextFreeSlots","selectedDate"),s=a[E(o,t,e)],p=u=>{n("selectedDate/set",u)};return e<new Date||s&&s.status=="empty"?l`<td class='table-active disabled'>${e.getDate()}</td>`:s?l`
    <td class=${R(e,r)?"bg-primary text-light":"active-cell"} 
      onClick="${()=>p(e)}"
    >
      ${e.getDate()}
    </td>
  `:l`<td class="placeholder">${e.getDate()}</td>`};var Ti=["January","February","March","April","May","June","July","August","September","October","November","December"],Pi=["@abbrMonday","@abbrTuesday","@abbrWednesday","@abbrThursday","@abbrFriday","@abbrSaturday","@abbrSunday"],Ka=()=>{let{selectedCalendar:e,selectedDate:t,nextFreeSlots:r,appointment:a,dispatch:o}=h("selectedCalendar","appointment","nextFreeSlots","selectedDate"),n=t.getFullYear(),s=t.getMonth(),p=new Date(n,s+1,0).getDate(),u=new Date<new Date(n,s,0),f=new Date(n,s,1),c=[],S=[];var v=!0;for(let k=t.getDate();k<=p;k++){let $=r[E(a,e,new Date(n,s,k))];if($==null||$.status=="incomplete"){v=!1;break}}for(let k=0;k<(f.getDay()||7)-1;k++)c.push(null);for(let k=1;k<=p;k++)c.push(new Date(n,s,k));for(let k=0;k<c.length;k+=7)S.push(c.slice(k,k+7));let g=()=>{o("selectedDate/set",new Date(n,s+1,1))};return l`
        ...
        <div class="col">
          <table class="table table caption-top placeholder-glow">
            <caption class="text-center display-6">
              ...
              ${n+" "+_(Ti[s])}
              <button class="btn btn-outline-secondary month-next ${v?null:"disabled"}" onClick="${g}">
                ${">"}
              </button>
            </caption>
            <thead>
              <tr>
                ${Pi.map(k=>l`<th scope="col">${_(k)}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${S.map(k=>l`
  ...
  `};var Ja=e=>{let{dispatch:t,appointment:r}=h("appointment"),a=()=>{t("appointment/selectSlot",e.slot)};return l`
  ...
  `};var Ya=()=>{let{selectedDate:e,selectedCalendar:t,appointment:r,nextFreeSlots:a}=h("selectedCalendar","selectedDate","nextFreeSlots","appointment");var o=E(r,t,e);return l`
    <ul class="list-group mt-3">
      ${a[o]?a[o].status=="empty"?l`<${We}/>`:a[o].slots.map(n=>l`<${Ja} slot=${n}/>`):l`<li class="list-group-item"><${B}/></li>`}
    </ul>
  `};var Za=({slot:e})=>{let{dispatch:t,appointment:r}=h("appointment"),a=()=>{t("appointment/selectSlot",e)},o=xe(new Date(r.start),new Date(e.start));return l`
  ...
  `};var Ke=({title:e,slots:t})=>t.length?l`
      ...
      `:null;var Xa=()=>{let{selectedDate:e,selectedCalendar:t,appointment:r,nextFreeSlots:a}=h("selectedCalendar","selectedDate","nextFreeSlots","appointment"),o=E(r,t,e),n=[],s=[],p=[],u=a[o]?a[o].slots:[];for(let f of u||[]){let c=new Date(f.start);c.getHours()<12?n.push(f):c.getHours()<18?s.push(f):p.push(f)}return l`
    <div class="grid">
  ...
  `};var Qa=()=>{let{calendarRange:e,timeSlotMode:t}=h("calendarRange","timeSlotMode");return l`
    <${e=="fiveDays"?qa:Ka}/>
    <${t=="singleColumn"?Ya:Xa}/>
  `};var en=e=>{let{appointment:t,dispatch:r}=h("appointment"),a=o=>{let{value:n}=o.target;var{customer:s}=t;s[e.property]=n,r("appointment/set",{customer:s})};return l`
  ...
  `};var A=e=>{let{customerForm:t}=h("customerForm");if(!!t[e.property]){var r=t[e.property];return l`
    <div class="${e.class||"col-sm"} needs-validation p-1 mb-2 w-100">
      ${e.label?l`
        ...
        `:null}
      <${e.inputClass||en} property=${e.property}
  ...
  `}};var tn=e=>{let{appointment:t,showAppointmentComment:r,appointmentCommentRequired:a,commentError:o,dispatch:n}=h("appointment","showAppointmentComment","appointmentCommentRequired","commentError");if(!r)return l``;let s=p=>{let{value:u}=p.target;t.comment=u,n("appointment/set",t),n("customerForm/set",{commentError:null})};return l`
      <div class="row mx-2">
  ...
  `};var Fi=e=>(e=e||new Date,e=new Date(e.getFullYear(),e.getMonth()+1,0),e.getDate()),rn=e=>{let{appointment:t,dispatch:r}=h("appointment"),a=(u,f)=>{var{customer:c}=t;f==""?c[e.property]=null:(c[e.property]=c[e.property]||new Date("2000-01-01"),c[e.property][`set${u}`](f)),r("appointment/set",{customer:c})},o=t.customer[e.property];var n=[];for(let u=1900;u<=new Date().getFullYear();u++)n.push({value:u,label:u});var s=[];for(let u=1;u<=12;u++)s.push({value:u-1,label:u<10?`0${u}`:u});var p=[];for(let u=1;u<=Fi(o);u++)p.push({value:u,label:u<10?`0${u}`:u});return l`
  ...
  `};var an=e=>{let{appointment:t,dispatch:r}=h("appointment");return l`
  ...
  `};var nn=e=>{let{appointment:t,privacyPolicy:r,dispatch:a}=h("appointment","privacyPolicy"),o=()=>{var{customer:s}=t;s[e.property]=!s[e.property]||null,a("appointment/set",{customer:s})},n=()=>a("privacyPolicyModalState/set",!1);return l`
  ...
  `};var on=e=>{let{appointment:t,dispatch:r}=h("appointment"),a=()=>{var{customer:o}=t;o[e.property]=!o[e.property]||null,r("appointment/set",{customer:o})};return l`
  ...
  `};var sn=e=>{let{customerForm:t,customerFormGlobalErrors:r,medicalConsent:a,dispatch:o}=h("customerForm","customerFormGlobalErrors","language","medicalConsent"),n=()=>{o("customerForm/validateAndNext")};return l`
    <div class="card p-2">
      ${r&&r.length?l`
      ...
      <div class="row mx-2">
        <${A} class="col-lg-5" property="birth" label="Birth" inputClass=${rn}/>
        <${A} property="gender" label="Gender" inputClass=${an}/>
      ...
      <${tn}/>
      <div class="row mx-2">
        <${A} property="acceptPrivacyPolicy" inputClass=${nn}/>
      </div>
      ${a=="explicit"?l`
          <div class="row mx-2">
            <${A} property="acceptMedicalRecordsUse" inputClass=${on}/>
          </div>
        `:""}
      <button class="mx-2 btn btn-primary" onClick=${n}>${_("Next")}</button>
    </div>
  `};var ln=({item:e})=>{let{store:t,dispatch:r,currentStep:a}=h("store","currentStep"),o=()=>{a==="storeSelection"&&(r("store/set",e),r("currentStep/next"))},n=pe.formatAddress(e);return l`
  ...
  `};var cn=()=>l`
    ...
    </li>`;var dn=e=>{let{stores:t}=h("stores");return t!==null?(t.sort((r,a)=>r.name.localeCompare(a.name)),t.map(r=>l`<${ln} item=${r}/>`)):l`<${cn}/>`};var At=e=>l`
    <div class="carousel slide">
      <div class="carousel-inner">
        <${ne} step="storeSelection" wrappedComponent=${dn}/>
        <${ne} step="process" wrappedComponent=${Ba}/>
        <${ne} step="calendar" wrappedComponent=${Ga}/>
        <${ne} step="appointment" wrappedComponent=${Qa}/>
        <${ne} step="customer" wrappedComponent=${sn}/>
  ...
  `};var pn=e=>{let{headerTitle:t,currentStep:r,style:a,parentWidth:o}=h("headerTitle","currentStep","style","parentWidth");switch(r){case"storeSelection":var n=_("Store selection");break;case"process":var n=_("Select eye examination type");break;case"calendar":var n=_("Select a vision expert");break;case"appointment":var n=_("Select your desired appointment time");break;case"customer":var n=_("Enter customer details");break;default:var n=_("Appointment details verification");break}return l`
        ...
        <div class="row">
          ...
          <div class="col-4">
            <div class="btn-group btn-group-lg float-end" role="group" aria-label="Navigation buttons">
              <${Ct}/>
              ${a==="embedded"||a==="embedded-safe"?"":l`<${wt}/>`}
            </div>
          </div>
        </div>
      </div>
