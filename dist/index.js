...
`||a==="\r"?(d(),o=2):i+=a),o===3&&i==="!--"&&(o=4,c=c[0])}return d(),c}(e)),t),arguments,[])).length>1?t:t[0]}var Br=(e,t,...r)=>(t&&t.class&&(t.class=t.class.trim().split(" ").filter(a=>a.trim()).map(a=>a.indexOf("cvio-ab-")!==0?`cvio-ab-${a}`:a).join(" ")),O(e,t,...r)),l=Dt.bind(Br);var $e=e=>{let{dispatch:t}=f();return l`
  ...
  `};var Oe=e=>{let{selectedCalendar:t,dispatch:r}=f("selectedCalendar"),a=()=>{r("selectedCalendar/set",e.item["@id"]?e.item:null),r("currentStep/next")};return l`
  ...
  `};var sr=e=>{let{appointment:t,dispatch:r}=f("appointment"),a=Y(f("calendars")),n={user:{name:u("First free"),description:u("For finding the nearest free time slot.")}},o=()=>r("currentStep/previous");return l`
    <ul class="list-group">
