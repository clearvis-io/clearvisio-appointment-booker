...
`||a==="\r"?(d(),o=2):i+=a),o===3&&i==="!--"&&(o=4,c=c[0])}return d(),c}(e)),t),arguments,[])).length>1?t:t[0]}var Br=(e,t,...r)=>(t&&t.class&&(t.class=t.class.trim().split(" ").filter(a=>a.trim()).map(a=>a.indexOf("cvio-ab-")!==0?`cvio-ab-${a}`:a).join(" ")),I(e,t,...r)),l=Dt.bind(Br);var $e=e=>{let{dispatch:t}=_();return l`
  ...
  `;var z=e=>{let t=_(e.modalStateStore),r=t[e.modalStateStore],[a,n]=N(!1),[o,i]=N(!1),[p,c]=N(!1);r&&!a&&(i(!0),setTimeout(()=>{c(!0),n(!0)},0)),!r&&a&&(c(!1),setTimeout(()=>{i(!1),n(!1)},100));let d=()=>t.dispatch(`${e.modalStateStore}/set`,!1);return l`
  ...
  `};var ze={HUF:0},ia=(e,t)=>{var r=e.price_list.currency,a={style:"currency",currency:r};return ze[r]!=null&&(a.maximumFractionDigits=ze[r],a.minimumFractionDigits=ze[r]),new Intl.NumberFormat(t,a)},ue=({process:e})=>{if(!e)return l``;let t=e.process_services,{store:r,language:a}=_("store","language");var n=null,o=null,i=r.price_list.id;t.forEach(c=>{c.service.packagings.forEach(d=>{d.currentPrices.forEach(s=>{s.price_list.id==i&&((n==null||n>s.value)&&(n=s.value),(o==null||o<s.value)&&(o=s.value))})})});var p=ia(r,a);return n==null||o==null?l``:n==o?l`${p.format(n)}`:l`${p.format(n)} - ${p.format(o)}`};var de=e=>{let{appointment:t,language:r,currentStep:a,store:n,selectedCalendar:o,priceComment:i}=_("appointment","language","currentStep","store","selectedCalendar","priceComment");if(!!n){var p=["state","postal_code","city","street_address"],c=[];p.forEach(v=>{!t.customer[v]||c.push(t.customer[v])});var d=t.calendar||o,s={dateTimeStart:t.start?$.formatDateTime(t.start):null,dateTimeEnd:t.end?$.formatDateTime(t.end):null,processLength:t.eye_examination_process?t.eye_examination_process.length:null,processName:t.eye_examination_process?t.eye_examination_process.name:null,process:t.eye_examination_process,examinerName:d?d.user.name:null,customer:t.customer,customerAddress:c.join(", "),storeAddress:n.postal_code+" "+n.city+", "+n.street_address};return l`
  ...
  `};var Ie=e=>{let{selectedCalendar:t,dispatch:r}=_("selectedCalendar"),a=()=>{r("selectedCalendar/set",e.item["@id"]?e.item:null),r("currentStep/next")};return l`
  ...
  `};var sr=e=>{let{appointment:t,showFirstAvailableUserItem:r,dispatch:a}=_("appointment","showFirstAvailableUserItem"),n=Y(_("calendars")),o={user:{name:u("First free"),description:u("For finding the nearest free time slot.")}},i=()=>a("currentStep/previous");return l`
    <ul class="list-group">
  ...
  `};var la=["January","February","March","April","May","June","July","August","September","October","November","December"],pr=e=>{let{selectedDate:t,firstEligibleDate:r,dispatch:a}=_("selectedDate","firstEligibleDate"),n=we(r),o=()=>a("selectedDate/set",p[4]),i=()=>a("selectedDate/set",d[0]);var p,c,d;for(let v=0;v<n.length&&(p=n[v-1],c=n[v],d=n[v+1],!c.hasDate(t));v++);let s={previousDateGroup:p,currentDateGroup:c,nextDateGroup:d};return l`
  ...
  `};var ur=e=>{let{selectedCalendar:t,selectedDate:r,nextFreeSlots:a,appointment:n,dispatch:o}=_("selectedCalendar","appointment","nextFreeSlots","selectedDate");var i=new Date(r),p,c=!1;for(i.setDate(i.getDate()+1);a[p=M(n,t,i)];){if(a[p].status!=="empty"){c=!0;break}i.setDate(i.getDate()+1)}let d=()=>o("selectedDate/set",i);return l`
