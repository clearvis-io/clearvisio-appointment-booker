const availableStates = ['idle', 'loading', 'error', 'success', 'error.storeCode', 'error.403', 'error.noLength', 'error.storeEmail', 'error.missingConfiguredProcessId', 'error.noProcessOrLength']
