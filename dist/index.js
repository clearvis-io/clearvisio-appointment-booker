var ze,k,hr,ge,vr,gr,_r,Fe={},br=[],Vn=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;function q(e,t){for(var r in t)e[r]=t[r];return e}function yr(e){var t=e.parentNode;t&&t.removeChild(e)}function ee(e,t,r){var a,n,o,s={};for(o in t)o=="key"?a=t[o]:o=="ref"?n=t[o]:s[o]=t[o];if(arguments.length>2&&(s.children=arguments.length>3?ze.call(arguments,2):r),typeof e=="function"&&e.defaultProps!=null)for(o in e.defaultProps)s[o]===void 0&&(s[o]=e.defaultProps[o]);return Ee(e,s,a,n,null)}function Ee(e,t,r,a,n){var o={type:e,props:t,key:r,ref:a,__k:null,__:null,__b:0,__e:null,__d:void 0,__c:null,__h:null,constructor:void 0,__v:n==null?++hr:n};return n==null&&k.vnode!=null&&k.vnode(o),o}function te(e){return e.children}function L(e,t){this.props=e,this.context=t}function de(e,t){if(t==null)return e.__?de(e.__,e.__.__k.indexOf(e)+1):null;for(var r;t<e.__k.length;t++)if((r=e.__k[t])!=null&&r.__e!=null)return r.__e;return typeof e.type=="function"?de(e):null}function Sr(e){var t,r;if((e=e.__)!=null&&e.__c!=null){for(e.__e=e.__c.base=null,t=0;t<e.__k.length;t++)if((r=e.__k[t])!=null&&r.__e!=null){e.__e=e.__c.base=r.__e;break}return Sr(e)}}function lt(e){(!e.__d&&(e.__d=!0)&&ge.push(e)&&!Ne.__r++||gr!==k.debounceRendering)&&((gr=k.debounceRendering)||vr)(Ne)}function Ne(){for(var e;Ne.__r=ge.length;)e=ge.sort(function(t,r){return t.__v.__b-r.__v.__b}),ge=[],e.some(function(t){var r,a,n,o,s,c;t.__d&&(s=(o=(r=t).__v).__e,(c=r.__P)&&(a=[],(n=q({},o)).__v=o.__v+1,ct(c,o,n,r.__n,c.ownerSVGElement!==void 0,o.__h!=null?[s]:null,a,s==null?de(o):s,o.__h),kr(a,o),o.__e!=s&&Sr(o)))})}function Cr(e,t,r,a,n,o,s,c,u,h){var d,S,g,b,_,x,$,j=a&&a.__k||br,E=j.length;for(r.__k=[],d=0;d<t.length;d++)if((b=r.__k[d]=(b=t[d])==null||typeof b=="boolean"?null:typeof b=="string"||typeof b=="number"||typeof b=="bigint"?Ee(null,b,null,null,b):Array.isArray(b)?Ee(te,{children:b},null,null,null):b.__b>0?Ee(b.type,b.props,b.key,null,b.__v):b)!=null){if(b.__=r,b.__b=r.__b+1,(g=j[d])===null||g&&b.key==g.key&&b.type===g.type)j[d]=void 0;else for(S=0;S<E;S++){if((g=j[S])&&b.key==g.key&&b.type===g.type){j[S]=void 0;break}g=null}ct(e,b,g=g||Fe,n,o,s,c,u,h),_=b.__e,(S=b.ref)&&g.ref!=S&&($||($=[]),g.ref&&$.push(g.ref,null,b),$.push(S,b.__c||_,b)),_!=null?(x==null&&(x=_),typeof b.type=="function"&&b.__k===g.__k?b.__d=u=xr(b,u,e):u=$r(e,b,g,j,_,u),typeof r.type=="function"&&(r.__d=u)):u&&g.__e==u&&u.parentNode!=e&&(u=de(g))}for(r.__e=x,d=E;d--;)j[d]!=null&&(typeof r.type=="function"&&j[d].__e!=null&&j[d].__e==r.__d&&(r.__d=de(a,d+1)),wr(j[d],j[d]));if($)for(d=0;d<$.length;d++)jr($[d],$[++d],$[++d])}function xr(e,t,r){for(var a,n=e.__k,o=0;n&&o<n.length;o++)(a=n[o])&&(a.__=e,t=typeof a.type=="function"?xr(a,t,r):$r(r,a,a,n,a.__e,t));return t}function _e(e,t){return t=t||[],e==null||typeof e=="boolean"||(Array.isArray(e)?e.some(function(r){_e(r,t)}):t.push(e)),t}function $r(e,t,r,a,n,o){var s,c,u;if(t.__d!==void 0)s=t.__d,t.__d=void 0;else if(r==null||n!=o||n.parentNode==null)e:if(o==null||o.parentNode!==e)e.appendChild(n),s=null;else{for(c=o,u=0;(c=c.nextSibling)&&u<a.length;u+=2)if(c==n)break e;e.insertBefore(n,o),s=o}return s!==void 0?s:n.nextSibling}function Un(e,t,r,a,n){var o;for(o in r)o==="children"||o==="key"||o in t||Ie(e,o,null,r[o],a);for(o in t)n&&typeof t[o]!="function"||o==="children"||o==="key"||o==="value"||o==="checked"||r[o]===t[o]||Ie(e,o,t[o],r[o],a)}function Dr(e,t,r){t[0]==="-"?e.setProperty(t,r):e[t]=r==null?"":typeof r!="number"||Vn.test(t)?r:r+"px"}function Ie(e,t,r,a,n){var o;e:if(t==="style")if(typeof r=="string")e.style.cssText=r;else{if(typeof a=="string"&&(e.style.cssText=a=""),a)for(t in a)r&&t in r||Dr(e.style,t,"");if(r)for(t in r)a&&r[t]===a[t]||Dr(e.style,t,r[t])}else if(t[0]==="o"&&t[1]==="n")o=t!==(t=t.replace(/Capture$/,"")),t=t.toLowerCase()in e?t.toLowerCase().slice(2):t.slice(2),e.l||(e.l={}),e.l[t+o]=r,r?a||e.addEventListener(t,o?Pr:Tr,o):e.removeEventListener(t,o?Pr:Tr,o);else if(t!=="dangerouslySetInnerHTML"){if(n)t=t.replace(/xlink[H:h]/,"h").replace(/sName$/,"s");else if(t!=="href"&&t!=="list"&&t!=="form"&&t!=="tabIndex"&&t!=="download"&&t in e)try{e[t]=r==null?"":r;break e}catch(s){}typeof r=="function"||(r!=null&&(r!==!1||t[0]==="a"&&t[1]==="r")?e.setAttribute(t,r):e.removeAttribute(t))}}function Tr(e){this.l[e.type+!1](k.event?k.event(e):e)}function Pr(e){this.l[e.type+!0](k.event?k.event(e):e)}function ct(e,t,r,a,n,o,s,c,u){var h,d,S,g,b,_,x,$,j,E,J,N=t.type;if(t.constructor!==void 0)return null;r.__h!=null&&(u=r.__h,c=t.__e=r.__e,t.__h=null,o=[c]),(h=k.__b)&&h(t);try{e:if(typeof N=="function"){if($=t.props,j=(h=N.contextType)&&a[h.__c],E=h?j?j.props.value:h.__:a,r.__c?x=(d=t.__c=r.__c).__=d.__E:("prototype"in N&&N.prototype.render?t.__c=d=new N($,E):(t.__c=d=new L($,E),d.constructor=N,d.render=Kn),j&&j.sub(d),d.props=$,d.state||(d.state={}),d.context=E,d.__n=a,S=d.__d=!0,d.__h=[]),d.__s==null&&(d.__s=d.state),N.getDerivedStateFromProps!=null&&(d.__s==d.state&&(d.__s=q({},d.__s)),q(d.__s,N.getDerivedStateFromProps($,d.__s))),g=d.props,b=d.state,S)N.getDerivedStateFromProps==null&&d.componentWillMount!=null&&d.componentWillMount(),d.componentDidMount!=null&&d.__h.push(d.componentDidMount);else{if(N.getDerivedStateFromProps==null&&$!==g&&d.componentWillReceiveProps!=null&&d.componentWillReceiveProps($,E),!d.__e&&d.shouldComponentUpdate!=null&&d.shouldComponentUpdate($,d.__s,E)===!1||t.__v===r.__v){d.props=$,d.state=d.__s,t.__v!==r.__v&&(d.__d=!1),d.__v=t,t.__e=r.__e,t.__k=r.__k,t.__k.forEach(function(Y){Y&&(Y.__=t)}),d.__h.length&&s.push(d);break e}d.componentWillUpdate!=null&&d.componentWillUpdate($,d.__s,E),d.componentDidUpdate!=null&&d.__h.push(function(){d.componentDidUpdate(g,b,_)})}d.context=E,d.props=$,d.state=d.__s,(h=k.__r)&&h(t),d.__d=!1,d.__v=t,d.__P=e,h=d.render(d.props,d.state,d.context),d.state=d.__s,d.getChildContext!=null&&(a=q(q({},a),d.getChildContext())),S||d.getSnapshotBeforeUpdate==null||(_=d.getSnapshotBeforeUpdate(g,b)),J=h!=null&&h.type===te&&h.key==null?h.props.children:h,Cr(e,Array.isArray(J)?J:[J],t,r,a,n,o,s,c,u),d.base=t.__e,t.__h=null,d.__h.length&&s.push(d),x&&(d.__E=d.__=null),d.__e=!1}else o==null&&t.__v===r.__v?(t.__k=r.__k,t.__e=r.__e):t.__e=qn(r.__e,t,r,a,n,o,s,u);(h=k.diffed)&&h(t)}catch(Y){t.__v=null,(u||o!=null)&&(t.__e=c,t.__h=!!u,o[o.indexOf(c)]=null),k.__e(Y,t,r)}}function kr(e,t){k.__c&&k.__c(t,e),e.some(function(r){try{e=r.__h,r.__h=[],e.some(function(a){a.call(r)})}catch(a){k.__e(a,r.__v)}})}function qn(e,t,r,a,n,o,s,c){var u,h,d,S=r.props,g=t.props,b=t.type,_=0;if(b==="svg"&&(n=!0),o!=null){for(;_<o.length;_++)if((u=o[_])&&(u===e||(b?u.localName==b:u.nodeType==3))){e=u,o[_]=null;break}}if(e==null){if(b===null)return document.createTextNode(g);e=n?document.createElementNS("http://www.w3.org/2000/svg",b):document.createElement(b,g.is&&g),o=null,c=!1}if(b===null)S===g||c&&e.data===g||(e.data=g);else{if(o=o&&ze.call(e.childNodes),h=(S=r.props||Fe).dangerouslySetInnerHTML,d=g.dangerouslySetInnerHTML,!c){if(o!=null)for(S={},_=0;_<e.attributes.length;_++)S[e.attributes[_].name]=e.attributes[_].value;(d||h)&&(d&&(h&&d.__html==h.__html||d.__html===e.innerHTML)||(e.innerHTML=d&&d.__html||""))}if(Un(e,g,S,n,c),d)t.__k=[];else if(_=t.props.children,Cr(e,Array.isArray(_)?_:[_],t,r,a,n&&b!=="foreignObject",o,s,o?o[0]:r.__k&&de(r,0),c),o!=null)for(_=o.length;_--;)o[_]!=null&&yr(o[_]);c||("value"in g&&(_=g.value)!==void 0&&(_!==e.value||b==="progress"&&!_)&&Ie(e,"value",_,S.value,!1),"checked"in g&&(_=g.checked)!==void 0&&_!==e.checked&&Ie(e,"checked",_,S.checked,!1))}return e}function jr(e,t,r){try{typeof e=="function"?e(t):e.current=t}catch(a){k.__e(a,r)}}function wr(e,t,r){var a,n;if(k.unmount&&k.unmount(e),(a=e.ref)&&(a.current&&a.current!==e.__e||jr(a,null,t)),(a=e.__c)!=null){if(a.componentWillUnmount)try{a.componentWillUnmount()}catch(o){k.__e(o,t)}a.base=a.__P=null}if(a=e.__k)for(n=0;n<a.length;n++)a[n]&&wr(a[n],t,typeof e.type!="function");r||e.__e==null||yr(e.__e),e.__e=e.__d=void 0}function Kn(e,t,r){return this.constructor(e,r)}function dt(e,t,r){var a,n,o;k.__&&k.__(e,t),n=(a=typeof r=="function")?null:r&&r.__k||t.__k,o=[],ct(t,e=(!a&&r||t).__k=ee(te,null,[e]),n||Fe,Fe,t.ownerSVGElement!==void 0,!a&&r?[r]:n?null:t.firstChild?ze.call(t.childNodes):null,o,!a&&r?r:n?n.__e:t.firstChild,a),kr(o,e)}function Ar(e,t){var r={__c:t="__cC"+_r++,__:e,Consumer:function(a,n){return a.children(n)},Provider:function(a){var n,o;return this.getChildContext||(n=[],(o={})[t]=this,this.getChildContext=function(){return o},this.shouldComponentUpdate=function(s){this.props.value!==s.value&&n.some(lt)},this.sub=function(s){n.push(s);var c=s.componentWillUnmount;s.componentWillUnmount=function(){n.splice(n.indexOf(s),1),c&&c.call(s)}}),a.children}};return r.Provider.__=r.Consumer.contextType=r}ze=br.slice,k={__e:function(e,t){for(var r,a,n;t=t.__;)if((r=t.__c)&&!r.__)try{if((a=r.constructor)&&a.getDerivedStateFromError!=null&&(r.setState(a.getDerivedStateFromError(e)),n=r.__d),r.componentDidCatch!=null&&(r.componentDidCatch(e),n=r.__d),n)return r.__E=r}catch(o){e=o}throw e}},hr=0,L.prototype.setState=function(e,t){var r;r=this.__s!=null&&this.__s!==this.state?this.__s:this.__s=q({},this.state),typeof e=="function"&&(e=e(q({},r),this.props)),e&&q(r,e),e!=null&&this.__v&&(t&&this.__h.push(t),lt(this))},L.prototype.forceUpdate=function(e){this.__v&&(this.__e=!0,e&&this.__h.push(e),lt(this))},L.prototype.render=te,ge=[],vr=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,Ne.__r=0,_r=0;var pe,z,Mr,pt=0,ut=[],zr=k.__b,Fr=k.__r,Er=k.diffed,Nr=k.__c,Ir=k.unmount;function be(e,t){k.__h&&k.__h(z,e,pt||t),pt=0;var r=z.__H||(z.__H={__:[],__h:[]});return e>=r.__.length&&r.__.push({}),r.__[e]}function re(e){return pt=1,Wn(Or,e)}function Wn(e,t,r){var a=be(pe++,2);return a.t=e,a.__c||(a.__=[r?r(t):Or(void 0,t),function(n){var o=a.t(a.__[0],n);a.__[0]!==o&&(a.__=[o,a.__[1]],a.__c.setState({}))}],a.__c=z),a.__}function Lr(e,t){var r=be(pe++,3);!k.__s&&mt(r.__H,t)&&(r.__=e,r.__H=t,z.__H.__h.push(r))}function Rr(e,t){var r=be(pe++,4);!k.__s&&mt(r.__H,t)&&(r.__=e,r.__H=t,z.__h.push(r))}function Br(e,t){var r=be(pe++,7);return mt(r.__H,t)&&(r.__=e(),r.__H=t,r.__h=e),r.__}function Hr(e){var t=z.context[e.__c],r=be(pe++,9);return r.c=e,t?(r.__==null&&(r.__=!0,t.sub(z)),t.props.value):e.__}function Jn(){ut.forEach(function(e){if(e.__P)try{e.__H.__h.forEach(Oe),e.__H.__h.forEach(ft),e.__H.__h=[]}catch(t){e.__H.__h=[],k.__e(t,e.__v)}}),ut=[]}k.__b=function(e){z=null,zr&&zr(e)},k.__r=function(e){Fr&&Fr(e),pe=0;var t=(z=e.__c).__H;t&&(t.__h.forEach(Oe),t.__h.forEach(ft),t.__h=[])},k.diffed=function(e){Er&&Er(e);var t=e.__c;t&&t.__H&&t.__H.__h.length&&(ut.push(t)!==1&&Mr===k.requestAnimationFrame||((Mr=k.requestAnimationFrame)||function(r){var a,n=function(){clearTimeout(o),Gr&&cancelAnimationFrame(a),setTimeout(r)},o=setTimeout(n,100);Gr&&(a=requestAnimationFrame(n))})(Jn)),z=null},k.__c=function(e,t){t.some(function(r){try{r.__h.forEach(Oe),r.__h=r.__h.filter(function(a){return!a.__||ft(a)})}catch(a){t.some(function(n){n.__h&&(n.__h=[])}),t=[],k.__e(a,r.__v)}}),Nr&&Nr(e,t)},k.unmount=function(e){Ir&&Ir(e);var t=e.__c;if(t&&t.__H)try{t.__H.__.forEach(Oe)}catch(r){k.__e(r,t.__v)}};var Gr=typeof requestAnimationFrame=="function";function Oe(e){var t=z;typeof e.__c=="function"&&e.__c(),z=t}function ft(e){var t=z;e.__c=e.__(),z=t}function mt(e,t){return!e||e.length!==t.length||t.some(function(r,a){return r!==e[a]})}function Or(e,t){return typeof t=="function"?t(e):t}function Yn(e,t){for(var r in t)e[r]=t[r];return e}function Vr(e,t){for(var r in e)if(r!=="__source"&&!(r in t))return!0;for(var a in t)if(a!=="__source"&&e[a]!==t[a])return!0;return!1}function Ur(e){this.props=e}(Ur.prototype=new L).isPureReactComponent=!0,Ur.prototype.shouldComponentUpdate=function(e,t){return Vr(this.props,e)||Vr(this.state,t)};var qr=k.__b;k.__b=function(e){e.type&&e.type.__f&&e.ref&&(e.props.ref=e.ref,e.ref=null),qr&&qr(e)};var Zn=k.__e;k.__e=function(e,t,r){if(e.then){for(var a,n=t;n=n.__;)if((a=n.__c)&&a.__c)return t.__e==null&&(t.__e=r.__e,t.__k=r.__k),a.__c(e,t)}Zn(e,t,r)};var Kr=k.unmount;function ht(){this.__u=0,this.t=null,this.__b=null}function Wr(e){var t=e.__.__c;return t&&t.__e&&t.__e(e)}function Le(){this.u=null,this.o=null}k.unmount=function(e){var t=e.__c;t&&t.__R&&t.__R(),t&&e.__h===!0&&(e.type=null),Kr&&Kr(e)},(ht.prototype=new L).__c=function(e,t){var r=t.__c,a=this;a.t==null&&(a.t=[]),a.t.push(r);var n=Wr(a.__v),o=!1,s=function(){o||(o=!0,r.__R=null,n?n(c):c())};r.__R=s;var c=function(){if(!--a.__u){if(a.state.__e){var h=a.state.__e;a.__v.__k[0]=function S(g,b,_){return g&&(g.__v=null,g.__k=g.__k&&g.__k.map(function(x){return S(x,b,_)}),g.__c&&g.__c.__P===b&&(g.__e&&_.insertBefore(g.__e,g.__d),g.__c.__e=!0,g.__c.__P=_)),g}(h,h.__c.__P,h.__c.__O)}var d;for(a.setState({__e:a.__b=null});d=a.t.pop();)d.forceUpdate()}},u=t.__h===!0;a.__u++||u||a.setState({__e:a.__b=a.__v.__k[0]}),e.then(s,s)},ht.prototype.componentWillUnmount=function(){this.t=[]},ht.prototype.render=function(e,t){if(this.__b){if(this.__v.__k){var r=document.createElement("div"),a=this.__v.__k[0].__c;this.__v.__k[0]=function o(s,c,u){return s&&(s.__c&&s.__c.__H&&(s.__c.__H.__.forEach(function(h){typeof h.__c=="function"&&h.__c()}),s.__c.__H=null),(s=Yn({},s)).__c!=null&&(s.__c.__P===u&&(s.__c.__P=c),s.__c=null),s.__k=s.__k&&s.__k.map(function(h){return o(h,c,u)})),s}(this.__b,r,a.__O=a.__P)}this.__b=null}var n=t.__e&&ee(te,null,e.fallback);return n&&(n.__h=null),[ee(te,null,t.__e?null:e.children),n]};var Jr=function(e,t,r){if(++r[1]===r[0]&&e.o.delete(t),e.props.revealOrder&&(e.props.revealOrder[0]!=="t"||!e.o.size))for(r=e.u;r;){for(;r.length>3;)r.pop()();if(r[1]<r[0])break;e.u=r=r[2]}};(Le.prototype=new L).__e=function(e){var t=this,r=Wr(t.__v),a=t.o.get(e);return a[0]++,function(n){var o=function(){t.props.revealOrder?(a.push(n),Jr(t,e,a)):n()};r?r(o):o()}},Le.prototype.render=function(e){this.u=null,this.o=new Map;var t=_e(e.children);e.revealOrder&&e.revealOrder[0]==="b"&&t.reverse();for(var r=t.length;r--;)this.o.set(t[r],this.u=[1,0,this.u]);return e.children},Le.prototype.componentDidUpdate=Le.prototype.componentDidMount=function(){var e=this;this.o.forEach(function(t,r){Jr(e,r,t)})};var Xn=typeof Symbol!="undefined"&&Symbol.for&&Symbol.for("react.element")||60103,Qn=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,ei=typeof document!="undefined",ti=function(e){return(typeof Symbol!="undefined"&&typeof Symbol()=="symbol"?/fil|che|rad/i:/fil|che|ra/i).test(e)};L.prototype.isReactComponent={},["componentWillMount","componentWillReceiveProps","componentWillUpdate"].forEach(function(e){Object.defineProperty(L.prototype,e,{configurable:!0,get:function(){return this["UNSAFE_"+e]},set:function(t){Object.defineProperty(this,e,{configurable:!0,writable:!0,value:t})}})});var Yr=k.event;function ri(){}function ai(){return this.cancelBubble}function oi(){return this.defaultPrevented}k.event=function(e){return Yr&&(e=Yr(e)),e.persist=ri,e.isPropagationStopped=ai,e.isDefaultPrevented=oi,e.nativeEvent=e};var Zr={configurable:!0,get:function(){return this.class}},Xr=k.vnode;k.vnode=function(e){var t=e.type,r=e.props,a=r;if(typeof t=="string"){var n=t.indexOf("-")===-1;for(var o in a={},r){var s=r[o];ei&&o==="children"&&t==="noscript"||o==="value"&&"defaultValue"in r&&s==null||(o==="defaultValue"&&"value"in r&&r.value==null?o="value":o==="download"&&s===!0?s="":/ondoubleclick/i.test(o)?o="ondblclick":/^onchange(textarea|input)/i.test(o+t)&&!ti(r.type)?o="oninput":/^on(Ani|Tra|Tou|BeforeInp)/.test(o)?o=o.toLowerCase():n&&Qn.test(o)?o=o.replace(/[A-Z0-9]/,"-$&").toLowerCase():s===null&&(s=void 0),a[o]=s)}t=="select"&&a.multiple&&Array.isArray(a.value)&&(a.value=_e(r.children).forEach(function(c){c.props.selected=a.value.indexOf(c.props.value)!=-1})),t=="select"&&a.defaultValue!=null&&(a.value=_e(r.children).forEach(function(c){c.props.selected=a.multiple?a.defaultValue.indexOf(c.props.value)!=-1:a.defaultValue==c.props.value})),e.props=a}t&&r.class!=r.className&&(Zr.enumerable="className"in r,r.className!=null&&(a.class=r.className),Object.defineProperty(a,"className",Zr)),e.$$typeof=Xn,Xr&&Xr(e)};var Qr=k.__r;k.__r=function(e){Qr&&Qr(e)};var vt=Ar(),ni=typeof window!="undefined"?Rr:Lr,ii=e=>(...t)=>{let r=Hr(e),a=re({});return ni(()=>r.on("@changed",(n,o)=>{t.some(c=>c in o)&&a[1]({})}),[]),Br(()=>{let n=r.get(),o={};return t.forEach(s=>{o[s]=n[s]}),o.dispatch=r.dispatch,o},[a[0]])},v=ii(vt);var gt=class extends Error{constructor(t){super("Validation error");this.validations=t}getValidations(){return this.validations}},ye=gt;var ea=e=>Object.assign({accept:"application/ld+json","Content-Type":"application/ld+json"},e),si={get:async(e,t)=>{var n;let{path:r,headers:a}=e.get().api;try{let o=await fetch(`${r}/${t}`,{headers:ea(a)});if(o.status<200||o.status>299){let c=new Error("Unexpected api response");throw c.code=o.status,c}let s=await o.json();if(typeof s!="object")throw new Error("Invalid response");return(n=s["hydra:member"])!=null?n:s}catch(o){throw e.dispatch("moduleState/set","error"),o}},post:async({api:e,dispatch:t},r,a)=>{let{path:n,headers:o}=e,s={method:"POST",headers:ea(o),body:JSON.stringify(a)};try{var c=await(await fetch(`${n}/${r}`,s)).json()}catch(u){throw t("moduleState/set","error"),u}if(c["@id"])return c;throw c.violations?new ye(c.violations):(t("moduleState/set","error"),new Error("Invalid result"))}},T=si;var ta=function(e,t,r,a){var n;t[0]=0;for(var o=1;o<t.length;o++){var s=t[o++],c=t[o]?(t[0]|=s?1:2,r[t[o++]]):t[++o];s===3?a[0]=c:s===4?a[1]=Object.assign(a[1]||{},c):s===5?(a[1]=a[1]||{})[t[++o]]=c:s===6?a[1][t[++o]]+=c+"":s?(n=e.apply(c,ta(e,c,r,["",null])),a.push(n),c[0]?t[0]|=2:(t[o-2]=0,t[o]=n)):a.push(c)}return a},ra=new Map;function aa(e){var t=ra.get(this);return t||(t=new Map,ra.set(this,t)),(t=ta(this,t.get(e)||(t.set(e,t=function(r){for(var a,n,o=1,s="",c="",u=[0],h=function(g){o===1&&(g||(s=s.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?u.push(0,g,s):o===3&&(g||s)?(u.push(3,g,s),o=2):o===2&&s==="..."&&g?u.push(4,g,0):o===2&&s&&!g?u.push(5,0,!0,s):o>=5&&((s||!g&&o===5)&&(u.push(o,0,s,n),o=6),g&&(u.push(o,g,0,n),o=6)),s=""},d=0;d<r.length;d++){d&&(o===1&&h(),h(d));for(var S=0;S<r[d].length;S++)a=r[d][S],o===1?a==="<"?(h(),u=[u],o=3):s+=a:o===4?s==="--"&&a===">"?(o=1,s=""):s=a+s[0]:c?a===c?c="":s+=a:a==='"'||a==="'"?c=a:a===">"?(h(),o=1):o&&(a==="="?(o=5,n=s,s=""):a==="/"&&(o<5||r[d][S+1]===">")?(h(),o===3&&(u=u[0]),o=u,(u=u[0]).push(2,0,o),o=0):a===" "||a==="	"||a===`
`||a==="\r"?(h(),o=2):s+=a),o===3&&s==="!--"&&(o=4,u=u[0])}return h(),u}(e)),t),arguments,[])).length>1?t:t[0]}var li=(e,t,...r)=>(t&&t.class&&(t.class=t.class.trim().split(" ").filter(a=>a.trim()).map(a=>a.indexOf("cvio-ab-")!==0?`cvio-ab-${a}`:a).join(" ")),ee(e,t,...r)),l=aa.bind(li);var Se=e=>{let{dispatch:t,privacyPolicyLink:r}=v("privacyPolicyLink");return r?l`
  ...
  `};var Tt=e=>{let{dispatch:t}=v();return l`
    ...
    <${H} modalStateStore="closeConfirmModalState"
      ...
      onApprove=${()=>t("close")}/>
  `};var Va=({customer:e,customerAddress:t})=>l`
      <div>
        <div class="mb-1">
          ${f("Your information")}:
        </div>
  ...
  `;var zi=async e=>{try{var t=await Ti(e)}catch(r){if(r instanceof ye){Pi(e,r);return}throw r}await Ai(e,t),await Mi(e,t),e.dispatch("moduleState/set","success")},Ti=async e=>{let t=Object.assign({},e.appointment.customer,{medical_records_allowed:e.medicalConsent!="disabled"?!0:null,country:e.country,mobile:e.appointment.customer.mobile?xt(e.store.chain.language,e.appointment.customer.mobile):null});return"birth"in t&&(t.birth=Fi(t.birth)),Object.keys(t).forEach(r=>{typeof t[r]=="string"&&(t[r]=t[r].trim())}),await T.post(e,"customers",t)},Fi=e=>{if(!e||!(e instanceof Date))return null;let t=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),a=String(e.getDate()).padStart(2,"0");return`${t}-${r}-${a}T00:00:00+00:00`},Pi=async(e,t)=>{let{customerForm:r}=e;var a=[];for(let n=0;n<t.getValidations().length;n++){let{propertyPath:o,message:s}=t.getValidations()[n];if(o==""){a.push(s);continue}r[o].errors||(r[o].errors=[]),r[o].errors.push(s)}e.dispatch("customerForm/set",{customerForm:r,customerFormGlobalErrors:a}),e.dispatch("currentStep/set","customer"),e.dispatch("booking/set",!1)},Ai=async(e,t)=>{await T.post(e,"customer_consents",{customer:t["@id"],approved_at:new Date,medical_records_allowed:e.medicalConsent!="disabled",source:"api"})},Mi=async(e,t)=>{let{appointment:r,language:a,translationOverrides:n,constantAppointmentCommentText:o,confirmationType:s,reminderType:c}=e,u=o||"";r.comment&&(u=(u?u+`

`:"")+r.comment),await T.post(e,"appointment_events",Object.assign({},r,{customer:t["@id"],eye_examination_process:r.eye_examination_process["@id"],calendar:r.calendar["@id"],comment:u||void 0,title:f("%customer%'s examination",{customer:ae.format(t,a)},{language:a,translationOverrides:n}),status:"booked",should_send_confirmation_email:s=="email"||s=="both",should_send_confirmation_sms:s=="sms"||s=="both",should_send_reminder_email:c=="email"||c=="both",should_send_reminder_sms:c=="sms"||c=="both",source:"online"}))},Ua=e=>{var t=v("appointment","api","booking","language","customerForm","customerFormGlobalErrors","country","moduleState","store","translationOverrides","constantAppointmentCommentText","medicalConsent","confirmationType","reminderType");let{booking:r,moduleState:a,dispatch:n}=t;return l`
    <div class="d-grid">
      <button type="button" onClick=${async()=>{n("booking/set",!0);try{await zi(t)}catch(s){throw n("moduleState/set","error"),s}}} disabled=${a!="idle"}
        class="btn btn-primary btn-lg">
        ${r&&a=="idle"?l`<${B}/>`:f("Confirm appointment")}
      </button>
    </div>
  `};var Pt={HUF:0},Ei=(e,t)=>{var r=e.price_list.currency,a={style:"currency",currency:r};return Pt[r]!=null&&(a.maximumFractionDigits=Pt[r],a.minimumFractionDigits=Pt[r]),new Intl.NumberFormat(t,a)},qe=({process:e})=>{if(!e)return l``;let{store:t,language:r,showPrice:a}=v("store","language","showPrice");if(!a)return l``;let n=e.process_services;var o=null,s=null,c=t.price_list.id;n.forEach(h=>{h.service.packagings.forEach(d=>{d.currentPrices.forEach(S=>{S.price_list.id==c&&((o==null||o>S.value)&&(o=S.value),(s==null||s<S.value)&&(s=S.value))})})});var u=Ei(t,r);return o==null||s==null?l``:o==s?l`${u.format(o)}`:l`${u.format(o)} - ${u.format(s)}`};var Ke=e=>{let{appointment:t,language:r,currentStep:a,store:n,selectedCalendar:o,priceComment:s,showPrice:c,showExaminerName:u,locationName:h,locationAddress:d,showLocation:S,dispatch:g}=v("appointment","language","currentStep","store","selectedCalendar","priceComment","showPrice","showExaminerName","locationName","locationAddress","showLocation");if(!n)return;var b=t.calendar||o,_={dateTimeStart:t.start?P.formatDateTime(t.start):null,dateTimeEnd:t.end?P.formatDateTime(t.end):null,processLength:t.eye_examination_process?t.eye_examination_process.length:null,processName:t.eye_examination_process?t.eye_examination_process.name:null,process:t.eye_examination_process,examinerName:u&&b?b.user.name:null,customer:t.customer,customerAddress:ue.formatAddress(t.customer),showLocation:S,locationName:h!==null?h:n.name,locationAddress:d!==null?d:ue.formatAddress(n),appointmentComment:t.comment};let x=()=>{g("currentStep/set","appointment")};return l`
    <ul class="list-group${a=="summary"?"":" text-end"}">
      ...
      ${a=="summary"?l`
        <li class="list-group-item">
          <${Va} customer=${_.customer} customerAddress=${_.customerAddress}/>
        </li>
      `:""}
  ...
  `};var qa=e=>{let{appointment:t,dispatch:r,currentStep:a,showProcessLength:n}=v("appointment","currentStep","showProcessLength"),o=()=>{a==="process"&&(r("appointment/set",{eye_examination_process:e.item}),r("currentStep/eyeExaminationProcessSelected"),r("currentStep/next"))},s=c=>{c.stopPropagation(),r("detailedDescriptionModalState/set",e.item.detailed_description)};return l`
  ...
  `;var Wa=e=>{let{eyeExaminationProcesses:t,detailedDescriptionModalState:r,store:a,calendars:n,dispatch:o}=v("eyeExaminationProcesses","store","calendars"),s=()=>o("detailedDescriptionModalState/set",!1);return t.length==0||!a?l`
      <ul class="list-group">
  ...
  `};var Ja=()=>l`
    ...
    </li>`;var Ya=e=>{let{appointment:t,showFirstAvailableUserItem:r,dispatch:a}=v("appointment","showFirstAvailableUserItem"),n=ke(v("calendars","appointment","calendarRoleCheckMode")),o={user:{name:f("First free"),description:f("For finding the nearest free time slot.")}},s=()=>a("currentStep/previous");return l`
    <ul class="list-group">
  ...
  `};var Ni=["@abbrSunday","@abbrMonday","@abbrTuesday","@abbrWednesday","@abbrThursday","@abbrFriday","@abbrSaturday"],Za=({date:e})=>{let{selectedDate:t,dispatch:r}=v("selectedDate"),a=()=>r("selectedDate/set",e);return l`
    <div class="col">
  ...
  `};var Xa=({dateGroup:e,visibleDateGroups:t})=>{let{previousDateGroup:r,currentDateGroup:a,nextDateGroup:n}=t;return l`
    <div class="carousel-item
  ...
  `};var Ii=["January","February","March","April","May","June","July","August","September","October","November","December"],Qa=e=>{let{selectedDate:t,firstEligibleDate:r,dispatch:a}=v("selectedDate","firstEligibleDate","dispatch"),n=yt(r),o=()=>a("selectedDate/set",c[4]),s=()=>a("selectedDate/set",h[0]);var c,u,h;for(let S=0;S<n.length&&(c=n[S-1],u=n[S],h=n[S+1],!u.hasDate(t));S++);let d={previousDateGroup:c,currentDateGroup:u,nextDateGroup:h};return l`
    <div class="dateSelection hstack gap-1">
      ...
      <div class="carousel-container">
        <div>${f(Ii[u[0].getMonth()])}</div>
        <div class="carousel slide">
          <div class="carousel-inner">
            ${n.map(S=>l`<${Xa} dateGroup=${S} visibleDateGroups=${d}/>`)}
          </div>
        </div>
      </div>
  ...
  `};var eo=({day:e})=>{let{selectedCalendar:t,selectedDate:r,nextFreeSlots:a,appointment:n,dispatch:o,firstEligibleDate:s}=v("selectedCalendar","appointment","nextFreeSlots","selectedDate","firstEligibleDate"),c=a[C(n,t,e)],u=h=>{o("selectedDate/set",h)};return e<new Date(s).setHours(0,0,0,0)||c&&c.status=="empty"?l`<td class='table-active disabled'>${e.getDate()}</td>`:c?l`
    <td class=${R(e,r)?"bg-primary text-light":"active-cell"} 
      onClick="${()=>u(e)}"
    >
      ${e.getDate()}
    </td>
  `:l`<td class="placeholder">${e.getDate()}</td>`};var Oi=["January","February","March","April","May","June","July","August","September","October","November","December"],Li=["@abbrMonday","@abbrTuesday","@abbrWednesday","@abbrThursday","@abbrFriday","@abbrSaturday","@abbrSunday"],to=()=>{let{selectedCalendar:e,selectedDate:t,nextFreeSlots:r,appointment:a,dispatch:n}=v("selectedCalendar","appointment","nextFreeSlots","selectedDate"),o=t.getFullYear(),s=t.getMonth(),c=new Date(o,s+1,0).getDate(),u=new Date<new Date(o,s,0),h=new Date(o,s,1),d=[],S=[];var g=!0;for(let x=t.getDate();x<=c;x++){let $=r[C(a,e,new Date(o,s,x))];if($==null||$.status=="incomplete"){g=!1;break}}for(let x=0;x<(h.getDay()||7)-1;x++)d.push(null);for(let x=1;x<=c;x++)d.push(new Date(o,s,x));for(let x=0;x<d.length;x+=7)S.push(d.slice(x,x+7));let b=()=>{let x=new Date(o,s+1,0).getDate();for(let $=1;$<=x;$++){let j=r[C(a,e,new Date(o,s+1,$))];if(j&&(j.status=="complete"||j.status=="incomplete")){n("selectedDate/set",new Date(o,s+1,$));return}}n("selectedDate/set",new Date(o,s+1,1)),n("initialNextFreeSlotsLoading/set",!0)};return l`
          ...
          <table class="table table caption-top placeholder-glow">
            <caption class="text-center display-6">
              <button
                ...
                onClick="${()=>{let x=new Date(o,s,0).getDate();for(let $=1;$<=x;$++){let j=r[C(a,e,new Date(o,s-1,$))];if(j&&j.status=="complete"){n("selectedDate/set",new Date(o,s-1,$));return}}n("selectedDate/set",new Date(o,s-1,1))}}"
              >
                ${"<"}
              </button>
              ${o+" "+f(Oi[s])}
            ...
            <thead>
              <tr>
                ${Li.map(x=>l`<th scope="col">${f(x)}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${S.map(x=>l`
  ...
  `};var We=e=>{let{selectedCalendar:t,selectedDate:r,nextFreeSlots:a,appointment:n,dispatch:o,nextFreeSlotLoading:s}=v("selectedCalendar","appointment","nextFreeSlots","selectedDate","nextFreeSlotLoading");var c=new Date(r),u,h=!1;for(c.setDate(c.getDate()+1);a[u=C(n,t,c)];){if(a[u].status!=="empty"){h=!0;break}c.setDate(c.getDate()+1)}let d=()=>o("selectedDate/set",c);return l`
  ...
  `};var ro=e=>{let{dispatch:t,appointment:r}=v("appointment"),a=()=>{t("appointment/selectSlot",e.slot)};return l`
  ...
  `};var ao=()=>{let{selectedDate:e,selectedCalendar:t,appointment:r,nextFreeSlots:a}=v("selectedCalendar","selectedDate","nextFreeSlots","appointment");var n=C(r,t,e);return l`
    <ul class="list-group mt-3">
      ${a[n]?a[n].status=="empty"?l`<${We}/>`:a[n].slots.map(o=>l`<${ro} slot=${o}/>`):l`<li class="list-group-item"><${B}/></li>`}
    </ul>
  `};var oo=({slot:e})=>{let{dispatch:t,appointment:r}=v("appointment"),a=()=>{t("appointment/selectSlot",e)},n=xe(new Date(r.start),new Date(e.start));return l`
  ...
  `};var Je=({title:e,slots:t})=>t.length?l`
      ...
      `:null;var no=()=>{let{selectedDate:e,selectedCalendar:t,appointment:r,nextFreeSlots:a}=v("selectedCalendar","selectedDate","nextFreeSlots","appointment"),n=C(r,t,e),o=[],s=[],c=[],u=a[n]?a[n].slots:[];for(let h of u||[]){let d=new Date(h.start);d.getHours()<12?o.push(h):d.getHours()<18?s.push(h):c.push(h)}return l`
    <div class="grid">
  ...
  `};var io=()=>{let{calendarRange:e,timeSlotMode:t}=v("calendarRange","timeSlotMode");return l`
    <${e=="fiveDays"?Qa:to}/>
    <${t=="singleColumn"?ao:no}/>
  `};var so=e=>{let{appointment:t,dispatch:r}=v("appointment"),a=n=>{let{value:o}=n.target;var{customer:s}=t;s[e.property]=o,r("appointment/set",{customer:s})};return l`
    <input type="text" class="${e.invalid?"is-invalid":""} form-control" onInput=${a}
      value=${t.customer[e.property]||""}
      disabled=${!!t.customer["@id"]} />
  `};var A=e=>{let{customerForm:t}=v("customerForm");if(!!t[e.property]){var r=t[e.property];return l`
    <div class="${e.class||"col-sm"} needs-validation p-1 mb-2 w-100">
      ${e.label?l`
        ...
        `:null}
      <${e.inputClass||so} property=${e.property}
  ...
  `}};var lo=e=>{let{appointment:t,showAppointmentComment:r,appointmentCommentRequired:a,commentError:n,dispatch:o}=v("appointment","showAppointmentComment","appointmentCommentRequired","commentError");if(!r)return l``;let s=c=>{let{value:u}=c.target;t.comment=u,o("appointment/set",t),o("customerForm/set",{commentError:null})};return l`
      <div class="row mx-2">
  ...
  `};var Ri=e=>(e=e||new Date,e=new Date(e.getFullYear(),e.getMonth()+1,0),e.getDate()),co=e=>{let{appointment:t,dispatch:r}=v("appointment"),a=(u,h)=>{var{customer:d}=t;h==""?d[e.property]=null:(d[e.property]=d[e.property]||new Date("2000-01-01"),d[e.property][`set${u}`](h)),r("appointment/set",{customer:d})},n=t.customer[e.property];var o=[];for(let u=1900;u<=new Date().getFullYear();u++)o.push({value:u,label:u});var s=[];for(let u=1;u<=12;u++)s.push({value:u-1,label:u<10?`0${u}`:u});var c=[];for(let u=1;u<=Ri(n);u++)c.push({value:u,label:u<10?`0${u}`:u});return l`
  ...
  `};var po=e=>{let{appointment:t,dispatch:r}=v("appointment");return l`
  ...
  `};var uo=e=>{let{appointment:t,privacyPolicy:r,dispatch:a}=v("appointment","privacyPolicy"),n=()=>{var{customer:s}=t;s[e.property]=!s[e.property]||null,a("appointment/set",{customer:s})},o=()=>a("privacyPolicyModalState/set",!1);return l`
  ...
  `};var mo=e=>{let{appointment:t,dispatch:r}=v("appointment"),a=()=>{var{customer:n}=t;n[e.property]=!n[e.property]||null,r("appointment/set",{customer:n})};return l`
  ...
  `};var fo=e=>{let{customerForm:t,customerFormGlobalErrors:r,medicalConsent:a,dispatch:n}=v("customerForm","customerFormGlobalErrors","language","medicalConsent"),o=()=>{n("customerForm/validateAndNext")};return l`
    <div class="card p-2">
      ${r&&r.length?l`
      ...
      <div class="row mx-2">
        <${A} class="col-lg-5" property="birth" label="Birth" inputClass=${co}/>
        <${A} property="gender" label="Gender" inputClass=${po}/>
      ...
      <${lo}/>
      <div class="row mx-2">
        <${A} property="acceptPrivacyPolicy" inputClass=${uo}/>
      </div>
      ${a=="explicit"?l`
          <div class="row mx-2">
            <${A} property="acceptMedicalRecordsUse" inputClass=${mo}/>
          </div>
        `:""}
      <button class="mx-2 btn btn-primary" onClick=${o}>${f("Next")}</button>
    </div>
  `};var ho=({item:e})=>{let{store:t,dispatch:r,currentStep:a}=v("store","currentStep"),n=()=>{a==="storeSelection"&&(r("store/set",e),r("currentStep/next"))},o=ue.formatAddress(e);return l`
  ...
  `};var vo=()=>l`
    ...
    </li>`;var go=e=>{let{stores:t}=v("stores");return t!==null?(t.sort((r,a)=>r.name.localeCompare(a.name)),t.map(r=>l`<${ho} item=${r}/>`)):l`<${vo}/>`};var Mt=e=>l`
    <div class="carousel slide">
      <div class="carousel-inner">
        <${ne} step="storeSelection" wrappedComponent=${go}/>
        <${ne} step="process" wrappedComponent=${Wa}/>
        <${ne} step="calendar" wrappedComponent=${Ya}/>
        <${ne} step="appointment" wrappedComponent=${io}/>
        <${ne} step="customer" wrappedComponent=${fo}/>
  ...
  `};var zt=e=>{let{moduleState:t,appointment:r,dispatch:a,store:n,style:o}=v("moduleState","appointment","store","style");if(!t.startsWith("success")&&!t.startsWith("error"))return;var s,c;n!=null&&(s=n.phone,c=n.email);let u=()=>{o=="embedded"||o=="embedded-safe"?a("resetStore"):a("close")},h="There is a configuration error in the appointment booker that prevents booking. Please contact our store on %mail% email address or book an appointment by calling our store (%tel%) and please mention the error then.",d="Error! Appointments can not be created! There is a configuration error in the appointment booker that prevents booking. Please contact our store on %mail% email address or book an appointment by calling us and please mention the error then.";switch(t){case"success":return l`
      ...
      `;default:throw new Error(`There was an unexpected error: ${t}`)}};var Ft=({colors:e})=>{if(e=e||{},Object.keys(e).length!=0)return l`
    <style>
      ${e.background?`
          .cvio-ab-bg-body {
  ...
  `};var _o=e=>{let{headerTitle:t,currentStep:r,style:a,parentWidth:n}=v("headerTitle","currentStep","style","parentWidth");switch(r){case"storeSelection":var o=f("Store selection");break;case"process":var o=f("Select eye examination type");break;case"calendar":var o=f("Select a vision expert");break;case"appointment":var o=f("Select your desired appointment time");break;case"customer":var o=f("Enter customer details");break;default:var o=f("Appointment details verification");break}return l`
        ...
        <div class="row">
          ...
          <div class="col-4">
            <div class="btn-group btn-group-lg float-end" role="group" aria-label="Navigation buttons">
              <${Dt}/>
              ${a==="embedded"||a==="embedded-safe"?"":l`<${Tt}/>`}
            </div>
          </div>
        </div>
      </div>
