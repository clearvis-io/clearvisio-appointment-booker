    ...
    <ul class="list-group${a=="summary"?"":" text-end"}">
      ...
      ${b.processName?l`
        <li class="list-group-item">
          ...
          <div>
            ${b.examinerName?l`${_("examiner: %examiner%",{examiner:b.examinerName})}`:null}
          </div>
        </li>
      `:""}
      ${b.dateTimeStart&&b.dateTimeEnd&&b.processLength?l`
        <li class="list-group-item">
          ...
          <div class="text-muted">
            ${_("It takes up to %length% minutes",{length:b.processLength})}
          </div>
          <div class="fs-6">
      ...
      ${a=="summary"?l`
        <li class="list-group-item">
          <${za} customer=${b.customer} customerAddress=${b.customerAddress}/>
        </li>
      `:""}
      ${a=="summary"&&b.appointmentComment?l`
        <li class="list-group-item">
          ${_("Comment")}: ${b.appointmentComment}
        </li>
      `:""}
      ${b.showLocation?l`
            <li class="list-group-item">
      ...
      <li class="list-group-item">
        ${p?l`
          <div>${_("Price")}:</div>
          <div class="fw-bold"><${Ue} process=${b.process}/></div>
        `:""}
        <div>${s||""}</div>
      </li>
      ${a=="summary"?l`
