var ee,h,Be,q,He,Ge,Re,te={},Ue=[],Sr=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;function P(e,t){for(var r in t)e[r]=t[r];return e}function Ve(e){var t=e.parentNode;t&&t.removeChild(e)}function O(e,t,r){var a,n,o,i={};for(o in t)o=="key"?a=t[o]:o=="ref"?n=t[o]:i[o]=t[o];if(arguments.length>2&&(i.children=arguments.length>3?ee.call(arguments,2):r),typeof e=="function"&&e.defaultProps!=null)for(o in e.defaultProps)i[o]===void 0&&(i[o]=e.defaultProps[o]);return re(e,i,a,n,null)}function re(e,t,r,a,n){var o={type:e,props:t,key:r,ref:a,__k:null,__:null,__b:0,__e:null,__d:void 0,__c:null,__h:null,constructor:void 0,__v:n==null?++Be:n};return n==null&&h.vnode!=null&&h.vnode(o),o}function I(e){return e.children}function D(e,t){this.props=e,this.context=t}function H(e,t){if(t==null)return e.__?H(e.__,e.__.__k.indexOf(e)+1):null;for(var r;t<e.__k.length;t++)if((r=e.__k[t])!=null&&r.__e!=null)return r.__e;return typeof e.type=="function"?H(e):null}function qe(e){var t,r;if((e=e.__)!=null&&e.__c!=null){for(e.__e=e.__c.base=null,t=0;t<e.__k.length;t++)if((r=e.__k[t])!=null&&r.__e!=null){e.__e=e.__c.base=r.__e;break}return qe(e)}}function he(e){(!e.__d&&(e.__d=!0)&&q.push(e)&&!ae.__r++||Ge!==h.debounceRendering)&&((Ge=h.debounceRendering)||He)(ae)}function ae(){for(var e;ae.__r=q.length;)e=q.sort(function(t,r){return t.__v.__b-r.__v.__b}),q=[],e.some(function(t){var r,a,n,o,i,u;t.__d&&(i=(o=(r=t).__v).__e,(u=r.__P)&&(a=[],(n=P({},o)).__v=o.__v+1,ve(u,o,n,r.__n,u.ownerSVGElement!==void 0,o.__h!=null?[i]:null,a,i==null?H(o):i,o.__h),Ke(a,o),o.__e!=i&&qe(o)))})}function Qe(e,t,r,a,n,o,i,u,c,p){var s,v,m,f,b,F,g,y=a&&a.__k||Ue,w=y.length;for(r.__k=[],s=0;s<t.length;s++)if((f=r.__k[s]=(f=t[s])==null||typeof f=="boolean"?null:typeof f=="string"||typeof f=="number"||typeof f=="bigint"?re(null,f,null,null,f):Array.isArray(f)?re(I,{children:f},null,null,null):f.__b>0?re(f.type,f.props,f.key,null,f.__v):f)!=null){if(f.__=r,f.__b=r.__b+1,(m=y[s])===null||m&&f.key==m.key&&f.type===m.type)y[s]=void 0;else for(v=0;v<w;v++){if((m=y[v])&&f.key==m.key&&f.type===m.type){y[v]=void 0;break}m=null}ve(e,f,m=m||te,n,o,i,u,c,p),b=f.__e,(v=f.ref)&&m.ref!=v&&(g||(g=[]),m.ref&&g.push(m.ref,null,f),g.push(v,f.__c||b,f)),b!=null?(F==null&&(F=b),typeof f.type=="function"&&f.__k===m.__k?f.__d=c=Je(f,c,e):c=We(e,f,m,y,b,c),typeof r.type=="function"&&(r.__d=c)):c&&m.__e==c&&c.parentNode!=e&&(c=H(m))}for(r.__e=F,s=w;s--;)y[s]!=null&&(typeof r.type=="function"&&y[s].__e!=null&&y[s].__e==r.__d&&(r.__d=H(a,s+1)),Ze(y[s],y[s]));if(g)for(s=0;s<g.length;s++)Ye(g[s],g[++s],g[++s])}function Je(e,t,r){for(var a,n=e.__k,o=0;n&&o<n.length;o++)(a=n[o])&&(a.__=e,t=typeof a.type=="function"?Je(a,t,r):We(r,a,a,n,a.__e,t));return t}function K(e,t){return t=t||[],e==null||typeof e=="boolean"||(Array.isArray(e)?e.some(function(r){K(r,t)}):t.push(e)),t}function We(e,t,r,a,n,o){var i,u,c;if(t.__d!==void 0)i=t.__d,t.__d=void 0;else if(r==null||n!=o||n.parentNode==null)e:if(o==null||o.parentNode!==e)e.appendChild(n),i=null;else{for(u=o,c=0;(u=u.nextSibling)&&c<a.length;c+=2)if(u==n)break e;e.insertBefore(n,o),i=o}return i!==void 0?i:n.nextSibling}function kr(e,t,r,a,n){var o;for(o in r)o==="children"||o==="key"||o in t||oe(e,o,null,r[o],a);for(o in t)n&&typeof t[o]!="function"||o==="children"||o==="key"||o==="value"||o==="checked"||r[o]===t[o]||oe(e,o,t[o],r[o],a)}function Xe(e,t,r){t[0]==="-"?e.setProperty(t,r):e[t]=r==null?"":typeof r!="number"||Sr.test(t)?r:r+"px"}function oe(e,t,r,a,n){var o;e:if(t==="style")if(typeof r=="string")e.style.cssText=r;else{if(typeof a=="string"&&(e.style.cssText=a=""),a)for(t in a)r&&t in r||Xe(e.style,t,"");if(r)for(t in r)a&&r[t]===a[t]||Xe(e.style,t,r[t])}else if(t[0]==="o"&&t[1]==="n")o=t!==(t=t.replace(/Capture$/,"")),t=t.toLowerCase()in e?t.toLowerCase().slice(2):t.slice(2),e.l||(e.l={}),e.l[t+o]=r,r?a||e.addEventListener(t,o?tt:et,o):e.removeEventListener(t,o?tt:et,o);else if(t!=="dangerouslySetInnerHTML"){if(n)t=t.replace(/xlink[H:h]/,"h").replace(/sName$/,"s");else if(t!=="href"&&t!=="list"&&t!=="form"&&t!=="tabIndex"&&t!=="download"&&t in e)try{e[t]=r==null?"":r;break e}catch(i){}typeof r=="function"||(r!=null&&(r!==!1||t[0]==="a"&&t[1]==="r")?e.setAttribute(t,r):e.removeAttribute(t))}}function et(e){this.l[e.type+!1](h.event?h.event(e):e)}function tt(e){this.l[e.type+!0](h.event?h.event(e):e)}function ve(e,t,r,a,n,o,i,u,c){var p,s,v,m,f,b,F,g,y,w,Q,j=t.type;if(t.constructor!==void 0)return null;r.__h!=null&&(c=r.__h,u=t.__e=r.__e,t.__h=null,o=[u]),(p=h.__b)&&p(t);try{e:if(typeof j=="function"){if(g=t.props,y=(p=j.contextType)&&a[p.__c],w=p?y?y.props.value:p.__:a,r.__c?F=(s=t.__c=r.__c).__=s.__E:("prototype"in j&&j.prototype.render?t.__c=s=new j(g,w):(t.__c=s=new D(g,w),s.constructor=j,s.render=$r),y&&y.sub(s),s.props=g,s.state||(s.state={}),s.context=w,s.__n=a,v=s.__d=!0,s.__h=[]),s.__s==null&&(s.__s=s.state),j.getDerivedStateFromProps!=null&&(s.__s==s.state&&(s.__s=P({},s.__s)),P(s.__s,j.getDerivedStateFromProps(g,s.__s))),m=s.props,f=s.state,v)j.getDerivedStateFromProps==null&&s.componentWillMount!=null&&s.componentWillMount(),s.componentDidMount!=null&&s.__h.push(s.componentDidMount);else{if(j.getDerivedStateFromProps==null&&g!==m&&s.componentWillReceiveProps!=null&&s.componentWillReceiveProps(g,w),!s.__e&&s.shouldComponentUpdate!=null&&s.shouldComponentUpdate(g,s.__s,w)===!1||t.__v===r.__v){s.props=g,s.state=s.__s,t.__v!==r.__v&&(s.__d=!1),s.__v=t,t.__e=r.__e,t.__k=r.__k,t.__k.forEach(function(X){X&&(X.__=t)}),s.__h.length&&i.push(s);break e}s.componentWillUpdate!=null&&s.componentWillUpdate(g,s.__s,w),s.componentDidUpdate!=null&&s.__h.push(function(){s.componentDidUpdate(m,f,b)})}s.context=w,s.props=g,s.state=s.__s,(p=h.__r)&&p(t),s.__d=!1,s.__v=t,s.__P=e,p=s.render(s.props,s.state,s.context),s.state=s.__s,s.getChildContext!=null&&(a=P(P({},a),s.getChildContext())),v||s.getSnapshotBeforeUpdate==null||(b=s.getSnapshotBeforeUpdate(m,f)),Q=p!=null&&p.type===I&&p.key==null?p.props.children:p,Qe(e,Array.isArray(Q)?Q:[Q],t,r,a,n,o,i,u,c),s.base=t.__e,t.__h=null,s.__h.length&&i.push(s),F&&(s.__E=s.__=null),s.__e=!1}else o==null&&t.__v===r.__v?(t.__k=r.__k,t.__e=r.__e):t.__e=xr(r.__e,t,r,a,n,o,i,c);(p=h.diffed)&&p(t)}catch(X){t.__v=null,(c||o!=null)&&(t.__e=u,t.__h=!!c,o[o.indexOf(u)]=null),h.__e(X,t,r)}}function Ke(e,t){h.__c&&h.__c(t,e),e.some(function(r){try{e=r.__h,r.__h=[],e.some(function(a){a.call(r)})}catch(a){h.__e(a,r.__v)}})}function xr(e,t,r,a,n,o,i,u){var c,p,s,v=r.props,m=t.props,f=t.type,b=0;if(f==="svg"&&(n=!0),o!=null){for(;b<o.length;b++)if((c=o[b])&&(c===e||(f?c.localName==f:c.nodeType==3))){e=c,o[b]=null;break}}if(e==null){if(f===null)return document.createTextNode(m);e=n?document.createElementNS("http://www.w3.org/2000/svg",f):document.createElement(f,m.is&&m),o=null,u=!1}if(f===null)v===m||u&&e.data===m||(e.data=m);else{if(o=o&&ee.call(e.childNodes),p=(v=r.props||te).dangerouslySetInnerHTML,s=m.dangerouslySetInnerHTML,!u){if(o!=null)for(v={},b=0;b<e.attributes.length;b++)v[e.attributes[b].name]=e.attributes[b].value;(s||p)&&(s&&(p&&s.__html==p.__html||s.__html===e.innerHTML)||(e.innerHTML=s&&s.__html||""))}if(kr(e,m,v,n,u),s)t.__k=[];else if(b=t.props.children,Qe(e,Array.isArray(b)?b:[b],t,r,a,n&&f!=="foreignObject",o,i,o?o[0]:r.__k&&H(r,0),u),o!=null)for(b=o.length;b--;)o[b]!=null&&Ve(o[b]);u||("value"in m&&(b=m.value)!==void 0&&(b!==e.value||f==="progress"&&!b)&&oe(e,"value",b,v.value,!1),"checked"in m&&(b=m.checked)!==void 0&&b!==e.checked&&oe(e,"checked",b,v.checked,!1))}return e}function Ye(e,t,r){try{typeof e=="function"?e(t):e.current=t}catch(a){h.__e(a,r)}}function Ze(e,t,r){var a,n;if(h.unmount&&h.unmount(e),(a=e.ref)&&(a.current&&a.current!==e.__e||Ye(a,null,t)),(a=e.__c)!=null){if(a.componentWillUnmount)try{a.componentWillUnmount()}catch(o){h.__e(o,t)}a.base=a.__P=null}if(a=e.__k)for(n=0;n<a.length;n++)a[n]&&Ze(a[n],t,typeof e.type!="function");r||e.__e==null||Ve(e.__e),e.__e=e.__d=void 0}function $r(e,t,r){return this.constructor(e,r)}function be(e,t,r){var a,n,o;h.__&&h.__(e,t),n=(a=typeof r=="function")?null:r&&r.__k||t.__k,o=[],ve(t,e=(!a&&r||t).__k=O(I,null,[e]),n||te,te,t.ownerSVGElement!==void 0,!a&&r?[r]:n?null:t.firstChild?ee.call(t.childNodes):null,o,!a&&r?r:n?n.__e:t.firstChild,a),Ke(o,e)}function rt(e,t){var r={__c:t="__cC"+Re++,__:e,Consumer:function(a,n){return a.children(n)},Provider:function(a){var n,o;return this.getChildContext||(n=[],(o={})[t]=this,this.getChildContext=function(){return o},this.shouldComponentUpdate=function(i){this.props.value!==i.value&&n.some(he)},this.sub=function(i){n.push(i);var u=i.componentWillUnmount;i.componentWillUnmount=function(){n.splice(n.indexOf(i),1),u&&u.call(i)}}),a.children}};return r.Provider.__=r.Consumer.contextType=r}ee=Ue.slice,h={__e:function(e,t){for(var r,a,n;t=t.__;)if((r=t.__c)&&!r.__)try{if((a=r.constructor)&&a.getDerivedStateFromError!=null&&(r.setState(a.getDerivedStateFromError(e)),n=r.__d),r.componentDidCatch!=null&&(r.componentDidCatch(e),n=r.__d),n)return r.__E=r}catch(o){e=o}throw e}},Be=0,D.prototype.setState=function(e,t){var r;r=this.__s!=null&&this.__s!==this.state?this.__s:this.__s=P({},this.state),typeof e=="function"&&(e=e(P({},r),this.props)),e&&P(r,e),e!=null&&this.__v&&(t&&this.__h.push(t),he(this))},D.prototype.forceUpdate=function(e){this.__v&&(this.__e=!0,e&&this.__h.push(e),he(this))},D.prototype.render=I,q=[],He=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,ae.__r=0,Re=0;var G,k,at,ge=0,ye=[],ot=h.__b,nt=h.__r,it=h.diffed,st=h.__c,lt=h.unmount;function J(e,t){h.__h&&h.__h(k,e,ge||t),ge=0;var r=k.__H||(k.__H={__:[],__h:[]});return e>=r.__.length&&r.__.push({}),r.__[e]}function z(e){return ge=1,Cr(ct,e)}function Cr(e,t,r){var a=J(G++,2);return a.t=e,a.__c||(a.__=[r?r(t):ct(void 0,t),function(n){var o=a.t(a.__[0],n);a.__[0]!==o&&(a.__=[o,a.__[1]],a.__c.setState({}))}],a.__c=k),a.__}function ut(e,t){var r=J(G++,3);!h.__s&&Se(r.__H,t)&&(r.__=e,r.__H=t,k.__H.__h.push(r))}function pt(e,t){var r=J(G++,4);!h.__s&&Se(r.__H,t)&&(r.__=e,r.__H=t,k.__h.push(r))}function dt(e,t){var r=J(G++,7);return Se(r.__H,t)&&(r.__=e(),r.__H=t,r.__h=e),r.__}function mt(e){var t=k.context[e.__c],r=J(G++,9);return r.c=e,t?(r.__==null&&(r.__=!0,t.sub(k)),t.props.value):e.__}function wr(){ye.forEach(function(e){if(e.__P)try{e.__H.__h.forEach(ne),e.__H.__h.forEach(ke),e.__H.__h=[]}catch(t){e.__H.__h=[],h.__e(t,e.__v)}}),ye=[]}h.__b=function(e){k=null,ot&&ot(e)},h.__r=function(e){nt&&nt(e),G=0;var t=(k=e.__c).__H;t&&(t.__h.forEach(ne),t.__h.forEach(ke),t.__h=[])},h.diffed=function(e){it&&it(e);var t=e.__c;t&&t.__H&&t.__H.__h.length&&(ye.push(t)!==1&&at===h.requestAnimationFrame||((at=h.requestAnimationFrame)||function(r){var a,n=function(){clearTimeout(o),ft&&cancelAnimationFrame(a),setTimeout(r)},o=setTimeout(n,100);ft&&(a=requestAnimationFrame(n))})(wr)),k=null},h.__c=function(e,t){t.some(function(r){try{r.__h.forEach(ne),r.__h=r.__h.filter(function(a){return!a.__||ke(a)})}catch(a){t.some(function(n){n.__h&&(n.__h=[])}),t=[],h.__e(a,r.__v)}}),st&&st(e,t)},h.unmount=function(e){lt&&lt(e);var t=e.__c;if(t&&t.__H)try{t.__H.__.forEach(ne)}catch(r){h.__e(r,t.__v)}};var ft=typeof requestAnimationFrame=="function";function ne(e){var t=k;typeof e.__c=="function"&&e.__c(),k=t}function ke(e){var t=k;e.__c=e.__(),k=t}function Se(e,t){return!e||e.length!==t.length||t.some(function(r,a){return r!==e[a]})}function ct(e,t){return typeof t=="function"?t(e):t}function jr(e,t){for(var r in t)e[r]=t[r];return e}function _t(e,t){for(var r in e)if(r!=="__source"&&!(r in t))return!0;for(var a in t)if(a!=="__source"&&e[a]!==t[a])return!0;return!1}function ht(e){this.props=e}(ht.prototype=new D).isPureReactComponent=!0,ht.prototype.shouldComponentUpdate=function(e,t){return _t(this.props,e)||_t(this.state,t)};var vt=h.__b;h.__b=function(e){e.type&&e.type.__f&&e.ref&&(e.props.ref=e.ref,e.ref=null),vt&&vt(e)};var Dr=h.__e;h.__e=function(e,t,r){if(e.then){for(var a,n=t;n=n.__;)if((a=n.__c)&&a.__c)return t.__e==null&&(t.__e=r.__e,t.__k=r.__k),a.__c(e,t)}Dr(e,t,r)};var bt=h.unmount;function xe(){this.__u=0,this.t=null,this.__b=null}function gt(e){var t=e.__.__c;return t&&t.__e&&t.__e(e)}function ie(){this.u=null,this.o=null}h.unmount=function(e){var t=e.__c;t&&t.__R&&t.__R(),t&&e.__h===!0&&(e.type=null),bt&&bt(e)},(xe.prototype=new D).__c=function(e,t){var r=t.__c,a=this;a.t==null&&(a.t=[]),a.t.push(r);var n=gt(a.__v),o=!1,i=function(){o||(o=!0,r.__R=null,n?n(u):u())};r.__R=i;var u=function(){if(!--a.__u){if(a.state.__e){var p=a.state.__e;a.__v.__k[0]=function v(m,f,b){return m&&(m.__v=null,m.__k=m.__k&&m.__k.map(function(F){return v(F,f,b)}),m.__c&&m.__c.__P===f&&(m.__e&&b.insertBefore(m.__e,m.__d),m.__c.__e=!0,m.__c.__P=b)),m}(p,p.__c.__P,p.__c.__O)}var s;for(a.setState({__e:a.__b=null});s=a.t.pop();)s.forceUpdate()}},c=t.__h===!0;a.__u++||c||a.setState({__e:a.__b=a.__v.__k[0]}),e.then(i,i)},xe.prototype.componentWillUnmount=function(){this.t=[]},xe.prototype.render=function(e,t){if(this.__b){if(this.__v.__k){var r=document.createElement("div"),a=this.__v.__k[0].__c;this.__v.__k[0]=function o(i,u,c){return i&&(i.__c&&i.__c.__H&&(i.__c.__H.__.forEach(function(p){typeof p.__c=="function"&&p.__c()}),i.__c.__H=null),(i=jr({},i)).__c!=null&&(i.__c.__P===c&&(i.__c.__P=u),i.__c=null),i.__k=i.__k&&i.__k.map(function(p){return o(p,u,c)})),i}(this.__b,r,a.__O=a.__P)}this.__b=null}var n=t.__e&&O(I,null,e.fallback);return n&&(n.__h=null),[O(I,null,t.__e?null:e.children),n]};var yt=function(e,t,r){if(++r[1]===r[0]&&e.o.delete(t),e.props.revealOrder&&(e.props.revealOrder[0]!=="t"||!e.o.size))for(r=e.u;r;){for(;r.length>3;)r.pop()();if(r[1]<r[0])break;e.u=r=r[2]}};(ie.prototype=new D).__e=function(e){var t=this,r=gt(t.__v),a=t.o.get(e);return a[0]++,function(n){var o=function(){t.props.revealOrder?(a.push(n),yt(t,e,a)):n()};r?r(o):o()}},ie.prototype.render=function(e){this.u=null,this.o=new Map;var t=K(e.children);e.revealOrder&&e.revealOrder[0]==="b"&&t.reverse();for(var r=t.length;r--;)this.o.set(t[r],this.u=[1,0,this.u]);return e.children},ie.prototype.componentDidUpdate=ie.prototype.componentDidMount=function(){var e=this;this.o.forEach(function(t,r){yt(e,r,t)})};var Mr=typeof Symbol!="undefined"&&Symbol.for&&Symbol.for("react.element")||60103,Fr=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,Pr=typeof document!="undefined",Tr=function(e){return(typeof Symbol!="undefined"&&typeof Symbol()=="symbol"?/fil|che|rad/i:/fil|che|ra/i).test(e)};D.prototype.isReactComponent={},["componentWillMount","componentWillReceiveProps","componentWillUpdate"].forEach(function(e){Object.defineProperty(D.prototype,e,{configurable:!0,get:function(){return this["UNSAFE_"+e]},set:function(t){Object.defineProperty(this,e,{configurable:!0,writable:!0,value:t})}})});var St=h.event;function Ar(){}function Er(){return this.cancelBubble}function Nr(){return this.defaultPrevented}h.event=function(e){return St&&(e=St(e)),e.persist=Ar,e.isPropagationStopped=Er,e.isDefaultPrevented=Nr,e.nativeEvent=e};var kt={configurable:!0,get:function(){return this.class}},xt=h.vnode;h.vnode=function(e){var t=e.type,r=e.props,a=r;if(typeof t=="string"){var n=t.indexOf("-")===-1;for(var o in a={},r){var i=r[o];Pr&&o==="children"&&t==="noscript"||o==="value"&&"defaultValue"in r&&i==null||(o==="defaultValue"&&"value"in r&&r.value==null?o="value":o==="download"&&i===!0?i="":/ondoubleclick/i.test(o)?o="ondblclick":/^onchange(textarea|input)/i.test(o+t)&&!Tr(r.type)?o="oninput":/^on(Ani|Tra|Tou|BeforeInp)/.test(o)?o=o.toLowerCase():n&&Fr.test(o)?o=o.replace(/[A-Z0-9]/,"-$&").toLowerCase():i===null&&(i=void 0),a[o]=i)}t=="select"&&a.multiple&&Array.isArray(a.value)&&(a.value=K(r.children).forEach(function(u){u.props.selected=a.value.indexOf(u.props.value)!=-1})),t=="select"&&a.defaultValue!=null&&(a.value=K(r.children).forEach(function(u){u.props.selected=a.multiple?a.defaultValue.indexOf(u.props.value)!=-1:a.defaultValue==u.props.value})),e.props=a}t&&r.class!=r.className&&(kt.enumerable="className"in r,r.className!=null&&(a.class=r.className),Object.defineProperty(a,"className",kt)),e.$$typeof=Mr,xt&&xt(e)};var $t=h.__r;h.__r=function(e){$t&&$t(e)};var $e=rt(),Or=typeof window!="undefined"?pt:ut,Ir=e=>(...t)=>{let r=mt(e),a=z({});return Or(()=>r.on("@changed",(n,o)=>{t.some(u=>u in o)&&a[1]({})}),[]),dt(()=>{let n=r.get(),o={};return t.forEach(i=>{o[i]=n[i]}),o.dispatch=r.dispatch,o},[a[0]])},_=Ir($e);var Ce=class extends Error{constructor(t){super("Validation error");this.validations=t}getValidations(){return this.validations}},W=Ce;var Ct=e=>Object.assign({accept:"application/ld+json","Content-Type":"application/ld+json"},e),zr={get:async(e,t)=>{let{path:r,headers:a}=e.get().api;try{let n=await(await fetch(`${r}/${t}`,{headers:Ct(a)})).json();if(!n["hydra:member"])throw new Error("Invalid response");return n["hydra:member"]}catch(n){throw e.dispatch("moduleState/set","error"),n}},post:async({api:e,dispatch:t},r,a)=>{let{path:n,headers:o}=e,i={method:"POST",headers:Ct(o),body:JSON.stringify(a)};try{var u=await(await fetch(`${n}/${r}`,i)).json()}catch(c){throw t("moduleState/set","error"),c}if(u["@id"])return u;throw u.violations?new W(u.violations):(t("moduleState/set","error"),new Error("Invalid result"))}},C=zr;var wt=function(e,t,r,a){var n;t[0]=0;for(var o=1;o<t.length;o++){var i=t[o++],u=t[o]?(t[0]|=i?1:2,r[t[o++]]):t[++o];i===3?a[0]=u:i===4?a[1]=Object.assign(a[1]||{},u):i===5?(a[1]=a[1]||{})[t[++o]]=u:i===6?a[1][t[++o]]+=u+"":i?(n=e.apply(u,wt(e,u,r,["",null])),a.push(n),u[0]?t[0]|=2:(t[o-2]=0,t[o]=n)):a.push(u)}return a},jt=new Map;function Dt(e){var t=jt.get(this);return t||(t=new Map,jt.set(this,t)),(t=wt(this,t.get(e)||(t.set(e,t=function(r){for(var a,n,o=1,i="",u="",c=[0],p=function(m){o===1&&(m||(i=i.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?c.push(0,m,i):o===3&&(m||i)?(c.push(3,m,i),o=2):o===2&&i==="..."&&m?c.push(4,m,0):o===2&&i&&!m?c.push(5,0,!0,i):o>=5&&((i||!m&&o===5)&&(c.push(o,0,i,n),o=6),m&&(c.push(o,m,0,n),o=6)),i=""},s=0;s<r.length;s++){s&&(o===1&&p(),p(s));for(var v=0;v<r[s].length;v++)a=r[s][v],o===1?a==="<"?(p(),c=[c],o=3):i+=a:o===4?i==="--"&&a===">"?(o=1,i=""):i=a+i[0]:u?a===u?u="":i+=a:a==='"'||a==="'"?u=a:a===">"?(p(),o=1):o&&(a==="="?(o=5,n=i,i=""):a==="/"&&(o<5||r[s][v+1]===">")?(p(),o===3&&(c=c[0]),o=c,(c=c[0]).push(2,0,o),o=0):a===" "||a==="	"||a===`
`||a==="\r"?(p(),o=2):i+=a),o===3&&i==="!--"&&(o=4,c=c[0])}return p(),c}(e)),t),arguments,[])).length>1?t:t[0]}var Lr=(e,t,...r)=>(t&&t.class&&(t.class=t.class.trim().split(" ").filter(a=>a.trim()).map(a=>a.indexOf("cvio-ab-")!==0?`cvio-ab-${a}`:a).join(" ")),O(e,t,...r)),l=Dt.bind(Lr);var se=e=>{let{dispatch:t}=_();return l`
  ...
  `;var N=e=>{let t=_(e.modalStateStore),r=t[e.modalStateStore],[a,n]=z(!1),[o,i]=z(!1),[u,c]=z(!1);r&&!a&&(i(!0),setTimeout(()=>{c(!0),n(!0)},0)),!r&&a&&(c(!1),setTimeout(()=>{i(!1),n(!1)},100));let p=()=>t.dispatch(`${e.modalStateStore}/set`,!1);return l`
    <div class="modal text-dark fade ${u?"show":""}" tabindex="-1" style="${o?"display: block;":""}">
  ...
  `};var Ne={HUF:0},ia=(e,t)=>{var r=e.price_list.currency,a={style:"currency",currency:r};return Ne[r]!=null&&(a.maximumFractionDigits=Ne[r],a.minimumFractionDigits=Ne[r]),new Intl.NumberFormat(t,a)},me=({process:e})=>{if(!e)return l``;let t=e.process_services,{store:r,language:a}=_("store","language");var n=null,o=null,i=r.price_list.id;t.forEach(c=>{c.service.packagings.forEach(p=>{p.currentPrices.forEach(s=>{s.price_list.id==i&&((n==null||n>s.value)&&(n=s.value),(o==null||o<s.value)&&(o=s.value))})})});var u=ia(r,a);return n==null||o==null?l``:n==o?l`${u.format(n)}`:l`${u.format(n)} - ${u.format(o)}`};var fe=e=>{let{appointment:t,language:r,currentStep:a,store:n,selectedCalendar:o,priceComment:i}=_("appointment","language","currentStep","store","selectedCalendar","priceComment");if(!!n){var u=["state","postal_code","city","street_address"],c=[];u.forEach(v=>{!t.customer[v]||c.push(t.customer[v])});var p=t.calendar||o,s={dateTimeStart:t.start?$.formatDateTime(t.start):null,dateTimeEnd:t.end?$.formatDateTime(t.end):null,processLength:t.eye_examination_process?t.eye_examination_process.length:null,processName:t.eye_examination_process?t.eye_examination_process.name:null,process:t.eye_examination_process,examinerName:p?p.user.name:null,customer:t.customer,customerAddress:c.join(", "),storeAddress:n.postal_code+" "+n.city+", "+n.street_address};return l`
  ...
  `};var Oe=e=>{let{selectedCalendar:t,dispatch:r,currentStep:a}=_("selectedCalendar","currentStep"),n=()=>{a==="calendar"&&(r("selectedCalendar/set",e.item["@id"]?e.item:null),r("currentStep/next"))};return l`
  ...
  `};var la=["January","February","March","April","May","June","July","August","September","October","November","December"],ur=e=>{let{selectedDate:t,firstEligibleDate:r,dispatch:a}=_("selectedDate","firstEligibleDate"),n=De(r),o=()=>a("selectedDate/set",u[4]),i=()=>a("selectedDate/set",p[0]);var u,c,p;for(let v=0;v<n.length&&(u=n[v-1],c=n[v],p=n[v+1],!c.hasDate(t));v++);let s={previousDateGroup:u,currentDateGroup:c,nextDateGroup:p};return l`
  ...
  `};var pr=e=>{let{selectedCalendar:t,selectedDate:r,nextFreeSlots:a,appointment:n,dispatch:o}=_("selectedCalendar","appointment","nextFreeSlots","selectedDate");var i=new Date(r),u,c=!1;for(i.setDate(i.getDate()+1);a[u=M(n,t,i)];){if(a[u].status!=="empty"){c=!0;break}i.setDate(i.getDate()+1)}let p=()=>o("selectedDate/set",i);return l`
    <li class="list-group-item p-4 text-center">
      ...
      ${c?l`
          ...
          <button class="btn m-2 btn-primary" onClick="${p}">${d("Go to date")}</button>
        `:l`
          <button class="btn m-2 btn-primary" onClick="${p}">
            ${d("Click here to search for the next free appointment")}
          </button>
        `}
    </li>
  `};var dr=e=>{let{appointment:t,calendars:r,dispatch:a,currentStep:n}=_("appointment","calendars","currentStep"),o=()=>{if(n==="appointment"){var i=null;for(let u=0;u<r.length;u++)if(e.slot.calendar["@id"]==r[u]["@id"])var i=r[u];if(!i)throw new Error("Could not find calendar");a("appointment/set",{start:e.slot.start,end:e.slot.end,calendar:i}),a("currentStep/next")}};return l`
  ...
  `};var mr=()=>{let{selectedDate:e,selectedCalendar:t,appointment:r,nextFreeSlots:a}=_("selectedCalendar","selectedDate","nextFreeSlots","appointment");var n=M(r,t,e);return l`
    ...
    <ul class="list-group mt-3">
      ${a[n]?a[n].status=="empty"?l`<${pr}/>`:a[n].slots.map(o=>l`<${dr} slot=${o}/>`):l`<li class="list-group-item"><${E}/></li>`}
    </ul>
  ...
  `};var ca=e=>(e=e||new Date,e=new Date(e.getFullYear(),e.getMonth()+1,0),e.getDate()),_r=e=>{let{appointment:t,dispatch:r}=_("appointment"),a=(c,p)=>{var{customer:s}=t;p==""?s[e.property]=null:(s[e.property]=s[e.property]||new Date("2000-01-01"),s[e.property][`set${c}`](p)),r("appointment/set",{customer:s})},n=t.customer[e.property];var o=[];for(let c=1900;c<=new Date().getFullYear();c++)o.push({value:c,label:c});var i=[];for(let c=1;c<=12;c++)i.push({value:c-1,label:c<10?`0${c}`:c});var u=[];for(let c=1;c<=ca(n);c++)u.push({value:c,label:c<10?`0${c}`:c});return l`
    <div class="${e.invalid?"is-invalid":""} input-group">
      ...
      <${V} invalid=${e.invalid} onInput=${c=>a("Date",c)}
        value=${n?n.getDate():""} emptySelection="--" options=${u}
         disabled=${!!t.customer["@id"]}/>
    </div>
  ...
  `;var ze=e=>{let{moduleState:t,appointment:r,dispatch:a}=_("moduleState","appointment"),n=()=>a("close");switch(t){case"success":return l`
