...
`||a==="\r"?(h(),o=2):s+=a),o===3&&s==="!--"&&(o=4,u=u[0])}return h(),u}(e)),t),arguments,[])).length>1?t:t[0]}var ii=(e,t,...r)=>(t&&t.class&&(t.class=t.class.trim().split(" ").filter(a=>a.trim()).map(a=>a.indexOf("cvio-ab-")!==0?`cvio-ab-${a}`:a).join(" ")),ee(e,t,...r)),l=ra.bind(ii);var ke=e=>{let{dispatch:t,privacyPolicyLink:r}=v("privacyPolicyLink");return r?l`
  ...
  `};var Tt=e=>{let{dispatch:t}=v();return l`
    ...
    <${H} modalStateStore="closeConfirmModalState"
      ...
      onApprove=${()=>t("close")}/>
  `};var Ha=({customer:e,customerAddress:t})=>l`
      <div>
        <div class="mb-1">
          ${f("Your information")}:
        </div>
        ...
        <div>
          ${e.birth?l`${f("Date of birth")}: ${D.formatDate(e.birth)}`:""}
        </div>
        <div>
  ...
  `;var Ai=async e=>{try{var t=await Ci(e)}catch(r){if(r instanceof ye){Ti(e,r);return}throw r}await Di(e,t),await Pi(e,t),e.dispatch("moduleState/set","success")},Ci=async e=>{let t=Object.assign({},e.appointment.customer,{medical_records_allowed:e.medicalConsent!="disabled"?!0:null,country:e.country,mobile:e.appointment.customer.mobile?xt(e.store.chain.language,e.appointment.customer.mobile):null});return"birth"in t&&(t.birth=Mi(t.birth)),Object.keys(t).forEach(r=>{typeof t[r]=="string"&&(t[r]=t[r].trim())}),await T.post(e,"customers",t)},Mi=e=>{if(!e||!(e instanceof Date))return null;let t=e.getFullYear(),r=String(e.getMonth()+1).padStart(2,"0"),a=String(e.getDate()).padStart(2,"0");return`${t}-${r}-${a}T00:00:00+00:00`},Ti=async(e,t)=>{let{customerForm:r}=e;var a=[];for(let n=0;n<t.getValidations().length;n++){let{propertyPath:o,message:s}=t.getValidations()[n];if(o==""){a.push(s);continue}r[o].errors||(r[o].errors=[]),r[o].errors.push(s)}e.dispatch("customerForm/set",{customerForm:r,customerFormGlobalErrors:a}),e.dispatch("currentStep/set","customer"),e.dispatch("booking/set",!1)},Di=async(e,t)=>{await T.post(e,"customer_consents",{customer:t["@id"],approved_at:new Date,medical_records_allowed:e.medicalConsent!="disabled",source:"api"})},Pi=async(e,t)=>{let{appointment:r,language:a,translationOverrides:n,constantAppointmentCommentText:o,confirmationType:s,reminderType:c}=e,u=o||"";r.comment&&(u=(u?u+`

`:"")+r.comment),await T.post(e,"appointment_events",Object.assign({},r,{customer:t["@id"],eye_examination_process:r.eye_examination_process["@id"],calendar:r.calendar["@id"],comment:u||void 0,title:f("%customer%'s examination",{customer:ae.format(t,a)},{language:a,translationOverrides:n}),status:"booked",should_send_confirmation_email:s=="email"||s=="both",should_send_confirmation_sms:s=="sms"||s=="both",should_send_reminder_email:c=="email"||c=="both",should_send_reminder_sms:c=="sms"||c=="both",source:"online"}))},Ga=e=>{var t=v("appointment","api","booking","language","customerForm","customerFormGlobalErrors","country","moduleState","store","translationOverrides","constantAppointmentCommentText","medicalConsent","confirmationType","reminderType");let{booking:r,moduleState:a,dispatch:n}=t;return l`
    <div class="d-grid">
      <button type="button" onClick=${async()=>{n("booking/set",!0);try{await Ai(t)}catch(s){throw n("moduleState/set","error"),s}}} disabled=${a!="idle"}
        class="btn btn-primary btn-lg">
        ${r&&a=="idle"?l`<${B}/>`:f("Confirm appointment")}
      </button>
    </div>
  `};var Dt={HUF:0},zi=(e,t)=>{var r=e.price_list.currency,a={style:"currency",currency:r};return Dt[r]!=null&&(a.maximumFractionDigits=Dt[r],a.minimumFractionDigits=Dt[r]),new Intl.NumberFormat(t,a)},qe=({process:e})=>{if(!e)return l``;let{store:t,language:r,showPrice:a}=v("store","language","showPrice");if(!a)return l``;let n=e.process_services;var o=null,s=null,c=t.price_list.id;n.forEach(h=>{h.service.packagings.forEach(d=>{d.currentPrices.forEach(k=>{k.price_list.id==c&&((o==null||o>k.value)&&(o=k.value),(s==null||s<k.value)&&(s=k.value))})})});var u=zi(t,r);return o==null||s==null?l``:o==s?l`${u.format(o)}`:l`${u.format(o)} - ${u.format(s)}`};var Ke=e=>{let{appointment:t,language:r,currentStep:a,store:n,selectedCalendar:o,priceComment:s,showPrice:c,showExaminerName:u,locationName:h,locationAddress:d,showLocation:k,dispatch:g}=v("appointment","language","currentStep","store","selectedCalendar","priceComment","showPrice","showExaminerName","locationName","locationAddress","showLocation");if(!n)return;var b=t.calendar||o,_={dateTimeStart:t.start?D.formatDateTime(t.start):null,dateTimeEnd:t.end?D.formatDateTime(t.end):null,processLength:t.eye_examination_process?t.eye_examination_process.length:null,processName:t.eye_examination_process?t.eye_examination_process.name:null,process:t.eye_examination_process,examinerName:u&&b?b.user.name:null,customer:t.customer,customerAddress:ue.formatAddress(t.customer),showLocation:k,locationName:h!==null?h:n.name,locationAddress:d!==null?d:ue.formatAddress(n),appointmentComment:t.comment};let x=()=>{g("currentStep/set","appointment")};return l`
    <ul class="list-group${a=="summary"?"":" text-end"}">
      ...
      ${a=="summary"?l`
        <li class="list-group-item">
          <${Ha} customer=${_.customer} customerAddress=${_.customerAddress}/>
        </li>
      `:""}
  ...
  `};var Va=e=>{let{appointment:t,dispatch:r,currentStep:a,showProcessLength:n}=v("appointment","currentStep","showProcessLength"),o=()=>{a==="process"&&(r("appointment/set",{eye_examination_process:e.item}),r("currentStep/eyeExaminationProcessSelected"),r("currentStep/next"))},s=c=>{c.stopPropagation(),r("detailedDescriptionModalState/set",e.item.detailed_description)};return l`
  ...
  `;var qa=e=>{let{eyeExaminationProcesses:t,detailedDescriptionModalState:r,store:a,calendars:n,dispatch:o}=v("eyeExaminationProcesses","store","calendars"),s=()=>o("detailedDescriptionModalState/set",!1);return t.length==0||!a?l`
      <ul class="list-group">
  ...
  `};var Ka=()=>l`
    ...
    </li>`;var Wa=e=>{let{appointment:t,showFirstAvailableUserItem:r,dispatch:a}=v("appointment","showFirstAvailableUserItem"),n=Se(v("calendars","appointment","calendarRoleCheckMode")),o={user:{name:f("First free"),description:f("For finding the nearest free time slot.")}},s=()=>a("currentStep/previous");return l`
    <ul class="list-group">
  ...
  `};var Ei=["@abbrSunday","@abbrMonday","@abbrTuesday","@abbrWednesday","@abbrThursday","@abbrFriday","@abbrSaturday"],Ja=({date:e})=>{let{selectedDate:t,dispatch:r}=v("selectedDate"),a=()=>r("selectedDate/set",e);return l`
    <div class="col">
  ...
  `};var Ya=({dateGroup:e,visibleDateGroups:t})=>{let{previousDateGroup:r,currentDateGroup:a,nextDateGroup:n}=t;return l`
    <div class="carousel-item
  ...
  `};var Fi=["January","February","March","April","May","June","July","August","September","October","November","December"],Za=e=>{let{selectedDate:t,firstEligibleDate:r,dispatch:a}=v("selectedDate","firstEligibleDate"),n=yt(r),o=()=>a("selectedDate/set",c[4]),s=()=>a("selectedDate/set",h[0]);var c,u,h;for(let k=0;k<n.length&&(c=n[k-1],u=n[k],h=n[k+1],!u.hasDate(t));k++);let d={previousDateGroup:c,currentDateGroup:u,nextDateGroup:h};return l`
    <div class="dateSelection hstack gap-1">
      ...
      <div class="carousel-container">
        <div>${f(Fi[u[0].getMonth()])}</div>
        <div class="carousel slide">
          <div class="carousel-inner">
            ${n.map(k=>l`<${Ya} dateGroup=${k} visibleDateGroups=${d}/>`)}
          </div>
        </div>
      </div>
  ...
  `};var Xa=({day:e})=>{let{selectedCalendar:t,selectedDate:r,nextFreeSlots:a,appointment:n,dispatch:o}=v("selectedCalendar","appointment","nextFreeSlots","selectedDate"),s=a[E(n,t,e)],c=u=>{o("selectedDate/set",u)};return e<new Date||s&&s.status=="empty"?l`<td class='table-active disabled'>${e.getDate()}</td>`:s?l`
    <td class=${R(e,r)?"bg-primary text-light":"active-cell"} 
      onClick="${()=>c(e)}"
    >
      ${e.getDate()}
    </td>
  `:l`<td class="placeholder">${e.getDate()}</td>`};var Ii=["January","February","March","April","May","June","July","August","September","October","November","December"],Oi=["@abbrMonday","@abbrTuesday","@abbrWednesday","@abbrThursday","@abbrFriday","@abbrSaturday","@abbrSunday"],Qa=()=>{let{selectedCalendar:e,selectedDate:t,nextFreeSlots:r,appointment:a,dispatch:n}=v("selectedCalendar","appointment","nextFreeSlots","selectedDate"),o=t.getFullYear(),s=t.getMonth(),c=new Date(o,s+1,0).getDate(),u=new Date<new Date(o,s,0),h=new Date(o,s,1),d=[],k=[];var g=!0;for(let x=t.getDate();x<=c;x++){let $=r[E(a,e,new Date(o,s,x))];if($==null||$.status=="incomplete"){g=!1;break}}for(let x=0;x<(h.getDay()||7)-1;x++)d.push(null);for(let x=1;x<=c;x++)d.push(new Date(o,s,x));for(let x=0;x<d.length;x+=7)k.push(d.slice(x,x+7));let b=()=>{n("selectedDate/set",new Date(o,s+1,1))};return l`
      ...
      <div class="row">
        <div class="col">
          <table class="table table caption-top placeholder-glow">
            ...
            <thead>
              <tr>
                ${Oi.map(x=>l`<th scope="col">${f(x)}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${k.map(x=>l`
  ...
  `};var We=e=>{let{selectedCalendar:t,selectedDate:r,nextFreeSlots:a,appointment:n,dispatch:o,nextFreeSlotLoading:s}=v("selectedCalendar","appointment","nextFreeSlots","selectedDate","nextFreeSlotLoading");var c=new Date(r),u,h=!1;for(c.setDate(c.getDate()+1);a[u=E(n,t,c)];){if(a[u].status!=="empty"){h=!0;break}c.setDate(c.getDate()+1)}let d=()=>o("selectedDate/set",c);return l`
    <li class="list-group-item p-4 text-center">
      ...
      ${h?l`
          <div class="text-muted">
            ${f("The next free slot is available on %date%",{date:D.formatDate(c)})}
          </div>
  ...
  `};var eo=e=>{let{dispatch:t,appointment:r}=v("appointment"),a=()=>{t("appointment/selectSlot",e.slot)};return l`
    <li class="list-group-item${xe(new Date(r.start),new Date(e.slot.start))?" selected":""}" onClick=${a}>
      <div class="row align-items-center ms-2">
        <div class="col-11">${D.formatTime(e.slot.start)}</div>
        <div class="col text-end p-2 next item icon">
          \u203A
        </div>
      </div>
    </li>
  `};var to=()=>{let{selectedDate:e,selectedCalendar:t,appointment:r,nextFreeSlots:a}=v("selectedCalendar","selectedDate","nextFreeSlots","appointment");var n=E(r,t,e);return l`
    <ul class="list-group mt-3">
      ${a[n]?a[n].status=="empty"?l`<${We}/>`:a[n].slots.map(o=>l`<${eo} slot=${o}/>`):l`<li class="list-group-item"><${B}/></li>`}
    </ul>
  `};var ro=({slot:e})=>{let{dispatch:t,appointment:r}=v("appointment"),a=()=>{t("appointment/selectSlot",e)},n=xe(new Date(r.start),new Date(e.start));return l`
    <button class="btn btn-outline-secondary m-1 ${n?" selected":""}" onClick=${a}>
      ${D.formatTime(e.start)}
    </button>
  `};var Je=({title:e,slots:t})=>t.length?l`
      ...
      `:null;var ao=()=>{let{selectedDate:e,selectedCalendar:t,appointment:r,nextFreeSlots:a}=v("selectedCalendar","selectedDate","nextFreeSlots","appointment"),n=E(r,t,e),o=[],s=[],c=[],u=a[n]?a[n].slots:[];for(let h of u||[]){let d=new Date(h.start);d.getHours()<12?o.push(h):d.getHours()<18?s.push(h):c.push(h)}return l`
    <div class="grid">
  ...
  `};var oo=()=>{let{calendarRange:e,timeSlotMode:t}=v("calendarRange","timeSlotMode");return l`
    <${e=="fiveDays"?Za:Qa}/>
    <${t=="singleColumn"?to:ao}/>
  `};var no=e=>{let{appointment:t,dispatch:r}=v("appointment"),a=n=>{let{value:o}=n.target;var{customer:s}=t;s[e.property]=o,r("appointment/set",{customer:s})};return l`
  ...
  `};var P=e=>{let{customerForm:t}=v("customerForm");if(!!t[e.property]){var r=t[e.property];return l`
    <div class="${e.class||"col-sm"} needs-validation p-1 mb-2 w-100">
      ${e.label?l`
        ...
        `:null}
      <${e.inputClass||no} property=${e.property}
  ...
  `}};var io=e=>{let{appointment:t,showAppointmentComment:r,appointmentCommentRequired:a,commentError:n,dispatch:o}=v("appointment","showAppointmentComment","appointmentCommentRequired","commentError");if(!r)return l``;let s=c=>{let{value:u}=c.target;t.comment=u,o("appointment/set",t),o("customerForm/set",{commentError:null})};return l`
      <div class="row mx-2">
  ...
  `};var Ni=e=>(e=e||new Date,e=new Date(e.getFullYear(),e.getMonth()+1,0),e.getDate()),so=e=>{let{appointment:t,dispatch:r}=v("appointment"),a=(u,h)=>{var{customer:d}=t;h==""?d[e.property]=null:(d[e.property]=d[e.property]||new Date("2000-01-01"),d[e.property][`set${u}`](h)),r("appointment/set",{customer:d})},n=t.customer[e.property];var o=[];for(let u=1900;u<=new Date().getFullYear();u++)o.push({value:u,label:u});var s=[];for(let u=1;u<=12;u++)s.push({value:u-1,label:u<10?`0${u}`:u});var c=[];for(let u=1;u<=Ni(n);u++)c.push({value:u,label:u<10?`0${u}`:u});return l`
  ...
  `};var lo=e=>{let{appointment:t,dispatch:r}=v("appointment");return l`
  ...
  `};var co=e=>{let{appointment:t,privacyPolicy:r,dispatch:a}=v("appointment","privacyPolicy"),n=()=>{var{customer:s}=t;s[e.property]=!s[e.property]||null,a("appointment/set",{customer:s})},o=()=>a("privacyPolicyModalState/set",!1);return l`
  ...
  `};var po=e=>{let{appointment:t,dispatch:r}=v("appointment"),a=()=>{var{customer:n}=t;n[e.property]=!n[e.property]||null,r("appointment/set",{customer:n})};return l`
  ...
  `};var uo=e=>{let{customerForm:t,customerFormGlobalErrors:r,medicalConsent:a,dispatch:n}=v("customerForm","customerFormGlobalErrors","language","medicalConsent"),o=()=>{n("customerForm/validateAndNext")};return l`
    <div class="card p-2">
      ${r&&r.length?l`
      ...
      <div class="row mx-2">
        <${P} class="col-lg-5" property="birth" label="Birth" inputClass=${so}/>
        <${P} property="gender" label="Gender" inputClass=${lo}/>
      ...
      <${io}/>
      <div class="row mx-2">
        <${P} property="acceptPrivacyPolicy" inputClass=${co}/>
      </div>
      ${a=="explicit"?l`
          <div class="row mx-2">
            <${P} property="acceptMedicalRecordsUse" inputClass=${po}/>
          </div>
        `:""}
      <button class="mx-2 btn btn-primary" onClick=${o}>${f("Next")}</button>
    </div>
  `};var mo=({item:e})=>{let{store:t,dispatch:r,currentStep:a}=v("store","currentStep"),n=()=>{a==="storeSelection"&&(r("store/set",e),r("currentStep/next"))},o=ue.formatAddress(e);return l`
  ...
  `};var fo=()=>l`
    ...
    </li>`;var ho=e=>{let{stores:t}=v("stores");return t!==null?(t.sort((r,a)=>r.name.localeCompare(a.name)),t.map(r=>l`<${mo} item=${r}/>`)):l`<${fo}/>`};var At=e=>l`
    <div class="carousel slide">
      <div class="carousel-inner">
        <${ne} step="storeSelection" wrappedComponent=${ho}/>
        <${ne} step="process" wrappedComponent=${qa}/>
        <${ne} step="calendar" wrappedComponent=${Wa}/>
        <${ne} step="appointment" wrappedComponent=${oo}/>
        <${ne} step="customer" wrappedComponent=${uo}/>
  ...
  `};var Mt=e=>{let{moduleState:t,appointment:r,dispatch:a,store:n,style:o}=v("moduleState","appointment","store","style");if(!t.startsWith("success")&&!t.startsWith("error"))return;var s,c;n!=null&&(s=n.phone,c=n.email);let u=()=>{o=="embedded"||o=="embedded-safe"?a("resetStore"):a("close")},h="There is a configuration error in the appointment booker that prevents booking. Please contact our store on %mail% email address or book an appointment by calling our store (%tel%) and please mention the error then.",d="Error! Appointments can not be created! There is a configuration error in the appointment booker that prevents booking. Please contact our store on %mail% email address or book an appointment by calling us and please mention the error then.";switch(t){case"success":return l`
        <${H} modalStateStore="globalModalState"
          ...
          content="
            ...
            ${f("The examination will start at %start%, please arrive 5 minutes early.",{start:D.formatTime(r.start)})}
  ...
  `};var vo=e=>{let{headerTitle:t,currentStep:r,style:a,parentWidth:n}=v("headerTitle","currentStep","style","parentWidth");switch(r){case"storeSelection":var o=f("Store selection");break;case"process":var o=f("Select eye examination type");break;case"calendar":var o=f("Select a vision expert");break;case"appointment":var o=f("Select your desired appointment time");break;case"customer":var o=f("Enter customer details");break;default:var o=f("Appointment details verification");break}return l`
