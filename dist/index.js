var re,v,Ue,J,qe,Je,Ke,oe={},Ye=[],La=/acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;function E(e,t){for(var a in t)e[a]=t[a];return e}function We(e){var t=e.parentNode;t&&t.removeChild(e)}function O(e,t,a){var r,n,o,i={};for(o in t)o=="key"?r=t[o]:o=="ref"?n=t[o]:i[o]=t[o];if(arguments.length>2&&(i.children=arguments.length>3?re.call(arguments,2):a),typeof e=="function"&&e.defaultProps!=null)for(o in e.defaultProps)i[o]===void 0&&(i[o]=e.defaultProps[o]);return ne(e,i,r,n,null)}function ne(e,t,a,r,n){var o={type:e,props:t,key:a,ref:r,__k:null,__:null,__b:0,__e:null,__d:void 0,__c:null,__h:null,constructor:void 0,__v:n==null?++Ue:n};return n==null&&v.vnode!=null&&v.vnode(o),o}function z(e){return e.children}function A(e,t){this.props=e,this.context=t}function H(e,t){if(t==null)return e.__?H(e.__,e.__.__k.indexOf(e)+1):null;for(var a;t<e.__k.length;t++)if((a=e.__k[t])!=null&&a.__e!=null)return a.__e;return typeof e.type=="function"?H(e):null}function Ze(e){var t,a;if((e=e.__)!=null&&e.__c!=null){for(e.__e=e.__c.base=null,t=0;t<e.__k.length;t++)if((a=e.__k[t])!=null&&a.__e!=null){e.__e=e.__c.base=a.__e;break}return Ze(e)}}function ye(e){(!e.__d&&(e.__d=!0)&&J.push(e)&&!ie.__r++||Je!==v.debounceRendering)&&((Je=v.debounceRendering)||qe)(ie)}function ie(){for(var e;ie.__r=J.length;)e=J.sort(function(t,a){return t.__v.__b-a.__v.__b}),J=[],e.some(function(t){var a,r,n,o,i,d;t.__d&&(i=(o=(a=t).__v).__e,(d=a.__P)&&(r=[],(n=E({},o)).__v=o.__v+1,Se(d,o,n,a.__n,d.ownerSVGElement!==void 0,o.__h!=null?[i]:null,r,i==null?H(o):i,o.__h),Qe(r,o),o.__e!=i&&Ze(o)))})}function rt(e,t,a,r,n,o,i,d,c,p){var l,g,f,h,_,b,y,x=r&&r.__k||Ye,D=x.length;for(a.__k=[],l=0;l<t.length;l++)if((h=a.__k[l]=(h=t[l])==null||typeof h=="boolean"?null:typeof h=="string"||typeof h=="number"||typeof h=="bigint"?ne(null,h,null,null,h):Array.isArray(h)?ne(z,{children:h},null,null,null):h.__b>0?ne(h.type,h.props,h.key,null,h.__v):h)!=null){if(h.__=a,h.__b=a.__b+1,(f=x[l])===null||f&&h.key==f.key&&h.type===f.type)x[l]=void 0;else for(g=0;g<D;g++){if((f=x[g])&&h.key==f.key&&h.type===f.type){x[g]=void 0;break}f=null}Se(e,h,f=f||oe,n,o,i,d,c,p),_=h.__e,(g=h.ref)&&f.ref!=g&&(y||(y=[]),f.ref&&y.push(f.ref,null,h),y.push(g,h.__c||_,h)),_!=null?(b==null&&(b=_),typeof h.type=="function"&&h.__k===f.__k?h.__d=c=Xe(h,c,e):c=et(e,h,f,x,_,c),typeof a.type=="function"&&(a.__d=c)):c&&f.__e==c&&c.parentNode!=e&&(c=H(f))}for(a.__e=b,l=D;l--;)x[l]!=null&&(typeof a.type=="function"&&x[l].__e!=null&&x[l].__e==a.__d&&(a.__d=H(r,l+1)),at(x[l],x[l]));if(y)for(l=0;l<y.length;l++)tt(y[l],y[++l],y[++l])}function Xe(e,t,a){for(var r,n=e.__k,o=0;n&&o<n.length;o++)(r=n[o])&&(r.__=e,t=typeof r.type=="function"?Xe(r,t,a):et(a,r,r,n,r.__e,t));return t}function K(e,t){return t=t||[],e==null||typeof e=="boolean"||(Array.isArray(e)?e.some(function(a){K(a,t)}):t.push(e)),t}function et(e,t,a,r,n,o){var i,d,c;if(t.__d!==void 0)i=t.__d,t.__d=void 0;else if(a==null||n!=o||n.parentNode==null)e:if(o==null||o.parentNode!==e)e.appendChild(n),i=null;else{for(d=o,c=0;(d=d.nextSibling)&&c<r.length;c+=2)if(d==n)break e;e.insertBefore(n,o),i=o}return i!==void 0?i:n.nextSibling}function Ra(e,t,a,r,n){var o;for(o in a)o==="children"||o==="key"||o in t||se(e,o,null,a[o],r);for(o in t)n&&typeof t[o]!="function"||o==="children"||o==="key"||o==="value"||o==="checked"||a[o]===t[o]||se(e,o,t[o],a[o],r)}function ot(e,t,a){t[0]==="-"?e.setProperty(t,a):e[t]=a==null?"":typeof a!="number"||La.test(t)?a:a+"px"}function se(e,t,a,r,n){var o;e:if(t==="style")if(typeof a=="string")e.style.cssText=a;else{if(typeof r=="string"&&(e.style.cssText=r=""),r)for(t in r)a&&t in a||ot(e.style,t,"");if(a)for(t in a)r&&a[t]===r[t]||ot(e.style,t,a[t])}else if(t[0]==="o"&&t[1]==="n")o=t!==(t=t.replace(/Capture$/,"")),t=t.toLowerCase()in e?t.toLowerCase().slice(2):t.slice(2),e.l||(e.l={}),e.l[t+o]=a,a?r||e.addEventListener(t,o?it:nt,o):e.removeEventListener(t,o?it:nt,o);else if(t!=="dangerouslySetInnerHTML"){if(n)t=t.replace(/xlink[H:h]/,"h").replace(/sName$/,"s");else if(t!=="href"&&t!=="list"&&t!=="form"&&t!=="tabIndex"&&t!=="download"&&t in e)try{e[t]=a==null?"":a;break e}catch(i){}typeof a=="function"||(a!=null&&(a!==!1||t[0]==="a"&&t[1]==="r")?e.setAttribute(t,a):e.removeAttribute(t))}}function nt(e){this.l[e.type+!1](v.event?v.event(e):e)}function it(e){this.l[e.type+!0](v.event?v.event(e):e)}function Se(e,t,a,r,n,o,i,d,c){var p,l,g,f,h,_,b,y,x,D,te,M=t.type;if(t.constructor!==void 0)return null;a.__h!=null&&(c=a.__h,d=t.__e=a.__e,t.__h=null,o=[d]),(p=v.__b)&&p(t);try{e:if(typeof M=="function"){if(y=t.props,x=(p=M.contextType)&&r[p.__c],D=p?x?x.props.value:p.__:r,a.__c?b=(l=t.__c=a.__c).__=l.__E:("prototype"in M&&M.prototype.render?t.__c=l=new M(y,D):(t.__c=l=new A(y,D),l.constructor=M,l.render=Ha),x&&x.sub(l),l.props=y,l.state||(l.state={}),l.context=D,l.__n=r,g=l.__d=!0,l.__h=[]),l.__s==null&&(l.__s=l.state),M.getDerivedStateFromProps!=null&&(l.__s==l.state&&(l.__s=E({},l.__s)),E(l.__s,M.getDerivedStateFromProps(y,l.__s))),f=l.props,h=l.state,g)M.getDerivedStateFromProps==null&&l.componentWillMount!=null&&l.componentWillMount(),l.componentDidMount!=null&&l.__h.push(l.componentDidMount);else{if(M.getDerivedStateFromProps==null&&y!==f&&l.componentWillReceiveProps!=null&&l.componentWillReceiveProps(y,D),!l.__e&&l.shouldComponentUpdate!=null&&l.shouldComponentUpdate(y,l.__s,D)===!1||t.__v===a.__v){l.props=y,l.state=l.__s,t.__v!==a.__v&&(l.__d=!1),l.__v=t,t.__e=a.__e,t.__k=a.__k,t.__k.forEach(function(ae){ae&&(ae.__=t)}),l.__h.length&&i.push(l);break e}l.componentWillUpdate!=null&&l.componentWillUpdate(y,l.__s,D),l.componentDidUpdate!=null&&l.__h.push(function(){l.componentDidUpdate(f,h,_)})}l.context=D,l.props=y,l.state=l.__s,(p=v.__r)&&p(t),l.__d=!1,l.__v=t,l.__P=e,p=l.render(l.props,l.state,l.context),l.state=l.__s,l.getChildContext!=null&&(r=E(E({},r),l.getChildContext())),g||l.getSnapshotBeforeUpdate==null||(_=l.getSnapshotBeforeUpdate(f,h)),te=p!=null&&p.type===z&&p.key==null?p.props.children:p,rt(e,Array.isArray(te)?te:[te],t,a,r,n,o,i,d,c),l.base=t.__e,t.__h=null,l.__h.length&&i.push(l),b&&(l.__E=l.__=null),l.__e=!1}else o==null&&t.__v===a.__v?(t.__k=a.__k,t.__e=a.__e):t.__e=Ba(a.__e,t,a,r,n,o,i,c);(p=v.diffed)&&p(t)}catch(ae){t.__v=null,(c||o!=null)&&(t.__e=d,t.__h=!!c,o[o.indexOf(d)]=null),v.__e(ae,t,a)}}function Qe(e,t){v.__c&&v.__c(t,e),e.some(function(a){try{e=a.__h,a.__h=[],e.some(function(r){r.call(a)})}catch(r){v.__e(r,a.__v)}})}function Ba(e,t,a,r,n,o,i,d){var c,p,l,g=a.props,f=t.props,h=t.type,_=0;if(h==="svg"&&(n=!0),o!=null){for(;_<o.length;_++)if((c=o[_])&&(c===e||(h?c.localName==h:c.nodeType==3))){e=c,o[_]=null;break}}if(e==null){if(h===null)return document.createTextNode(f);e=n?document.createElementNS("http://www.w3.org/2000/svg",h):document.createElement(h,f.is&&f),o=null,d=!1}if(h===null)g===f||d&&e.data===f||(e.data=f);else{if(o=o&&re.call(e.childNodes),p=(g=a.props||oe).dangerouslySetInnerHTML,l=f.dangerouslySetInnerHTML,!d){if(o!=null)for(g={},_=0;_<e.attributes.length;_++)g[e.attributes[_].name]=e.attributes[_].value;(l||p)&&(l&&(p&&l.__html==p.__html||l.__html===e.innerHTML)||(e.innerHTML=l&&l.__html||""))}if(Ra(e,f,g,n,d),l)t.__k=[];else if(_=t.props.children,rt(e,Array.isArray(_)?_:[_],t,a,r,n&&h!=="foreignObject",o,i,o?o[0]:a.__k&&H(a,0),d),o!=null)for(_=o.length;_--;)o[_]!=null&&We(o[_]);d||("value"in f&&(_=f.value)!==void 0&&(_!==e.value||h==="progress"&&!_)&&se(e,"value",_,g.value,!1),"checked"in f&&(_=f.checked)!==void 0&&_!==e.checked&&se(e,"checked",_,g.checked,!1))}return e}function tt(e,t,a){try{typeof e=="function"?e(t):e.current=t}catch(r){v.__e(r,a)}}function at(e,t,a){var r,n;if(v.unmount&&v.unmount(e),(r=e.ref)&&(r.current&&r.current!==e.__e||tt(r,null,t)),(r=e.__c)!=null){if(r.componentWillUnmount)try{r.componentWillUnmount()}catch(o){v.__e(o,t)}r.base=r.__P=null}if(r=e.__k)for(n=0;n<r.length;n++)r[n]&&at(r[n],t,typeof e.type!="function");a||e.__e==null||We(e.__e),e.__e=e.__d=void 0}function Ha(e,t,a){return this.constructor(e,a)}function xe(e,t,a){var r,n,o;v.__&&v.__(e,t),n=(r=typeof a=="function")?null:a&&a.__k||t.__k,o=[],Se(t,e=(!r&&a||t).__k=O(z,null,[e]),n||oe,oe,t.ownerSVGElement!==void 0,!r&&a?[a]:n?null:t.firstChild?re.call(t.childNodes):null,o,!r&&a?a:n?n.__e:t.firstChild,r),Qe(o,e)}function st(e,t){var a={__c:t="__cC"+Ke++,__:e,Consumer:function(r,n){return r.children(n)},Provider:function(r){var n,o;return this.getChildContext||(n=[],(o={})[t]=this,this.getChildContext=function(){return o},this.shouldComponentUpdate=function(i){this.props.value!==i.value&&n.some(ye)},this.sub=function(i){n.push(i);var d=i.componentWillUnmount;i.componentWillUnmount=function(){n.splice(n.indexOf(i),1),d&&d.call(i)}}),r.children}};return a.Provider.__=a.Consumer.contextType=a}re=Ye.slice,v={__e:function(e,t){for(var a,r,n;t=t.__;)if((a=t.__c)&&!a.__)try{if((r=a.constructor)&&r.getDerivedStateFromError!=null&&(a.setState(r.getDerivedStateFromError(e)),n=a.__d),a.componentDidCatch!=null&&(a.componentDidCatch(e),n=a.__d),n)return a.__E=a}catch(o){e=o}throw e}},Ue=0,A.prototype.setState=function(e,t){var a;a=this.__s!=null&&this.__s!==this.state?this.__s:this.__s=E({},this.state),typeof e=="function"&&(e=e(E({},a),this.props)),e&&E(a,e),e!=null&&this.__v&&(t&&this.__h.push(t),ye(this))},A.prototype.forceUpdate=function(e){this.__v&&(this.__e=!0,e&&this.__h.push(e),ye(this))},A.prototype.render=z,J=[],qe=typeof Promise=="function"?Promise.prototype.then.bind(Promise.resolve()):setTimeout,ie.__r=0,Ke=0;var G,j,lt,ke=0,$e=[],ct=v.__b,dt=v.__r,pt=v.diffed,mt=v.__c,ut=v.unmount;function Y(e,t){v.__h&&v.__h(j,e,ke||t),ke=0;var a=j.__H||(j.__H={__:[],__h:[]});return e>=a.__.length&&a.__.push({}),a.__[e]}function I(e){return ke=1,Ga(ft,e)}function Ga(e,t,a){var r=Y(G++,2);return r.t=e,r.__c||(r.__=[a?a(t):ft(void 0,t),function(n){var o=r.t(r.__[0],n);r.__[0]!==o&&(r.__=[o,r.__[1]],r.__c.setState({}))}],r.__c=j),r.__}function ht(e,t){var a=Y(G++,3);!v.__s&&je(a.__H,t)&&(a.__=e,a.__H=t,j.__H.__h.push(a))}function _t(e,t){var a=Y(G++,4);!v.__s&&je(a.__H,t)&&(a.__=e,a.__H=t,j.__h.push(a))}function vt(e,t){var a=Y(G++,7);return je(a.__H,t)&&(a.__=e(),a.__H=t,a.__h=e),a.__}function gt(e){var t=j.context[e.__c],a=Y(G++,9);return a.c=e,t?(a.__==null&&(a.__=!0,t.sub(j)),t.props.value):e.__}function Va(){$e.forEach(function(e){if(e.__P)try{e.__H.__h.forEach(le),e.__H.__h.forEach(Ce),e.__H.__h=[]}catch(t){e.__H.__h=[],v.__e(t,e.__v)}}),$e=[]}v.__b=function(e){j=null,ct&&ct(e)},v.__r=function(e){dt&&dt(e),G=0;var t=(j=e.__c).__H;t&&(t.__h.forEach(le),t.__h.forEach(Ce),t.__h=[])},v.diffed=function(e){pt&&pt(e);var t=e.__c;t&&t.__H&&t.__H.__h.length&&($e.push(t)!==1&&lt===v.requestAnimationFrame||((lt=v.requestAnimationFrame)||function(a){var r,n=function(){clearTimeout(o),bt&&cancelAnimationFrame(r),setTimeout(a)},o=setTimeout(n,100);bt&&(r=requestAnimationFrame(n))})(Va)),j=null},v.__c=function(e,t){t.some(function(a){try{a.__h.forEach(le),a.__h=a.__h.filter(function(r){return!r.__||Ce(r)})}catch(r){t.some(function(n){n.__h&&(n.__h=[])}),t=[],v.__e(r,a.__v)}}),mt&&mt(e,t)},v.unmount=function(e){ut&&ut(e);var t=e.__c;if(t&&t.__H)try{t.__H.__.forEach(le)}catch(a){v.__e(a,t.__v)}};var bt=typeof requestAnimationFrame=="function";function le(e){var t=j;typeof e.__c=="function"&&e.__c(),j=t}function Ce(e){var t=j;e.__c=e.__(),j=t}function je(e,t){return!e||e.length!==t.length||t.some(function(a,r){return a!==e[r]})}function ft(e,t){return typeof t=="function"?t(e):t}function Ua(e,t){for(var a in t)e[a]=t[a];return e}function yt(e,t){for(var a in e)if(a!=="__source"&&!(a in t))return!0;for(var r in t)if(r!=="__source"&&e[r]!==t[r])return!0;return!1}function St(e){this.props=e}(St.prototype=new A).isPureReactComponent=!0,St.prototype.shouldComponentUpdate=function(e,t){return yt(this.props,e)||yt(this.state,t)};var xt=v.__b;v.__b=function(e){e.type&&e.type.__f&&e.ref&&(e.props.ref=e.ref,e.ref=null),xt&&xt(e)};var qa=v.__e;v.__e=function(e,t,a){if(e.then){for(var r,n=t;n=n.__;)if((r=n.__c)&&r.__c)return t.__e==null&&(t.__e=a.__e,t.__k=a.__k),r.__c(e,t)}qa(e,t,a)};var kt=v.unmount;function we(){this.__u=0,this.t=null,this.__b=null}function $t(e){var t=e.__.__c;return t&&t.__e&&t.__e(e)}function ce(){this.u=null,this.o=null}v.unmount=function(e){var t=e.__c;t&&t.__R&&t.__R(),t&&e.__h===!0&&(e.type=null),kt&&kt(e)},(we.prototype=new A).__c=function(e,t){var a=t.__c,r=this;r.t==null&&(r.t=[]),r.t.push(a);var n=$t(r.__v),o=!1,i=function(){o||(o=!0,a.__R=null,n?n(d):d())};a.__R=i;var d=function(){if(!--r.__u){if(r.state.__e){var p=r.state.__e;r.__v.__k[0]=function g(f,h,_){return f&&(f.__v=null,f.__k=f.__k&&f.__k.map(function(b){return g(b,h,_)}),f.__c&&f.__c.__P===h&&(f.__e&&_.insertBefore(f.__e,f.__d),f.__c.__e=!0,f.__c.__P=_)),f}(p,p.__c.__P,p.__c.__O)}var l;for(r.setState({__e:r.__b=null});l=r.t.pop();)l.forceUpdate()}},c=t.__h===!0;r.__u++||c||r.setState({__e:r.__b=r.__v.__k[0]}),e.then(i,i)},we.prototype.componentWillUnmount=function(){this.t=[]},we.prototype.render=function(e,t){if(this.__b){if(this.__v.__k){var a=document.createElement("div"),r=this.__v.__k[0].__c;this.__v.__k[0]=function o(i,d,c){return i&&(i.__c&&i.__c.__H&&(i.__c.__H.__.forEach(function(p){typeof p.__c=="function"&&p.__c()}),i.__c.__H=null),(i=Ua({},i)).__c!=null&&(i.__c.__P===c&&(i.__c.__P=d),i.__c=null),i.__k=i.__k&&i.__k.map(function(p){return o(p,d,c)})),i}(this.__b,a,r.__O=r.__P)}this.__b=null}var n=t.__e&&O(z,null,e.fallback);return n&&(n.__h=null),[O(z,null,t.__e?null:e.children),n]};var jt=function(e,t,a){if(++a[1]===a[0]&&e.o.delete(t),e.props.revealOrder&&(e.props.revealOrder[0]!=="t"||!e.o.size))for(a=e.u;a;){for(;a.length>3;)a.pop()();if(a[1]<a[0])break;e.u=a=a[2]}};(ce.prototype=new A).__e=function(e){var t=this,a=$t(t.__v),r=t.o.get(e);return r[0]++,function(n){var o=function(){t.props.revealOrder?(r.push(n),jt(t,e,r)):n()};a?a(o):o()}},ce.prototype.render=function(e){this.u=null,this.o=new Map;var t=K(e.children);e.revealOrder&&e.revealOrder[0]==="b"&&t.reverse();for(var a=t.length;a--;)this.o.set(t[a],this.u=[1,0,this.u]);return e.children},ce.prototype.componentDidUpdate=ce.prototype.componentDidMount=function(){var e=this;this.o.forEach(function(t,a){jt(e,a,t)})};var Ja=typeof Symbol!="undefined"&&Symbol.for&&Symbol.for("react.element")||60103,Ka=/^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,Ya=typeof document!="undefined",Wa=function(e){return(typeof Symbol!="undefined"&&typeof Symbol()=="symbol"?/fil|che|rad/i:/fil|che|ra/i).test(e)};A.prototype.isReactComponent={},["componentWillMount","componentWillReceiveProps","componentWillUpdate"].forEach(function(e){Object.defineProperty(A.prototype,e,{configurable:!0,get:function(){return this["UNSAFE_"+e]},set:function(t){Object.defineProperty(this,e,{configurable:!0,writable:!0,value:t})}})});var Ct=v.event;function Za(){}function Qa(){return this.cancelBubble}function Xa(){return this.defaultPrevented}v.event=function(e){return Ct&&(e=Ct(e)),e.persist=Za,e.isPropagationStopped=Qa,e.isDefaultPrevented=Xa,e.nativeEvent=e};var wt={configurable:!0,get:function(){return this.class}},Dt=v.vnode;v.vnode=function(e){var t=e.type,a=e.props,r=a;if(typeof t=="string"){var n=t.indexOf("-")===-1;for(var o in r={},a){var i=a[o];Ya&&o==="children"&&t==="noscript"||o==="value"&&"defaultValue"in a&&i==null||(o==="defaultValue"&&"value"in a&&a.value==null?o="value":o==="download"&&i===!0?i="":/ondoubleclick/i.test(o)?o="ondblclick":/^onchange(textarea|input)/i.test(o+t)&&!Wa(a.type)?o="oninput":/^on(Ani|Tra|Tou|BeforeInp)/.test(o)?o=o.toLowerCase():n&&Ka.test(o)?o=o.replace(/[A-Z0-9]/,"-$&").toLowerCase():i===null&&(i=void 0),r[o]=i)}t=="select"&&r.multiple&&Array.isArray(r.value)&&(r.value=K(a.children).forEach(function(d){d.props.selected=r.value.indexOf(d.props.value)!=-1})),t=="select"&&r.defaultValue!=null&&(r.value=K(a.children).forEach(function(d){d.props.selected=r.multiple?r.defaultValue.indexOf(d.props.value)!=-1:r.defaultValue==d.props.value})),e.props=r}t&&a.class!=a.className&&(wt.enumerable="className"in a,a.className!=null&&(r.class=a.className),Object.defineProperty(r,"className",wt)),e.$$typeof=Ja,Dt&&Dt(e)};var Mt=v.__r;v.__r=function(e){Mt&&Mt(e)};var De=st(),er=typeof window!="undefined"?_t:ht,tr=e=>(...t)=>{let a=gt(e),r=I({});return er(()=>a.on("@changed",(n,o)=>{t.some(d=>d in o)&&r[1]({})}),[]),vt(()=>{let n=a.get(),o={};return t.forEach(i=>{o[i]=n[i]}),o.dispatch=a.dispatch,o},[r[0]])},m=tr(De);var Me=class extends Error{constructor(t){super("Validation error");this.validations=t}getValidations(){return this.validations}},W=Me;var At=e=>Object.assign({accept:"application/ld+json","Content-Type":"application/ld+json"},e),ar={get:async(e,t)=>{var n;let{path:a,headers:r}=e.get().api;try{let o=await(await fetch(`${a}/${t}`,{headers:At(r)})).json();if(typeof o!="object")throw new Error("Invalid response");return(n=o["hydra:member"])!=null?n:o}catch(o){throw e.dispatch("moduleState/set","error"),o}},post:async({api:e,dispatch:t},a,r)=>{let{path:n,headers:o}=e,i={method:"POST",headers:At(o),body:JSON.stringify(r)};try{var d=await(await fetch(`${n}/${a}`,i)).json()}catch(c){throw t("moduleState/set","error"),c}if(d["@id"])return d;throw d.violations?new W(d.violations):(t("moduleState/set","error"),new Error("Invalid result"))}},S=ar;var Pt=function(e,t,a,r){var n;t[0]=0;for(var o=1;o<t.length;o++){var i=t[o++],d=t[o]?(t[0]|=i?1:2,a[t[o++]]):t[++o];i===3?r[0]=d:i===4?r[1]=Object.assign(r[1]||{},d):i===5?(r[1]=r[1]||{})[t[++o]]=d:i===6?r[1][t[++o]]+=d+"":i?(n=e.apply(d,Pt(e,d,a,["",null])),r.push(n),d[0]?t[0]|=2:(t[o-2]=0,t[o]=n)):r.push(d)}return r},Ft=new Map;function Tt(e){var t=Ft.get(this);return t||(t=new Map,Ft.set(this,t)),(t=Pt(this,t.get(e)||(t.set(e,t=function(a){for(var r,n,o=1,i="",d="",c=[0],p=function(f){o===1&&(f||(i=i.replace(/^\s*\n\s*|\s*\n\s*$/g,"")))?c.push(0,f,i):o===3&&(f||i)?(c.push(3,f,i),o=2):o===2&&i==="..."&&f?c.push(4,f,0):o===2&&i&&!f?c.push(5,0,!0,i):o>=5&&((i||!f&&o===5)&&(c.push(o,0,i,n),o=6),f&&(c.push(o,f,0,n),o=6)),i=""},l=0;l<a.length;l++){l&&(o===1&&p(),p(l));for(var g=0;g<a[l].length;g++)r=a[l][g],o===1?r==="<"?(p(),c=[c],o=3):i+=r:o===4?i==="--"&&r===">"?(o=1,i=""):i=r+i[0]:d?r===d?d="":i+=r:r==='"'||r==="'"?d=r:r===">"?(p(),o=1):o&&(r==="="?(o=5,n=i,i=""):r==="/"&&(o<5||a[l][g+1]===">")?(p(),o===3&&(c=c[0]),o=c,(c=c[0]).push(2,0,o),o=0):r===" "||r==="	"||r===`
...
`:"")+a.comment),await S.post(e,"appointment_events",Object.assign({},a,{customer:t["@id"],eye_examination_process:a.eye_examination_process["@id"],calendar:a.calendar["@id"],comment:i||void 0,title:u("%customer%'s examination",{customer:L.format(t,r)},{language:r,translationOverrides:n}),status:"booked",should_send_confirmation_email:!0,should_send_reminder_email:!0,source:"online"}))},ua=e=>{var t=m("appointment","api","booking","language","customerForm","customerFormGlobalErrors","country","moduleState","store","translationOverrides","constantAppointmentCommentText","medicalConsent");let{booking:a,moduleState:r,dispatch:n}=t;return s`
  ...
  `};var Re={HUF:0},Dr=(e,t)=>{var a=e.price_list.currency,r={style:"currency",currency:a};return Re[a]!=null&&(r.maximumFractionDigits=Re[a],r.minimumFractionDigits=Re[a]),new Intl.NumberFormat(t,r)},he=({process:e})=>{if(!e)return s``;let{store:t,language:a,showPrice:r}=m("store","language","showPrice");if(!r)return s``;let n=e.process_services;var o=null,i=null,d=t.price_list.id;n.forEach(p=>{p.service.packagings.forEach(l=>{l.currentPrices.forEach(g=>{g.price_list.id==d&&((o==null||o>g.value)&&(o=g.value),(i==null||i<g.value)&&(i=g.value))})})});var c=Dr(t,a);return o==null||i==null?s``:o==i?s`${c.format(o)}`:s`${c.format(o)} - ${c.format(i)}`};var _e=e=>{let{appointment:t,language:a,currentStep:r,store:n,selectedCalendar:o,priceComment:i,showPrice:d,showExaminerName:c,locationName:p,locationAddress:l,showLocation:g,dispatch:f}=m("appointment","language","currentStep","store","selectedCalendar","priceComment","showPrice","showExaminerName","locationName","locationAddress","showLocation");if(!n)return;var h=t.calendar||o,_={dateTimeStart:t.start?k.formatDateTime(t.start):null,dateTimeEnd:t.end?k.formatDateTime(t.end):null,processLength:t.eye_examination_process?t.eye_examination_process.length:null,processName:t.eye_examination_process?t.eye_examination_process.name:null,process:t.eye_examination_process,examinerName:c&&h?h.user.name:null,customer:t.customer,customerAddress:V.formatAddress(t.customer),showLocation:g,locationName:p!==null?p:n.name,locationAddress:l!==null?l:V.formatAddress(n),appointmentComment:t.comment};let b=()=>{f("currentStep/set","appointment")};return s`
    <ul class="list-group${r=="summary"?"":" text-end"}">
      ...
      ${_.processName?s`
        <li class="list-group-item">
          ...
          <div>
            ${_.examinerName?s`${u("examiner: %examiner%",{examiner:_.examinerName})}`:null}
          </div>
        </li>
      `:""}
      ${_.dateTimeStart&&_.dateTimeEnd&&_.processLength?s`
        <li class="list-group-item">
          ...
          <div class="text-muted">
            ${u("It takes up to %length% minutes",{length:_.processLength})}
          </div>
          <div class="fs-6">
      ...
      ${r=="summary"?s`
        <li class="list-group-item">
          <${ma} customer=${_.customer} customerAddress=${_.customerAddress}/>
        </li>
      `:""}
      ${r=="summary"&&_.appointmentComment?s`
        <li class="list-group-item">
          ${u("Comment")}: ${_.appointmentComment}
        </li>
      `:""}
      ${_.showLocation?s`
            <li class="list-group-item">
      ...
      <li class="list-group-item">
        ${d?s`
          <div>${u("Price")}:</div>
          <div class="fw-bold"><${he} process=${_.process}/></div>
        `:""}
        <div>${i||""}</div>
      </li>
      ${r=="summary"?s`
  ...
  `};var Mr=["@abbrSunday","@abbrMonday","@abbrTuesday","@abbrWednesday","@abbrThursday","@abbrFriday","@abbrSaturday"],ga=({date:e})=>{let{selectedDate:t,dispatch:a}=m("selectedDate"),r=()=>a("selectedDate/set",e);return s`
    <div class="col">
  ...
  `};var Ar=["January","February","March","April","May","June","July","August","September","October","November","December"],ya=e=>{let{selectedDate:t,firstEligibleDate:a,dispatch:r}=m("selectedDate","firstEligibleDate"),n=Fe(a),o=()=>r("selectedDate/set",d[4]),i=()=>r("selectedDate/set",p[0]);var d,c,p;for(let g=0;g<n.length&&(d=n[g-1],c=n[g],p=n[g+1],!c.hasDate(t));g++);let l={previousDateGroup:d,currentDateGroup:c,nextDateGroup:p};return s`
    <div class="dateSelection hstack gap-1">
      ...
      <div class="carousel-container">
        <div>${u(Ar[c[0].getMonth()])}</div>
        <div class="carousel slide">
          <div class="carousel-inner">
            ${n.map(g=>s`<${ba} dateGroup=${g} visibleDateGroups=${l}/>`)}
          </div>
        </div>
      </div>
  ...
  `:s`<td class="placeholder">${e.getDate()}</td>`};var Pr=["January","February","March","April","May","June","July","August","September","October","November","December"],Fr=["@abbrMonday","@abbrTuesday","@abbrWednesday","@abbrThursday","@abbrFriday","@abbrSaturday","@abbrSunday"],xa=()=>{let{selectedCalendar:e,selectedDate:t,nextFreeSlots:a,appointment:r,dispatch:n}=m("selectedCalendar","appointment","nextFreeSlots","selectedDate"),o=t.getFullYear(),i=t.getMonth(),d=new Date(o,i+1,0).getDate(),c=new Date<new Date(o,i,0),p=new Date(o,i,1),l=[],g=[];var f=!0;for(let b=t.getDate();b<=d;b++){let y=a[w(r,e,new Date(o,i,b))];if(y==null||y.status=="incomplete"){f=!1;break}}for(let b=0;b<(p.getDay()||7)-1;b++)l.push(null);for(let b=1;b<=d;b++)l.push(new Date(o,i,b));for(let b=0;b<l.length;b+=7)g.push(l.slice(b,b+7));let h=()=>{n("selectedDate/set",new Date(o,i+1,1))};return s`
      ...
      <div class="row">
        <div class="col">
          <table class="table table caption-top placeholder-glow">
            ...
            <thead>
              <tr>
                ${Fr.map(b=>s`<th scope="col">${u(b)}</th>`)}
              </tr>
            </thead>
            <tbody>
              ${g.map(b=>s`
  ...
  `};var ge=({title:e,slots:t})=>t.length?s`
      ...
      `:null;var Ca=()=>{let{selectedDate:e,selectedCalendar:t,appointment:a,nextFreeSlots:r}=m("selectedCalendar","selectedDate","nextFreeSlots","appointment"),n=w(a,t,e),o=[],i=[],d=[],c=r[n]?r[n].slots:[];for(let p of c){let l=new Date(p.start);l.getHours()<12?o.push(p):l.getHours()<18?i.push(p):d.push(p)}return s`
    <div class="grid">
